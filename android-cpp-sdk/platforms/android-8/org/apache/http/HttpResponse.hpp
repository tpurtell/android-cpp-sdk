...
namespace org { namespace apache { namespace http {
	...
	class HttpResponse;
	class HttpResponse
		: public cpp_object<HttpResponse>
	{
	public:
		...
		HttpResponse(jobject jobj)
		: cpp_object<HttpResponse>(jobj)
		{
		}
...
void org::apache::http::HttpResponse::setStatusLine(local_ref< org::apache::http::ProtocolVersion > const &a0, cpp_int const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void org::apache::http::HttpResponse::setStatusLine(local_ref< org::apache::http::ProtocolVersion > const &a0, cpp_int const &a1, local_ref< java::lang::String > const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void org::apache::http::HttpResponse::setStatusCode(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
