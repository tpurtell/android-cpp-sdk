...
namespace org { namespace apache { namespace http { namespace client { namespace protocol {
	...
	class RequestTargetAuthentication
		: public cpp_object<RequestTargetAuthentication>
	{
	public:
		...
		RequestTargetAuthentication(jobject jobj)
		: cpp_object<RequestTargetAuthentication>(jobj)
		{
		}
...
template <>
local_ref< org::apache::http::client::protocol::RequestTargetAuthentication > create< org::apache::http::client::protocol::RequestTargetAuthentication>()
{
	return local_ref< org::apache::http::client::protocol::RequestTargetAuthentication >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::client::protocol::RequestTargetAuthentication::J2CPP_CLASS_NAME>(),
			get_method_id<org::apache::http::client::protocol::RequestTargetAuthentication::J2CPP_CLASS_NAME, org::apache::http::client::protocol::RequestTargetAuthentication::J2CPP_METHOD_NAME(0), org::apache::http::client::protocol::RequestTargetAuthentication::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
