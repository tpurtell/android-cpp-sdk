...
template <>
local_ref< org::apache::http::impl::conn::tsccm::BasicPoolEntry > create< org::apache::http::impl::conn::tsccm::BasicPoolEntry>(local_ref< org::apache::http::conn::ClientConnectionOperator > const &a0, local_ref< org::apache::http::conn::routing::HttpRoute > const &a1, local_ref< java::lang::ref::ReferenceQueue > const &a2)
{
