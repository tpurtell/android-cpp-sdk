...
template <>
local_ref< org::apache::http::ProtocolException > create< org::apache::http::ProtocolException>()
{
	return local_ref< org::apache::http::ProtocolException >(
...
template <>
local_ref< org::apache::http::ProtocolException > create< org::apache::http::ProtocolException>(local_ref< java::lang::String > const &a0)
{
	return local_ref< org::apache::http::ProtocolException >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::ProtocolException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< org::apache::http::ProtocolException > create< org::apache::http::ProtocolException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1)
{
	return local_ref< org::apache::http::ProtocolException >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::ProtocolException::J2CPP_CLASS_NAME>(),
