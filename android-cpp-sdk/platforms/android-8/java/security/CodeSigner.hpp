...
template <>
local_ref< java::security::CodeSigner > create< java::security::CodeSigner>(local_ref< java::security::cert::CertPath > const &a0, local_ref< java::security::Timestamp > const &a1)
{
	return local_ref< java::security::CodeSigner >(
