...
namespace java { namespace security {
	...
	public:
		...
		static cpp_int addProvider(local_ref< java::security::Provider > const&);
		static void removeProvider(local_ref< java::lang::String > const&);
		static local_ref< cpp_object_array<java::security::Provider, 1> > getProviders();
		static local_ref< java::security::Provider > getProvider(local_ref< java::lang::String > const&);
		static local_ref< cpp_object_array<java::security::Provider, 1> > getProviders(local_ref< java::lang::String > const&);
		static local_ref< cpp_object_array<java::security::Provider, 1> > getProviders(local_ref< java::util::Map > const&);
...
cpp_int java::security::Security::insertProviderAt(local_ref< java::security::Provider > const &a0, cpp_int const &a1)
{
	return cpp_int(
...
cpp_int java::security::Security::addProvider(local_ref< java::security::Provider > const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallStaticIntMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
local_ref< cpp_object_array<java::security::Provider, 1> > java::security::Security::getProviders()
{
	return local_ref< cpp_object_array<java::security::Provider, 1> >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
local_ref< cpp_object_array<java::security::Provider, 1> > java::security::Security::getProviders(local_ref< java::lang::String > const &a0)
{
	return local_ref< cpp_object_array<java::security::Provider, 1> >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
local_ref< cpp_object_array<java::security::Provider, 1> > java::security::Security::getProviders(local_ref< java::util::Map > const &a0)
{
	return local_ref< cpp_object_array<java::security::Provider, 1> >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
