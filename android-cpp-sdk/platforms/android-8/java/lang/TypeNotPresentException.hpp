...
namespace java { namespace lang {
	...
	public:
		...
		TypeNotPresentException(jobject jobj)
...
template <>
local_ref< java::lang::TypeNotPresentException > create< java::lang::TypeNotPresentException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1)
{
	return local_ref< java::lang::TypeNotPresentException >(
