...
namespace java { namespace nio { namespace channels {
	...
	public:
		...
		CancelledKeyException(jobject jobj)
...
template <>
local_ref< java::nio::channels::CancelledKeyException > create< java::nio::channels::CancelledKeyException>()
{
	return local_ref< java::nio::channels::CancelledKeyException >(
