...
namespace android { namespace webkit {
	...
	class WebViewClient;
	class WebViewClient
		: public cpp_object<WebViewClient>
	{
	public:
		...
		void onReceivedError(local_ref< android::webkit::WebView > const&, cpp_int const&, local_ref< java::lang::String > const&, local_ref< java::lang::String > const&);
		...
		void doUpdateVisitedHistory(local_ref< android::webkit::WebView > const&, local_ref< java::lang::String > const&, cpp_boolean const&);
		...
		cpp_boolean shouldOverrideKeyEvent(local_ref< android::webkit::WebView > const&, local_ref< android::view::KeyEvent > const&);
		void onUnhandledKeyEvent(local_ref< android::webkit::WebView > const&, local_ref< android::view::KeyEvent > const&);
		void onScaleChanged(local_ref< android::webkit::WebView > const&, cpp_float const&, cpp_float const&);

		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_int > ERROR_UNKNOWN;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_int > ERROR_HOST_LOOKUP;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_int > ERROR_UNSUPPORTED_AUTH_SCHEME;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), cpp_int > ERROR_AUTHENTICATION;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), cpp_int > ERROR_PROXY_AUTHENTICATION;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(5), J2CPP_FIELD_SIGNATURE(5), cpp_int > ERROR_CONNECT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), cpp_int > ERROR_IO;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), cpp_int > ERROR_TIMEOUT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(8), J2CPP_FIELD_SIGNATURE(8), cpp_int > ERROR_REDIRECT_LOOP;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(9), J2CPP_FIELD_SIGNATURE(9), cpp_int > ERROR_UNSUPPORTED_SCHEME;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(10), J2CPP_FIELD_SIGNATURE(10), cpp_int > ERROR_FAILED_SSL_HANDSHAKE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(11), J2CPP_FIELD_SIGNATURE(11), cpp_int > ERROR_BAD_URL;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(12), J2CPP_FIELD_SIGNATURE(12), cpp_int > ERROR_FILE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(13), J2CPP_FIELD_SIGNATURE(13), cpp_int > ERROR_FILE_NOT_FOUND;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(14), J2CPP_FIELD_SIGNATURE(14), cpp_int > ERROR_TOO_MANY_REQUESTS;
	}; //class WebViewClient
...
void android::webkit::WebViewClient::onReceivedError(local_ref< android::webkit::WebView > const &a0, cpp_int const &a1, local_ref< java::lang::String > const &a2, local_ref< java::lang::String > const &a3)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::webkit::WebViewClient::doUpdateVisitedHistory(local_ref< android::webkit::WebView > const &a0, local_ref< java::lang::String > const &a1, cpp_boolean const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_boolean android::webkit::WebViewClient::shouldOverrideKeyEvent(local_ref< android::webkit::WebView > const &a0, local_ref< android::view::KeyEvent > const &a1)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
void android::webkit::WebViewClient::onScaleChanged(local_ref< android::webkit::WebView > const &a0, cpp_float const &a1, cpp_float const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
