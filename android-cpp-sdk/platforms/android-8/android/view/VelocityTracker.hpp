...
namespace android { namespace view {
	...
	public:
		...
		cpp_float getXVelocity(cpp_int const&);
		cpp_float getYVelocity(cpp_int const&);
	}; //class VelocityTracker
...
cpp_float android::view::VelocityTracker::getXVelocity(cpp_int const &a0)
{
	return cpp_float(
		environment::get().get_jenv()->CallFloatMethod(
			get_jtype(),
...
cpp_float android::view::VelocityTracker::getYVelocity(cpp_int const &a0)
{
	return cpp_float(
		environment::get().get_jenv()->CallFloatMethod(
			get_jtype(),
