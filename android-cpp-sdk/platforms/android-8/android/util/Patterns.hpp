...
namespace android { namespace util {
	...
	public:
		...
		Patterns(jobject jobj)
		: cpp_object<Patterns>(jobj)
		{
		}
...
template <>
local_ref< android::util::Patterns > create< android::util::Patterns>()
{
	return local_ref< android::util::Patterns >(
		environment::get().get_jenv()->NewObject(
			get_class<android::util::Patterns::J2CPP_CLASS_NAME>(),
			get_method_id<android::util::Patterns::J2CPP_CLASS_NAME, android::util::Patterns::J2CPP_METHOD_NAME(0), android::util::Patterns::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
