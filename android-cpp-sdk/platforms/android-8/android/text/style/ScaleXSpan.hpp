...
template <>
local_ref< android::text::style::ScaleXSpan > create< android::text::style::ScaleXSpan>(cpp_float const &a0)
{
	return local_ref< android::text::style::ScaleXSpan >(
...
template <>
local_ref< android::text::style::ScaleXSpan > create< android::text::style::ScaleXSpan>(local_ref< android::os::Parcel > const &a0)
{
	return local_ref< android::text::style::ScaleXSpan >(
		environment::get().get_jenv()->NewObject(
			get_class<android::text::style::ScaleXSpan::J2CPP_CLASS_NAME>(),
