...
namespace android { namespace widget {
	...
	public:
		...
		void setBundle(cpp_int const&, local_ref< java::lang::String > const&, local_ref< android::os::Bundle > const&);
...
void android::widget::RemoteViews::setBundle(cpp_int const &a0, local_ref< java::lang::String > const &a1, local_ref< android::os::Bundle > const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
J2CPP_DEFINE_METHOD(android::widget::RemoteViews,27,"setBundle","(ILjava/lang/String;Landroid/os/Bundle;)V")
J2CPP_DEFINE_METHOD(android::widget::RemoteViews,28,"apply","(Landroid/content/Context;Landroid/view/ViewGroup;)Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::widget::RemoteViews,29,"reapply","(Landroid/content/Context;Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::widget::RemoteViews,30,"onLoadClass","(Ljava/lang/Class;)Z")
J2CPP_DEFINE_METHOD(android::widget::RemoteViews,31,"describeContents","()I")
J2CPP_DEFINE_METHOD(android::widget::RemoteViews,32,"writeToParcel","(Landroid/os/Parcel;I)V")
J2CPP_DEFINE_METHOD(android::widget::RemoteViews,33,"<clinit>","()V")
