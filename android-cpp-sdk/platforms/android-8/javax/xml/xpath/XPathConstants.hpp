...
namespace javax { namespace xml { namespace xpath {
	...
	class XPathConstants
		: public cpp_object<XPathConstants>
	{
	public:
		...
		XPathConstants(jobject jobj)
		: cpp_object<XPathConstants>(jobj)
		{
		}
...
template <>
local_ref< javax::xml::xpath::XPathConstants > create< javax::xml::xpath::XPathConstants>()
{
	return local_ref< javax::xml::xpath::XPathConstants >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::xml::xpath::XPathConstants::J2CPP_CLASS_NAME>(),
			get_method_id<javax::xml::xpath::XPathConstants::J2CPP_CLASS_NAME, javax::xml::xpath::XPathConstants::J2CPP_METHOD_NAME(0), javax::xml::xpath::XPathConstants::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
