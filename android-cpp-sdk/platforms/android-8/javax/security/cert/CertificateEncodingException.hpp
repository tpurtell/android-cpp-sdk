...
template <>
local_ref< javax::security::cert::CertificateEncodingException > create< javax::security::cert::CertificateEncodingException>(local_ref< java::lang::String > const &a0)
{
	return local_ref< javax::security::cert::CertificateEncodingException >(
...
template <>
local_ref< javax::security::cert::CertificateEncodingException > create< javax::security::cert::CertificateEncodingException>()
{
	return local_ref< javax::security::cert::CertificateEncodingException >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::security::cert::CertificateEncodingException::J2CPP_CLASS_NAME>(),
