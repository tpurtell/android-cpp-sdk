...
template <>
local_ref< org::apache::http::protocol::ResponseContent > create< org::apache::http::protocol::ResponseContent>()
{
	return local_ref< org::apache::http::protocol::ResponseContent >(
