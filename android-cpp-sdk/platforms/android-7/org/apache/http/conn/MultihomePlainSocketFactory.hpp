...
namespace org { namespace apache { namespace http { namespace conn {
	...
	class MultihomePlainSocketFactory
		: public cpp_object<MultihomePlainSocketFactory>
	{
	public:
...
local_ref< java::net::Socket > org::apache::http::conn::MultihomePlainSocketFactory::connectSocket(local_ref< java::net::Socket > const &a0, local_ref< java::lang::String > const &a1, cpp_int const &a2, local_ref< java::net::InetAddress > const &a3, cpp_int const &a4, local_ref< org::apache::http::params::HttpParams > const &a5)
{
	return local_ref< java::net::Socket >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_boolean org::apache::http::conn::MultihomePlainSocketFactory::isSecure(local_ref< java::net::Socket > const &a0)
{
	return cpp_boolean(
...
cpp_boolean org::apache::http::conn::MultihomePlainSocketFactory::equals(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
cpp_int org::apache::http::conn::MultihomePlainSocketFactory::hashCode()
{
	return cpp_int(
