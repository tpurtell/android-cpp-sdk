...
namespace org { namespace apache { namespace http { namespace impl { namespace cookie {
	...
	class RFC2109VersionHandler
		: public object<RFC2109VersionHandler>
	{
	public:
		...
		: object<RFC2109VersionHandler>(jobj)
		{
		}
...
org::apache::http::impl::cookie::RFC2109VersionHandler::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

org::apache::http::impl::cookie::RFC2109VersionHandler::operator local_ref<org::apache::http::cookie::CookieAttributeHandler>() const
{
...
: object<org::apache::http::impl::cookie::RFC2109VersionHandler>(
	call_new_object<
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_CLASS_NAME,
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_METHOD_NAME(0),
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_METHOD_SIGNATURE(0)
	>()
)
{
}
...
void org::apache::http::impl::cookie::RFC2109VersionHandler::parse(local_ref< org::apache::http::cookie::SetCookie > const &a0, local_ref< java::lang::String > const &a1)
{
	return call_method<
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_CLASS_NAME,
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_METHOD_NAME(1),
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_METHOD_SIGNATURE(1), 
		void
	>(get_jobject(), a0, a1);
}
...
void org::apache::http::impl::cookie::RFC2109VersionHandler::validate(local_ref< org::apache::http::cookie::Cookie > const &a0, local_ref< org::apache::http::cookie::CookieOrigin > const &a1)
{
	return call_method<
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_CLASS_NAME,
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_METHOD_NAME(2),
		org::apache::http::impl::cookie::RFC2109VersionHandler::J2CPP_METHOD_SIGNATURE(2), 
		void
	>(get_jobject(), a0, a1);
}
