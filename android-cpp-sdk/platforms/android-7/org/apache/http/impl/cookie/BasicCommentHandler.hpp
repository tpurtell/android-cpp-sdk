...
namespace org { namespace apache { namespace http { namespace impl { namespace cookie {
	...
	public:
		...
		BasicCommentHandler(jobject jobj)
...
template <>
local_ref< org::apache::http::impl::cookie::BasicCommentHandler > create< org::apache::http::impl::cookie::BasicCommentHandler>()
{
	return local_ref< org::apache::http::impl::cookie::BasicCommentHandler >(
