...
namespace org { namespace apache { namespace http { namespace impl { namespace cookie {
	...
	public:
		...
		RFC2965Spec(jobject jobj)
		: cpp_object<RFC2965Spec>(jobj)
		{
		}
...
template <>
local_ref< org::apache::http::impl::cookie::RFC2965Spec > create< org::apache::http::impl::cookie::RFC2965Spec>()
{
	return local_ref< org::apache::http::impl::cookie::RFC2965Spec >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::impl::cookie::RFC2965Spec::J2CPP_CLASS_NAME>(),
			get_method_id<org::apache::http::impl::cookie::RFC2965Spec::J2CPP_CLASS_NAME, org::apache::http::impl::cookie::RFC2965Spec::J2CPP_METHOD_NAME(0), org::apache::http::impl::cookie::RFC2965Spec::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}

template <>
local_ref< org::apache::http::impl::cookie::RFC2965Spec > create< org::apache::http::impl::cookie::RFC2965Spec>(local_ref< cpp_object_array<java::lang::String, 1> > const &a0, cpp_boolean const &a1)
{
	return local_ref< org::apache::http::impl::cookie::RFC2965Spec >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::impl::cookie::RFC2965Spec::J2CPP_CLASS_NAME>(),
			get_method_id<org::apache::http::impl::cookie::RFC2965Spec::J2CPP_CLASS_NAME, org::apache::http::impl::cookie::RFC2965Spec::J2CPP_METHOD_NAME(1), org::apache::http::impl::cookie::RFC2965Spec::J2CPP_METHOD_SIGNATURE(1), false>(),
...
cpp_boolean org::apache::http::impl::cookie::RFC2965Spec::match(local_ref< org::apache::http::cookie::Cookie > const &a0, local_ref< org::apache::http::cookie::CookieOrigin > const &a1)
{
	return cpp_boolean(
...
cpp_int org::apache::http::impl::cookie::RFC2965Spec::getVersion()
{
	return cpp_int(
