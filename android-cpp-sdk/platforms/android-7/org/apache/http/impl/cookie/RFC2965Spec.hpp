...
namespace org { namespace apache { namespace http { namespace impl { namespace cookie {
	...
	public:
		...
		RFC2965Spec();
		RFC2965Spec(local_ref< cpp_object_array<java::lang::String, 1> > const&, cpp_boolean const&);
...
{
	return local_ref<org::apache::http::impl::cookie::RFC2109Spec>(get_jtype());
}


org::apache::http::impl::cookie::RFC2965Spec::RFC2965Spec()
: cpp_object<org::apache::http::impl::cookie::RFC2965Spec>(
...
org::apache::http::impl::cookie::RFC2965Spec::RFC2965Spec(local_ref< cpp_object_array<java::lang::String, 1> > const &a0, cpp_boolean const &a1)
: cpp_object<org::apache::http::impl::cookie::RFC2965Spec>(
	environment::get().get_jenv()->NewObject(
		get_class<org::apache::http::impl::cookie::RFC2965Spec::J2CPP_CLASS_NAME>(),
