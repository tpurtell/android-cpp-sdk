...
namespace org { namespace apache { namespace http { namespace impl { namespace cookie {
	...
	class RFC2965DomainAttributeHandler
		: public object<RFC2965DomainAttributeHandler>
	{
	public:
		...
		explicit RFC2965DomainAttributeHandler(jobject jobj)
		: object<RFC2965DomainAttributeHandler>(jobj)
		{
		}
		...
		jboolean domainMatch(local_ref< java::lang::String >  const&, local_ref< java::lang::String >  const&);
...
org::apache::http::impl::cookie::RFC2965DomainAttributeHandler::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

org::apache::http::impl::cookie::RFC2965DomainAttributeHandler::operator local_ref<org::apache::http::cookie::CookieAttributeHandler>() const
{
...
: object<org::apache::http::impl::cookie::RFC2965DomainAttributeHandler>(
	call_new_object<
