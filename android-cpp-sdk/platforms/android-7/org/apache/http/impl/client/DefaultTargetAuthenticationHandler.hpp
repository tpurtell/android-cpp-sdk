...
{
	return local_ref<org::apache::http::impl::client::AbstractAuthenticationHandler>(get_jtype());
}


org::apache::http::impl::client::DefaultTargetAuthenticationHandler::DefaultTargetAuthenticationHandler()
: cpp_object<org::apache::http::impl::client::DefaultTargetAuthenticationHandler>(
