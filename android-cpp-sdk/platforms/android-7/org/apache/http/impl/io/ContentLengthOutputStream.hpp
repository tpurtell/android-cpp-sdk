...
namespace org { namespace apache { namespace http { namespace impl { namespace io {
	...
	public:
		...
		ContentLengthOutputStream(local_ref< org::apache::http::io::SessionOutputBuffer > const&, cpp_long const&);
		void close();
		void flush();
...
org::apache::http::impl::io::ContentLengthOutputStream::ContentLengthOutputStream(local_ref< org::apache::http::io::SessionOutputBuffer > const &a0, cpp_long const &a1)
: cpp_object<org::apache::http::impl::io::ContentLengthOutputStream>(
