...
namespace org { namespace apache { namespace http { namespace impl { namespace io {
	...
	public:
		...
		SocketOutputBuffer(local_ref< java::net::Socket > const&, cpp_int const&, local_ref< org::apache::http::params::HttpParams > const&);
	}; //class SocketOutputBuffer
...
{
	return local_ref<org::apache::http::impl::io::AbstractSessionOutputBuffer>(get_jtype());
}


org::apache::http::impl::io::SocketOutputBuffer::SocketOutputBuffer(local_ref< java::net::Socket > const &a0, cpp_int const &a1, local_ref< org::apache::http::params::HttpParams > const &a2)
: cpp_object<org::apache::http::impl::io::SocketOutputBuffer>(
