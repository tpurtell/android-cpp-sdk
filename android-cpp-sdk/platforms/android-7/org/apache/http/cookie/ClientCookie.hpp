...
namespace org { namespace apache { namespace http { namespace cookie {
	...
	class ClientCookie;
	class ClientCookie
		: public cpp_object<ClientCookie>
	{
	public:
...
{
	return local_ref<org::apache::http::cookie::Cookie>(get_jtype());
}
...
cpp_boolean org::apache::http::cookie::ClientCookie::containsAttribute(local_ref< java::lang::String > const &a0)
{
	return cpp_boolean(
