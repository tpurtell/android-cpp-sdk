...
namespace org { namespace apache { namespace http { namespace params {
	...
	class BasicHttpParams
		: public cpp_object<BasicHttpParams>
	{
	public:
		...
		void setParameters(local_ref< cpp_object_array<java::lang::String, 1> > const&, local_ref< java::lang::Object > const&);
		cpp_boolean isParameterSet(local_ref< java::lang::String > const&);
		cpp_boolean isParameterSetLocally(local_ref< java::lang::String > const&);
		void clear();
...
cpp_boolean org::apache::http::params::BasicHttpParams::removeParameter(local_ref< java::lang::String > const &a0)
{
	return cpp_boolean(
...
void org::apache::http::params::BasicHttpParams::setParameters(local_ref< cpp_object_array<java::lang::String, 1> > const &a0, local_ref< java::lang::Object > const &a1)
{
	return void(
...
cpp_boolean org::apache::http::params::BasicHttpParams::isParameterSet(local_ref< java::lang::String > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
cpp_boolean org::apache::http::params::BasicHttpParams::isParameterSetLocally(local_ref< java::lang::String > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
