...
namespace org { namespace apache { namespace http { namespace message {
	...
	class BasicLineParser
		: public cpp_object<BasicLineParser>
	{
	public:
...
cpp_boolean org::apache::http::message::BasicLineParser::hasProtocolVersion(local_ref< org::apache::http::util::CharArrayBuffer > const &a0, local_ref< org::apache::http::message::ParserCursor > const &a1)
{
	return cpp_boolean(
