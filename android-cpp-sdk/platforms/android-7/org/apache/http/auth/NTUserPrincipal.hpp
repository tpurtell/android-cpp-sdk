...
namespace org { namespace apache { namespace http { namespace auth {
	...
	class NTUserPrincipal
		: public cpp_object<NTUserPrincipal>
	{
	public:
...
cpp_int org::apache::http::auth::NTUserPrincipal::hashCode()
{
	return cpp_int(
...
cpp_boolean org::apache::http::auth::NTUserPrincipal::equals(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
