...
org::apache::http::client::methods::HttpDelete::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

org::apache::http::client::methods::HttpDelete::operator local_ref<java::lang::Cloneable>() const
{
	return local_ref<java::lang::Cloneable>(get_jobject());
}

org::apache::http::client::methods::HttpDelete::operator local_ref<org::apache::http::HttpRequest>() const
{
	return local_ref<org::apache::http::HttpRequest>(get_jobject());
}

org::apache::http::client::methods::HttpDelete::operator local_ref<org::apache::http::message::AbstractHttpMessage>() const
{
	return local_ref<org::apache::http::message::AbstractHttpMessage>(get_jobject());
}

org::apache::http::client::methods::HttpDelete::operator local_ref<org::apache::http::client::methods::AbortableHttpRequest>() const
{
	return local_ref<org::apache::http::client::methods::AbortableHttpRequest>(get_jobject());
}

org::apache::http::client::methods::HttpDelete::operator local_ref<org::apache::http::client::methods::HttpUriRequest>() const
{
...
org::apache::http::client::methods::HttpDelete::operator local_ref<org::apache::http::HttpMessage>() const
{
