...
template <>
local_ref< javax::crypto::spec::DHPrivateKeySpec > create< javax::crypto::spec::DHPrivateKeySpec>(local_ref< java::math::BigInteger > const &a0, local_ref< java::math::BigInteger > const &a1, local_ref< java::math::BigInteger > const &a2)
{
	return local_ref< javax::crypto::spec::DHPrivateKeySpec >(
