...
namespace javax { namespace crypto { namespace spec {
	...
	public:
		...
		IvParameterSpec(local_ref< cpp_byte_array<1> > const&);
		IvParameterSpec(local_ref< cpp_byte_array<1> > const&, cpp_int const&, cpp_int const&);
...
javax::crypto::spec::IvParameterSpec::IvParameterSpec(local_ref< cpp_byte_array<1> > const &a0)
: cpp_object<javax::crypto::spec::IvParameterSpec>(
...
javax::crypto::spec::IvParameterSpec::IvParameterSpec(local_ref< cpp_byte_array<1> > const &a0, cpp_int const &a1, cpp_int const &a2)
: cpp_object<javax::crypto::spec::IvParameterSpec>(
	environment::get().get_jenv()->NewObject(
		get_class<javax::crypto::spec::IvParameterSpec::J2CPP_CLASS_NAME>(),
