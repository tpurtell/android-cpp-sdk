...
template <>
local_ref< javax::crypto::spec::DESedeKeySpec > create< javax::crypto::spec::DESedeKeySpec>(local_ref< cpp_byte_array<1> > const &a0)
{
	return local_ref< javax::crypto::spec::DESedeKeySpec >(
...
template <>
local_ref< javax::crypto::spec::DESedeKeySpec > create< javax::crypto::spec::DESedeKeySpec>(local_ref< cpp_byte_array<1> > const &a0, cpp_int const &a1)
{
	return local_ref< javax::crypto::spec::DESedeKeySpec >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::crypto::spec::DESedeKeySpec::J2CPP_CLASS_NAME>(),
