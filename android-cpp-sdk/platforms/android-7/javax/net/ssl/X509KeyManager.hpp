...
namespace javax { namespace net { namespace ssl {
	...
	class X509KeyManager
		: public cpp_object<X509KeyManager>
	{
	public:
		...
		local_ref< cpp_object_array<java::security::cert::X509Certificate, 1> > getCertificateChain(local_ref< java::lang::String > const&);
		local_ref< cpp_object_array<java::lang::String, 1> > getClientAliases(local_ref< java::lang::String > const&, local_ref< cpp_object_array<java::security::Principal, 1> > const&);
		local_ref< cpp_object_array<java::lang::String, 1> > getServerAliases(local_ref< java::lang::String > const&, local_ref< cpp_object_array<java::security::Principal, 1> > const&);
...
local_ref< java::lang::String > javax::net::ssl::X509KeyManager::chooseServerAlias(local_ref< java::lang::String > const &a0, local_ref< cpp_object_array<java::security::Principal, 1> > const &a1, local_ref< java::net::Socket > const &a2)
{
	return local_ref< java::lang::String >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< cpp_object_array<java::security::cert::X509Certificate, 1> > javax::net::ssl::X509KeyManager::getCertificateChain(local_ref< java::lang::String > const &a0)
{
...
local_ref< cpp_object_array<java::lang::String, 1> > javax::net::ssl::X509KeyManager::getClientAliases(local_ref< java::lang::String > const &a0, local_ref< cpp_object_array<java::security::Principal, 1> > const &a1)
{
...
local_ref< cpp_object_array<java::lang::String, 1> > javax::net::ssl::X509KeyManager::getServerAliases(local_ref< java::lang::String > const &a0, local_ref< cpp_object_array<java::security::Principal, 1> > const &a1)
{
	return local_ref< cpp_object_array<java::lang::String, 1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
