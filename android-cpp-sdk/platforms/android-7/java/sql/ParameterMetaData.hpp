...
namespace java { namespace sql {
	...
	class ParameterMetaData
		: public cpp_object<ParameterMetaData>
	{
	public:
		...
		cpp_int getParameterMode(cpp_int const&);
		cpp_int getParameterType(cpp_int const&);
		local_ref< java::lang::String > getParameterTypeName(cpp_int const&);
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_int > parameterModeIn;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_int > parameterModeInOut;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_int > parameterModeOut;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), cpp_int > parameterModeUnknown;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), cpp_int > parameterNoNulls;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(5), J2CPP_FIELD_SIGNATURE(5), cpp_int > parameterNullable;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), cpp_int > parameterNullableUnknown;
	}; //class ParameterMetaData
...
cpp_int java::sql::ParameterMetaData::getParameterCount()
{
	return cpp_int(
...
cpp_int java::sql::ParameterMetaData::getParameterMode(cpp_int const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::sql::ParameterMetaData::getParameterType(cpp_int const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
local_ref< java::lang::String > java::sql::ParameterMetaData::getParameterTypeName(cpp_int const &a0)
{
	return local_ref< java::lang::String >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_int java::sql::ParameterMetaData::getPrecision(cpp_int const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::sql::ParameterMetaData::getScale(cpp_int const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::sql::ParameterMetaData::isNullable(cpp_int const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_boolean java::sql::ParameterMetaData::isSigned(cpp_int const &a0)
{
	return cpp_boolean(
