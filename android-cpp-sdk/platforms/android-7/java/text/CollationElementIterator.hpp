...
namespace java { namespace text {
	...
	class CollationElementIterator
		: public cpp_object<CollationElementIterator>
	{
	public:
		...
		cpp_int next();
		cpp_int previous();
		static cpp_int primaryOrder(cpp_int const&);
		void reset();
		static cpp_short secondaryOrder(cpp_int const&);
		void setOffset(cpp_int const&);
		void setText(local_ref< java::text::CharacterIterator > const&);
		void setText(local_ref< java::lang::String > const&);
		static cpp_short tertiaryOrder(cpp_int const&);

		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_int > NULLORDER;
	}; //class CollationElementIterator
...
cpp_int java::text::CollationElementIterator::getOffset()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::text::CollationElementIterator::next()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::text::CollationElementIterator::previous()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::text::CollationElementIterator::primaryOrder(cpp_int const &a0)
{
	return cpp_int(
...
cpp_short java::text::CollationElementIterator::secondaryOrder(cpp_int const &a0)
{
	return cpp_short(
...
void java::text::CollationElementIterator::setOffset(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_short java::text::CollationElementIterator::tertiaryOrder(cpp_int const &a0)
{
	return cpp_short(
		environment::get().get_jenv()->CallStaticShortMethod(
			get_class<J2CPP_CLASS_NAME>(),
