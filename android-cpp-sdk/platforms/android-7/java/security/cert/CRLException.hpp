...
template <>
local_ref< java::security::cert::CRLException > create< java::security::cert::CRLException>(local_ref< java::lang::String > const &a0)
{
	return local_ref< java::security::cert::CRLException >(
...
template <>
local_ref< java::security::cert::CRLException > create< java::security::cert::CRLException>()
{
	return local_ref< java::security::cert::CRLException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CRLException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::cert::CRLException > create< java::security::cert::CRLException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1)
{
	return local_ref< java::security::cert::CRLException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CRLException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::cert::CRLException > create< java::security::cert::CRLException>(local_ref< java::lang::Throwable > const &a0)
{
	return local_ref< java::security::cert::CRLException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CRLException::J2CPP_CLASS_NAME>(),
