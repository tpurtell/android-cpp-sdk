...
namespace java { namespace security {
	...
	public:
		...
		NoSuchAlgorithmException(jobject jobj)
...
template <>
local_ref< java::security::NoSuchAlgorithmException > create< java::security::NoSuchAlgorithmException>(local_ref< java::lang::String > const &a0)
{
	return local_ref< java::security::NoSuchAlgorithmException >(
...
template <>
local_ref< java::security::NoSuchAlgorithmException > create< java::security::NoSuchAlgorithmException>()
{
	return local_ref< java::security::NoSuchAlgorithmException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::NoSuchAlgorithmException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::NoSuchAlgorithmException > create< java::security::NoSuchAlgorithmException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1)
{
	return local_ref< java::security::NoSuchAlgorithmException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::NoSuchAlgorithmException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::NoSuchAlgorithmException > create< java::security::NoSuchAlgorithmException>(local_ref< java::lang::Throwable > const &a0)
{
	return local_ref< java::security::NoSuchAlgorithmException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::NoSuchAlgorithmException::J2CPP_CLASS_NAME>(),
