...
namespace java { namespace security {
	...
	class AlgorithmParameterGenerator
		: public cpp_object<AlgorithmParameterGenerator>
	{
	public:
...
void java::security::AlgorithmParameterGenerator::init(cpp_int const &a0)
{
	return void(
...
void java::security::AlgorithmParameterGenerator::init(cpp_int const &a0, local_ref< java::security::SecureRandom > const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
