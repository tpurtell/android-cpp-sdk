...
template <>
local_ref< java::security::spec::RSAPublicKeySpec > create< java::security::spec::RSAPublicKeySpec>(local_ref< java::math::BigInteger > const &a0, local_ref< java::math::BigInteger > const &a1)
{
	return local_ref< java::security::spec::RSAPublicKeySpec >(
