...
namespace java { namespace security { namespace acl {
	...
	public:
		...
		cpp_boolean isMember(local_ref< java::security::Principal > const&);
...
cpp_boolean java::security::acl::Group::removeMember(local_ref< java::security::Principal > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
cpp_boolean java::security::acl::Group::isMember(local_ref< java::security::Principal > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
