...
local_ref< java::nio::channels::FileChannel > java::io::RandomAccessFile::getChannel()
{
	return call_method<
		java::io::RandomAccessFile::J2CPP_CLASS_NAME,
		java::io::RandomAccessFile::J2CPP_METHOD_NAME(3),
		java::io::RandomAccessFile::J2CPP_METHOD_SIGNATURE(3), 
...
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,3,"getChannel","()Ljava/nio/channels/FileChannel;")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,4,"getFD","()Ljava/io/FileDescriptor;")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,5,"getFilePointer","()J")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,6,"length","()J")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,7,"read","()I")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,8,"read","([B)I")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,9,"read","([BII)I")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,10,"readBoolean","()Z")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,11,"readByte","()B")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,12,"readChar","()C")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,13,"readDouble","()D")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,14,"readFloat","()F")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,15,"readFully","([B)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,16,"readFully","([BII)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,17,"readInt","()I")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,18,"readLine","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,19,"readLong","()J")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,20,"readShort","()S")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,21,"readUnsignedByte","()I")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,22,"readUnsignedShort","()I")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,23,"readUTF","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,24,"seek","(J)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,25,"setLength","(J)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,26,"skipBytes","(I)I")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,27,"write","([B)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,28,"write","([BII)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,29,"write","(I)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,30,"writeBoolean","(Z)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,31,"writeByte","(I)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,32,"writeBytes","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,33,"writeChar","(I)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,34,"writeChars","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,35,"writeDouble","(D)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,36,"writeFloat","(F)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,37,"writeInt","(I)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,38,"writeLong","(J)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,39,"writeShort","(I)V")
J2CPP_DEFINE_METHOD(java::io::RandomAccessFile,40,"writeUTF","(Ljava/lang/String;)V")
