...
java::net::ProtocolException::operator local_ref<java::io::Serializable>() const
{
...
java::net::ProtocolException::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

java::net::ProtocolException::operator local_ref<java::lang::Throwable>() const
{
	return local_ref<java::lang::Throwable>(get_jobject());
}

java::net::ProtocolException::operator local_ref<java::lang::Exception>() const
{
