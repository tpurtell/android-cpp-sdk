...
local_ref< java::lang::Object > java::net::ContentHandler::getContent(local_ref< java::net::URLConnection > const &a0, local_ref< cpp_object_array<java::lang::Class, 1> > const &a1)
{
	return local_ref< java::lang::Object >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
