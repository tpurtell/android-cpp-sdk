...
namespace java { namespace util {
	...
	public:
		...
		Hashtable();
		Hashtable(cpp_int const&);
		Hashtable(cpp_int const&, cpp_float const&);
...
{
	return local_ref<java::util::Dictionary>(get_jtype());
}
...
: cpp_object<java::util::Hashtable>(
...
java::util::Hashtable::Hashtable(cpp_int const &a0)
: cpp_object<java::util::Hashtable>(
	environment::get().get_jenv()->NewObject(
		get_class<java::util::Hashtable::J2CPP_CLASS_NAME>(),
...
java::util::Hashtable::Hashtable(cpp_int const &a0, cpp_float const &a1)
: cpp_object<java::util::Hashtable>(
	environment::get().get_jenv()->NewObject(
		get_class<java::util::Hashtable::J2CPP_CLASS_NAME>(),
