...
namespace java { namespace util {
	...
	public:
		...
		Vector();
		Vector(cpp_int const&);
		Vector(cpp_int const&, cpp_int const&);
...
java::util::Vector::Vector(cpp_int const &a0)
: cpp_object<java::util::Vector>(
	environment::get().get_jenv()->NewObject(
		get_class<java::util::Vector::J2CPP_CLASS_NAME>(),
...
java::util::Vector::Vector(cpp_int const &a0, cpp_int const &a1)
: cpp_object<java::util::Vector>(
	environment::get().get_jenv()->NewObject(
		get_class<java::util::Vector::J2CPP_CLASS_NAME>(),
