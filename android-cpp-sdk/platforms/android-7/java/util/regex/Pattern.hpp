...
namespace java { namespace util { namespace regex {
	...
	public:
		...
		static cpp_boolean matches(local_ref< java::lang::String > const&, local_ref< java::lang::CharSequence > const&);
		local_ref< cpp_object_array<java::lang::String, 1> > split(local_ref< java::lang::CharSequence > const&);
		local_ref< cpp_object_array<java::lang::String, 1> > split(local_ref< java::lang::CharSequence > const&, cpp_int const&);
		static local_ref< java::lang::String > quote(local_ref< java::lang::String > const&);
		local_ref< java::lang::String > toString();

		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_int > UNIX_LINES;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_int > CASE_INSENSITIVE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_int > COMMENTS;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), cpp_int > MULTILINE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), cpp_int > LITERAL;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(5), J2CPP_FIELD_SIGNATURE(5), cpp_int > DOTALL;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), cpp_int > UNICODE_CASE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), cpp_int > CANON_EQ;
	}; //class Pattern
...
local_ref< java::util::regex::Pattern > java::util::regex::Pattern::compile(local_ref< java::lang::String > const &a0, cpp_int const &a1)
{
	return local_ref< java::util::regex::Pattern >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
cpp_int java::util::regex::Pattern::flags()
{
	return cpp_int(
...
cpp_boolean java::util::regex::Pattern::matches(local_ref< java::lang::String > const &a0, local_ref< java::lang::CharSequence > const &a1)
{
	return cpp_boolean(
...
local_ref< cpp_object_array<java::lang::String, 1> > java::util::regex::Pattern::split(local_ref< java::lang::CharSequence > const &a0)
{
...
local_ref< cpp_object_array<java::lang::String, 1> > java::util::regex::Pattern::split(local_ref< java::lang::CharSequence > const &a0, cpp_int const &a1)
{
	return local_ref< cpp_object_array<java::lang::String, 1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,1,"compile","(Ljava/lang/String;)Ljava/util/regex/Pattern;")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,2,"compile","(Ljava/lang/String;I)Ljava/util/regex/Pattern;")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,3,"pattern","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,4,"flags","()I")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,5,"matcher","(Ljava/lang/CharSequence;)Ljava/util/regex/Matcher;")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,6,"matches","(Ljava/lang/String;Ljava/lang/CharSequence;)Z")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,7,"split","(Ljava/lang/CharSequence;)[java.lang.String")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,8,"split","(Ljava/lang/CharSequence;I)[java.lang.String")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,9,"quote","(Ljava/lang/String;)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::util::regex::Pattern,10,"toString","()Ljava/lang/String;")
