...
namespace java { namespace util { namespace concurrent { namespace atomic {
	...
	public:
		...
		AtomicIntegerArray(cpp_int const&);
		AtomicIntegerArray(local_ref< cpp_int_array<1> > const&);
		cpp_int length();
...
java::util::concurrent::atomic::AtomicIntegerArray::AtomicIntegerArray(cpp_int const &a0)
: cpp_object<java::util::concurrent::atomic::AtomicIntegerArray>(
...
java::util::concurrent::atomic::AtomicIntegerArray::AtomicIntegerArray(local_ref< cpp_int_array<1> > const &a0)
: cpp_object<java::util::concurrent::atomic::AtomicIntegerArray>(
	environment::get().get_jenv()->NewObject(
		get_class<java::util::concurrent::atomic::AtomicIntegerArray::J2CPP_CLASS_NAME>(),
...
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,5,"getAndSet","(II)I")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,6,"compareAndSet","(III)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,7,"weakCompareAndSet","(III)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,8,"getAndIncrement","(I)I")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,9,"getAndDecrement","(I)I")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,10,"getAndAdd","(II)I")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,11,"incrementAndGet","(I)I")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,12,"decrementAndGet","(I)I")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,13,"addAndGet","(II)I")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicIntegerArray,14,"toString","()Ljava/lang/String;")
