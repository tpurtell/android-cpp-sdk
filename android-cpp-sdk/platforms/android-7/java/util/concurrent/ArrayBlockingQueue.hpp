...
namespace java { namespace util { namespace concurrent {
	...
	public:
		...
		ArrayBlockingQueue(cpp_int const&);
		ArrayBlockingQueue(cpp_int const&, cpp_boolean const&);
		ArrayBlockingQueue(cpp_int const&, cpp_boolean const&, local_ref< java::util::Collection > const&);
...
java::util::concurrent::ArrayBlockingQueue::ArrayBlockingQueue(cpp_int const &a0)
: cpp_object<java::util::concurrent::ArrayBlockingQueue>(
...
java::util::concurrent::ArrayBlockingQueue::ArrayBlockingQueue(cpp_int const &a0, cpp_boolean const &a1)
: cpp_object<java::util::concurrent::ArrayBlockingQueue>(
	environment::get().get_jenv()->NewObject(
		get_class<java::util::concurrent::ArrayBlockingQueue::J2CPP_CLASS_NAME>(),
...
java::util::concurrent::ArrayBlockingQueue::ArrayBlockingQueue(cpp_int const &a0, cpp_boolean const &a1, local_ref< java::util::Collection > const &a2)
: cpp_object<java::util::concurrent::ArrayBlockingQueue>(
	environment::get().get_jenv()->NewObject(
		get_class<java::util::concurrent::ArrayBlockingQueue::J2CPP_CLASS_NAME>(),
