...
cpp_int java::util::logging::Level::intValue()
{
	return cpp_int(
...
cpp_boolean java::util::logging::Level::equals(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
...
cpp_int java::util::logging::Level::hashCode()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
