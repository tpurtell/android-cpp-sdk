...
namespace java { namespace util { namespace logging {
	...
	public:
		...
		void checkAccess();
		cpp_boolean addLogger(local_ref< java::util::logging::Logger > const&);
...
{
	return local_ref< java::util::logging::LoggingMXBean >(
...
cpp_boolean java::util::logging::LogManager::addLogger(local_ref< java::util::logging::Logger > const &a0)
{
	return cpp_boolean(
