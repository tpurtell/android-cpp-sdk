...
namespace java { namespace util {
	...
	class PropertyPermission
		: public cpp_object<PropertyPermission>
	{
	public:
...
cpp_int java::util::PropertyPermission::hashCode()
{
	return cpp_int(
...
cpp_boolean java::util::PropertyPermission::implies(local_ref< java::security::Permission > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
