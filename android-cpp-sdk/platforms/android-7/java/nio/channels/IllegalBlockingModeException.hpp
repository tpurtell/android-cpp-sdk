...
java::nio::channels::IllegalBlockingModeException::operator local_ref<java::io::Serializable>() const
{
	return local_ref<java::io::Serializable>(get_jobject());
}

java::nio::channels::IllegalBlockingModeException::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

java::nio::channels::IllegalBlockingModeException::operator local_ref<java::lang::RuntimeException>() const
{
	return local_ref<java::lang::RuntimeException>(get_jobject());
}

java::nio::channels::IllegalBlockingModeException::operator local_ref<java::lang::Throwable>() const
{
...
java::nio::channels::IllegalBlockingModeException::operator local_ref<java::lang::Exception>() const
{
