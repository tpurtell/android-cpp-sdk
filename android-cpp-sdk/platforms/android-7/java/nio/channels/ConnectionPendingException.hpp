...
namespace java { namespace nio { namespace channels {
	...
	class ConnectionPendingException
		: public object<ConnectionPendingException>
	{
	public:
		...
		: object<ConnectionPendingException>(jobj)
		{
		}
...
java::nio::channels::ConnectionPendingException::operator local_ref<java::io::Serializable>() const
{
	return local_ref<java::io::Serializable>(get_jobject());
}

java::nio::channels::ConnectionPendingException::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

java::nio::channels::ConnectionPendingException::operator local_ref<java::lang::RuntimeException>() const
{
	return local_ref<java::lang::RuntimeException>(get_jobject());
}

java::nio::channels::ConnectionPendingException::operator local_ref<java::lang::Throwable>() const
{
...
java::nio::channels::ConnectionPendingException::operator local_ref<java::lang::Exception>() const
{
...
: object<java::nio::channels::ConnectionPendingException>(
	call_new_object<
		java::nio::channels::ConnectionPendingException::J2CPP_CLASS_NAME,
		java::nio::channels::ConnectionPendingException::J2CPP_METHOD_NAME(0),
		java::nio::channels::ConnectionPendingException::J2CPP_METHOD_SIGNATURE(0)
	>()
)
{
}
