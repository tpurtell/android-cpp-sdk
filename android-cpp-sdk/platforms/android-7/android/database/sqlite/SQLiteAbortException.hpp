...
namespace android { namespace database { namespace sqlite {
	...
	class SQLiteAbortException
		: public object<SQLiteAbortException>
	{
	public:
		...
		: object<SQLiteAbortException>(jobj)
		{
		}
...
android::database::sqlite::SQLiteAbortException::operator local_ref<java::io::Serializable>() const
{
	return local_ref<java::io::Serializable>(get_jobject());
}

android::database::sqlite::SQLiteAbortException::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

android::database::sqlite::SQLiteAbortException::operator local_ref<java::lang::RuntimeException>() const
{
	return local_ref<java::lang::RuntimeException>(get_jobject());
}

android::database::sqlite::SQLiteAbortException::operator local_ref<java::lang::Throwable>() const
{
	return local_ref<java::lang::Throwable>(get_jobject());
}

android::database::sqlite::SQLiteAbortException::operator local_ref<java::lang::Exception>() const
{
	return local_ref<java::lang::Exception>(get_jobject());
}

android::database::sqlite::SQLiteAbortException::operator local_ref<android::database::SQLException>() const
{
...
: object<android::database::sqlite::SQLiteAbortException>(
	call_new_object<
		android::database::sqlite::SQLiteAbortException::J2CPP_CLASS_NAME,
		android::database::sqlite::SQLiteAbortException::J2CPP_METHOD_NAME(0),
		android::database::sqlite::SQLiteAbortException::J2CPP_METHOD_SIGNATURE(0)
	>()
)
{
}
...
: object<android::database::sqlite::SQLiteAbortException>(
	call_new_object<
		android::database::sqlite::SQLiteAbortException::J2CPP_CLASS_NAME,
		android::database::sqlite::SQLiteAbortException::J2CPP_METHOD_NAME(1),
		android::database::sqlite::SQLiteAbortException::J2CPP_METHOD_SIGNATURE(1)
	>(a0)
)
{
}
