...
namespace android { namespace view { namespace animation {
	...
	public:
		...
		DecelerateInterpolator(cpp_float const&);
...
: cpp_object<android::view::animation::DecelerateInterpolator>(
...
android::view::animation::DecelerateInterpolator::DecelerateInterpolator(cpp_float const &a0)
: cpp_object<android::view::animation::DecelerateInterpolator>(
	environment::get().get_jenv()->NewObject(
		get_class<android::view::animation::DecelerateInterpolator::J2CPP_CLASS_NAME>(),
