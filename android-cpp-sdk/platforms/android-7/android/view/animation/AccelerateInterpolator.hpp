...
namespace android { namespace view { namespace animation {
	...
	class AccelerateInterpolator
		: public object<AccelerateInterpolator>
	{
	public:
		...
		: object<AccelerateInterpolator>(jobj)
		{
		}
...
: object<android::view::animation::AccelerateInterpolator>(
	call_new_object<
...
android::view::animation::AccelerateInterpolator::AccelerateInterpolator(jfloat a0)
: object<android::view::animation::AccelerateInterpolator>(
	call_new_object<
		android::view::animation::AccelerateInterpolator::J2CPP_CLASS_NAME,
...
jfloat android::view::animation::AccelerateInterpolator::getInterpolation(jfloat a0)
{
	return call_method<
		android::view::animation::AccelerateInterpolator::J2CPP_CLASS_NAME,
