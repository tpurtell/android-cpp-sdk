...
namespace android { namespace view { namespace animation {
	...
	class AnticipateInterpolator
		: public object<AnticipateInterpolator>
	{
	public:
		...
		: object<AnticipateInterpolator>(jobj)
		{
		}
...
: object<android::view::animation::AnticipateInterpolator>(
	call_new_object<
...
android::view::animation::AnticipateInterpolator::AnticipateInterpolator(jfloat a0)
: object<android::view::animation::AnticipateInterpolator>(
	call_new_object<
		android::view::animation::AnticipateInterpolator::J2CPP_CLASS_NAME,
...
jfloat android::view::animation::AnticipateInterpolator::getInterpolation(jfloat a0)
{
	return call_method<
		android::view::animation::AnticipateInterpolator::J2CPP_CLASS_NAME,
