...
J2CPP_DEFINE_METHOD(android::view::ViewGroup,93,"isChildrenDrawingOrderEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,94,"setChildrenDrawingOrderEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,95,"getPersistentDrawingCache","()I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,96,"setPersistentDrawingCache","(I)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,97,"generateLayoutParams","(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,98,"generateLayoutParams","(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,99,"generateDefaultLayoutParams","()Landroid/view/ViewGroup$LayoutParams;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,100,"debug","(I)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,101,"indexOfChild","(Landroid/view/View;)I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,102,"getChildCount","()I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,103,"getChildAt","(I)Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,104,"measureChildren","(II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,105,"measureChild","(Landroid/view/View;II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,106,"measureChildWithMargins","(Landroid/view/View;IIII)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,107,"getChildMeasureSpec","(III)I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,108,"clearDisappearingChildren","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,109,"gatherTransparentRegion","(Landroid/graphics/Region;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,110,"requestTransparentRegion","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,111,"fitSystemWindows","(Landroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,112,"getLayoutAnimationListener","()Landroid/view/animation/Animation$AnimationListener;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,113,"drawableStateChanged","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,114,"onCreateDrawableState","(I)[I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,115,"setAddStatesFromChildren","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,116,"addStatesFromChildren","()Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,117,"childDrawableStateChanged","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,118,"setLayoutAnimationListener","(Landroid/view/animation/Animation$AnimationListener;)V")
