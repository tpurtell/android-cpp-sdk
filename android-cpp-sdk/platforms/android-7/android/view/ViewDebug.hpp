...
namespace android { namespace view {
	...
	namespace ViewDebug_ {
		...
		class ExportedProperty
			: public cpp_object<ExportedProperty>
		{
		public:
			...
			local_ref< cpp_object_array<android::view::ViewDebug_::IntToString, 1> > indexMapping();
			local_ref< cpp_object_array<android::view::ViewDebug_::FlagToString, 1> > flagMapping();
			cpp_boolean deepExport();
			local_ref< java::lang::String > prefix();
		}; //class ExportedProperty

		class RecyclerTraceType;
		class RecyclerTraceType
			: public cpp_object<RecyclerTraceType>
		{
		public:
			...
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), local_ref< android::view::ViewDebug_::RecyclerTraceType > > MOVE_TO_ACTIVE_HEAP;
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), local_ref< android::view::ViewDebug_::RecyclerTraceType > > MOVE_TO_SCRAP_HEAP;
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), local_ref< android::view::ViewDebug_::RecyclerTraceType > > NEW_VIEW;
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(5), J2CPP_FIELD_SIGNATURE(5), local_ref< android::view::ViewDebug_::RecyclerTraceType > > RECYCLE_FROM_ACTIVE_HEAP;
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), local_ref< android::view::ViewDebug_::RecyclerTraceType > > RECYCLE_FROM_SCRAP_HEAP;
		}; //class RecyclerTraceType

		class FlagToString;
		class FlagToString
			: public cpp_object<FlagToString>
		{
		public:
			...
			cpp_boolean outputIf();
		}; //class FlagToString

		class IntToString;
		class IntToString
			: public cpp_object<IntToString>
		{
		public:
		...
		class CapturedViewProperty
			: public cpp_object<CapturedViewProperty>
		{
		public:
		...
		class HierarchyTraceType
			: public cpp_object<HierarchyTraceType>
		{
		public:
	...
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_boolean > TRACE_HIERARCHY;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_boolean > TRACE_RECYCLER;
	}; //class ViewDebug
...
local_ref< cpp_object_array<android::view::ViewDebug_::IntToString, 1> > android::view::ViewDebug_::ExportedProperty::mapping()
{
	return local_ref< cpp_object_array<android::view::ViewDebug_::IntToString, 1> >(
...
local_ref< cpp_object_array<android::view::ViewDebug_::IntToString, 1> > android::view::ViewDebug_::ExportedProperty::indexMapping()
{
	return local_ref< cpp_object_array<android::view::ViewDebug_::IntToString, 1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< cpp_object_array<android::view::ViewDebug_::FlagToString, 1> > android::view::ViewDebug_::ExportedProperty::flagMapping()
{
	return local_ref< cpp_object_array<android::view::ViewDebug_::FlagToString, 1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_boolean android::view::ViewDebug_::ExportedProperty::deepExport()
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
static_field<
	...
	local_ref< android::view::ViewDebug_::RecyclerTraceType >
> android::view::ViewDebug_::RecyclerTraceType::MOVE_TO_ACTIVE_HEAP;
...
static_field<
	android::view::ViewDebug_::RecyclerTraceType::J2CPP_CLASS_NAME,
	android::view::ViewDebug_::RecyclerTraceType::J2CPP_FIELD_NAME(6),
	android::view::ViewDebug_::RecyclerTraceType::J2CPP_FIELD_SIGNATURE(6),
	local_ref< android::view::ViewDebug_::RecyclerTraceType >
...
J2CPP_DEFINE_FIELD(android::view::ViewDebug_::RecyclerTraceType,2,"MOVE_TO_ACTIVE_HEAP","Landroid/view/ViewDebug$RecyclerTraceType;")
J2CPP_DEFINE_FIELD(android::view::ViewDebug_::RecyclerTraceType,3,"MOVE_TO_SCRAP_HEAP","Landroid/view/ViewDebug$RecyclerTraceType;")
J2CPP_DEFINE_FIELD(android::view::ViewDebug_::RecyclerTraceType,4,"NEW_VIEW","Landroid/view/ViewDebug$RecyclerTraceType;")
J2CPP_DEFINE_FIELD(android::view::ViewDebug_::RecyclerTraceType,5,"RECYCLE_FROM_ACTIVE_HEAP","Landroid/view/ViewDebug$RecyclerTraceType;")
...
cpp_int android::view::ViewDebug_::FlagToString::equals()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_boolean android::view::ViewDebug_::FlagToString::outputIf()
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
{
	return local_ref< cpp_object_array<android::view::ViewDebug_::HierarchyTraceType, 1> >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
			get_method_id<J2CPP_CLASS_NAME, J2CPP_METHOD_NAME(0), J2CPP_METHOD_SIGNATURE(0), true>()
		)
