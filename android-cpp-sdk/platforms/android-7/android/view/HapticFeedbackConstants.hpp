...
namespace android { namespace view {
	...
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), jint > FLAG_IGNORE_VIEW_SETTING;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), jint > FLAG_IGNORE_GLOBAL_SETTING;
	}; //class HapticFeedbackConstants
