...
namespace android { namespace view {
	...
	class HapticFeedbackConstants
		: public cpp_object<HapticFeedbackConstants>
	{
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_int > VIRTUAL_KEY;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_int > FLAG_IGNORE_VIEW_SETTING;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), cpp_int > FLAG_IGNORE_GLOBAL_SETTING;
	}; //class HapticFeedbackConstants
...
J2CPP_DEFINE_FIELD(android::view::HapticFeedbackConstants,2,"FLAG_IGNORE_VIEW_SETTING","I")
J2CPP_DEFINE_FIELD(android::view::HapticFeedbackConstants,3,"FLAG_IGNORE_GLOBAL_SETTING","I")
