...
J2CPP_DEFINE_METHOD(android::net::SSLCertificateSocketFactory,2,"createSocket","(Ljava/net/Socket;Ljava/lang/String;IZ)Ljava/net/Socket;")
J2CPP_DEFINE_METHOD(android::net::SSLCertificateSocketFactory,3,"createSocket","(Ljava/net/InetAddress;ILjava/net/InetAddress;I)Ljava/net/Socket;")
J2CPP_DEFINE_METHOD(android::net::SSLCertificateSocketFactory,4,"createSocket","(Ljava/net/InetAddress;I)Ljava/net/Socket;")
J2CPP_DEFINE_METHOD(android::net::SSLCertificateSocketFactory,5,"createSocket","(Ljava/lang/String;ILjava/net/InetAddress;I)Ljava/net/Socket;")
J2CPP_DEFINE_METHOD(android::net::SSLCertificateSocketFactory,6,"createSocket","(Ljava/lang/String;I)Ljava/net/Socket;")
J2CPP_DEFINE_METHOD(android::net::SSLCertificateSocketFactory,7,"getDefaultCipherSuites","()[java.lang.String")
J2CPP_DEFINE_METHOD(android::net::SSLCertificateSocketFactory,8,"getSupportedCipherSuites","()[java.lang.String")
