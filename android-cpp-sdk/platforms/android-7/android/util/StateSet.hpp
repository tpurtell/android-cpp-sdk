...
namespace android { namespace util {
	...
	public:
		...
		static local_ref< cpp_int_array<1> > trimStateSet(local_ref< cpp_int_array<1> > const&, cpp_int const&);
		static local_ref< java::lang::String > dump(local_ref< cpp_int_array<1> > const&);

		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), local_ref< cpp_int_array<1> > > WILD_CARD;
	}; //class StateSet
...
cpp_boolean android::util::StateSet::stateSetMatches(local_ref< cpp_int_array<1> > const &a0, local_ref< cpp_int_array<1> > const &a1)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallStaticBooleanMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
cpp_boolean android::util::StateSet::stateSetMatches(local_ref< cpp_int_array<1> > const &a0, cpp_int const &a1)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallStaticBooleanMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
local_ref< cpp_int_array<1> > android::util::StateSet::trimStateSet(local_ref< cpp_int_array<1> > const &a0, cpp_int const &a1)
{
...
local_ref< java::lang::String > android::util::StateSet::dump(local_ref< cpp_int_array<1> > const &a0)
{
