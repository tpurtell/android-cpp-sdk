...
namespace android { namespace content { namespace pm {
	...
	public:
		...
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), local_ref< array<jint,1> > > gids;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), local_ref< array< local_ref< android::content::pm::ActivityInfo >, 1> > > activities;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(8), J2CPP_FIELD_SIGNATURE(8), local_ref< array< local_ref< android::content::pm::ActivityInfo >, 1> > > receivers;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(9), J2CPP_FIELD_SIGNATURE(9), local_ref< array< local_ref< android::content::pm::ServiceInfo >, 1> > > services;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(10), J2CPP_FIELD_SIGNATURE(10), local_ref< array< local_ref< android::content::pm::ProviderInfo >, 1> > > providers;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(11), J2CPP_FIELD_SIGNATURE(11), local_ref< array< local_ref< android::content::pm::InstrumentationInfo >, 1> > > instrumentation;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(12), J2CPP_FIELD_SIGNATURE(12), local_ref< array< local_ref< android::content::pm::PermissionInfo >, 1> > > permissions;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(13), J2CPP_FIELD_SIGNATURE(13), local_ref< array< local_ref< java::lang::String >, 1> > > requestedPermissions;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(14), J2CPP_FIELD_SIGNATURE(14), local_ref< array< local_ref< android::content::pm::Signature >, 1> > > signatures;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(15), J2CPP_FIELD_SIGNATURE(15), local_ref< array< local_ref< android::content::pm::ConfigurationInfo >, 1> > > configPreferences;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(16), J2CPP_FIELD_SIGNATURE(16), local_ref< array< local_ref< android::content::pm::FeatureInfo >, 1> > > reqFeatures;
