...
namespace android { namespace content {
	...
	public:
		...
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), local_ref< android::content::SyncStats > > stats;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(8), J2CPP_FIELD_SIGNATURE(8), local_ref< android::content::SyncResult > > ALREADY_IN_PROGRESS;
...
static_field<
	android::content::SyncResult::J2CPP_CLASS_NAME,
	android::content::SyncResult::J2CPP_FIELD_NAME(8),
	android::content::SyncResult::J2CPP_FIELD_SIGNATURE(8),
...
J2CPP_DEFINE_FIELD(android::content::SyncResult,7,"stats","Landroid/content/SyncStats;")
J2CPP_DEFINE_FIELD(android::content::SyncResult,8,"ALREADY_IN_PROGRESS","Landroid/content/SyncResult;")
J2CPP_DEFINE_FIELD(android::content::SyncResult,9,"CREATOR","Landroid/os/Parcelable$Creator;")
