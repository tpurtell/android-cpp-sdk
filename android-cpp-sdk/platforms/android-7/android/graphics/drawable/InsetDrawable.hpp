...
namespace android { namespace graphics { namespace drawable {
	...
	class InsetDrawable;
	class InsetDrawable
		: public cpp_object<InsetDrawable>
	{
	public:
...
void android::graphics::drawable::InsetDrawable::scheduleDrawable(local_ref< android::graphics::drawable::Drawable > const &a0, local_ref< java::lang::Runnable > const &a1, cpp_long const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_int android::graphics::drawable::InsetDrawable::getChangingConfigurations()
{
	return cpp_int(
...
cpp_boolean android::graphics::drawable::InsetDrawable::getPadding(local_ref< android::graphics::Rect > const &a0)
{
	return cpp_boolean(
...
cpp_boolean android::graphics::drawable::InsetDrawable::setVisible(cpp_boolean const &a0, cpp_boolean const &a1)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
void android::graphics::drawable::InsetDrawable::setAlpha(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_int android::graphics::drawable::InsetDrawable::getOpacity()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_boolean android::graphics::drawable::InsetDrawable::isStateful()
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
cpp_int android::graphics::drawable::InsetDrawable::getIntrinsicWidth()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int android::graphics::drawable::InsetDrawable::getIntrinsicHeight()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
