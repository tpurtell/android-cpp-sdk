...
android::text::InputFilter_::LengthFilter::LengthFilter(cpp_int const &a0)
: cpp_object<android::text::InputFilter_::LengthFilter>(
...
: cpp_object<android::text::InputFilter_::AllCaps>(
	environment::get().get_jenv()->NewObject(
