...
namespace android { namespace text {
	...
	public:
		...
		DynamicLayout(local_ref< java::lang::CharSequence > const&, local_ref< android::text::TextPaint > const&, cpp_int const&, local_ref< android::text::Layout_::Alignment > const&, cpp_float const&, cpp_float const&, cpp_boolean const&);
		DynamicLayout(local_ref< java::lang::CharSequence > const&, local_ref< java::lang::CharSequence > const&, local_ref< android::text::TextPaint > const&, cpp_int const&, local_ref< android::text::Layout_::Alignment > const&, cpp_float const&, cpp_float const&, cpp_boolean const&);
		DynamicLayout(local_ref< java::lang::CharSequence > const&, local_ref< java::lang::CharSequence > const&, local_ref< android::text::TextPaint > const&, cpp_int const&, local_ref< android::text::Layout_::Alignment > const&, cpp_float const&, cpp_float const&, cpp_boolean const&, local_ref< android::text::TextUtils_::TruncateAt > const&, cpp_int const&);
...
android::text::DynamicLayout::DynamicLayout(local_ref< java::lang::CharSequence > const &a0, local_ref< android::text::TextPaint > const &a1, cpp_int const &a2, local_ref< android::text::Layout_::Alignment > const &a3, cpp_float const &a4, cpp_float const &a5, cpp_boolean const &a6)
: cpp_object<android::text::DynamicLayout>(
...
android::text::DynamicLayout::DynamicLayout(local_ref< java::lang::CharSequence > const &a0, local_ref< java::lang::CharSequence > const &a1, local_ref< android::text::TextPaint > const &a2, cpp_int const &a3, local_ref< android::text::Layout_::Alignment > const &a4, cpp_float const &a5, cpp_float const &a6, cpp_boolean const &a7)
: cpp_object<android::text::DynamicLayout>(
	environment::get().get_jenv()->NewObject(
		get_class<android::text::DynamicLayout::J2CPP_CLASS_NAME>(),
