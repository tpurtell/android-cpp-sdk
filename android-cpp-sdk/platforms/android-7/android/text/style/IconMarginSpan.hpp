...
namespace android { namespace text { namespace style {
	...
	public:
		...
		IconMarginSpan(local_ref< android::graphics::Bitmap > const&, cpp_int const&);
...
: cpp_object<android::text::style::IconMarginSpan>(
...
android::text::style::IconMarginSpan::IconMarginSpan(local_ref< android::graphics::Bitmap > const &a0, cpp_int const &a1)
: cpp_object<android::text::style::IconMarginSpan>(
	environment::get().get_jenv()->NewObject(
		get_class<android::text::style::IconMarginSpan::J2CPP_CLASS_NAME>(),
