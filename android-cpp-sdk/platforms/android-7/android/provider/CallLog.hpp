...
namespace android { namespace provider {
	...
	namespace CallLog_ {
		...
		public:
			...
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), cpp_int > INCOMING_TYPE;
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), cpp_int > OUTGOING_TYPE;
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(8), J2CPP_FIELD_SIGNATURE(8), cpp_int > MISSED_TYPE;
...
J2CPP_DEFINE_METHOD(android::provider::CallLog_::Calls,1,"<clinit>","()V")
