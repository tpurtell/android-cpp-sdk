...
: cpp_object<android::provider::SyncStateContract_::Constants>(
...
: cpp_object<android::provider::SyncStateContract_::Helpers>(
	environment::get().get_jenv()->NewObject(
...
: cpp_object<android::provider::SyncStateContract>(
	environment::get().get_jenv()->NewObject(
