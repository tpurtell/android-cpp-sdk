...
namespace android { namespace bluetooth {
	...
	class BluetoothDevice
		: public cpp_object<BluetoothDevice>
	{
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(14), J2CPP_FIELD_SIGNATURE(14), cpp_int > BOND_NONE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(15), J2CPP_FIELD_SIGNATURE(15), cpp_int > BOND_BONDING;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(16), J2CPP_FIELD_SIGNATURE(16), cpp_int > BOND_BONDED;
...
cpp_int android::bluetooth::BluetoothDevice::hashCode()
{
	return cpp_int(
...
cpp_int android::bluetooth::BluetoothDevice::describeContents()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
void android::bluetooth::BluetoothDevice::writeToParcel(local_ref< android::os::Parcel > const &a0, cpp_int const &a1)
{
	return void(
...
cpp_int android::bluetooth::BluetoothDevice::getBondState()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
