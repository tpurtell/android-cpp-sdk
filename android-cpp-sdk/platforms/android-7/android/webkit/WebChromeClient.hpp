...
J2CPP_DEFINE_METHOD(android::webkit::WebChromeClient,20,"getDefaultVideoPoster","()Landroid/graphics/Bitmap;")
J2CPP_DEFINE_METHOD(android::webkit::WebChromeClient,21,"getVideoLoadingProgressView","()Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::webkit::WebChromeClient,22,"getVisitedHistory","(Landroid/webkit/ValueCallback;)V")
