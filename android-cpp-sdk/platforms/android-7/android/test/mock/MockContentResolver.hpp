...
namespace android { namespace test { namespace mock {
	...
	class MockContentResolver
		: public cpp_object<MockContentResolver>
	{
	public:
...
void android::test::mock::MockContentResolver::notifyChange(local_ref< android::net::Uri > const &a0, local_ref< android::database::ContentObserver > const &a1, cpp_boolean const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
