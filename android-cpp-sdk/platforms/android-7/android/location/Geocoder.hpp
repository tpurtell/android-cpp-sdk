...
J2CPP_DEFINE_METHOD(android::location::Geocoder,2,"getFromLocation","(DDI)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::location::Geocoder,3,"getFromLocationName","(Ljava/lang/String;I)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::location::Geocoder,4,"getFromLocationName","(Ljava/lang/String;IDDDD)Ljava/util/List;")
