...
void android::widget::AutoCompleteTextView::dismissDropDown()
{
	return call_method<
		android::widget::AutoCompleteTextView::J2CPP_CLASS_NAME,
		android::widget::AutoCompleteTextView::J2CPP_METHOD_NAME(47),
		android::widget::AutoCompleteTextView::J2CPP_METHOD_SIGNATURE(47), 
		void >
	(get_jobject());
}
...
void android::widget::AutoCompleteTextView::showDropDown()
{
	return call_method<
		android::widget::AutoCompleteTextView::J2CPP_CLASS_NAME,
		android::widget::AutoCompleteTextView::J2CPP_METHOD_NAME(49),
		android::widget::AutoCompleteTextView::J2CPP_METHOD_SIGNATURE(49), 
		void >
	(get_jobject());
}
