...
namespace android { namespace widget {
	...
	class ZoomControls;
	class ZoomControls
		: public cpp_object<ZoomControls>
	{
	public:
		...
		void show();
		void hide();
		void setIsZoomInEnabled(cpp_boolean const&);
		void setIsZoomOutEnabled(cpp_boolean const&);
...
void android::widget::ZoomControls::setZoomSpeed(cpp_long const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_boolean android::widget::ZoomControls::onTouchEvent(local_ref< android::view::MotionEvent > const &a0)
{
	return cpp_boolean(
...
void android::widget::ZoomControls::setIsZoomInEnabled(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::widget::ZoomControls::setIsZoomOutEnabled(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_boolean android::widget::ZoomControls::hasFocus()
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
