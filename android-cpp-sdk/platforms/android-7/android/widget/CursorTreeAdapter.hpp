...
namespace android { namespace widget {
	...
	class CursorTreeAdapter
		: public cpp_object<CursorTreeAdapter>
	{
	public:
		...
		local_ref< android::database::Cursor > getGroup(cpp_int const&);
		...
		void notifyDataSetChanged(cpp_boolean const&);
		...
		local_ref< java::lang::Object > getChild_1(cpp_int const&, cpp_int const&);
		local_ref< java::lang::Object > getGroup_1(cpp_int const&);
	}; //class CursorTreeAdapter
...
void android::widget::CursorTreeAdapter::setChildrenCursor(cpp_int const &a0, local_ref< android::database::Cursor > const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
local_ref< android::database::Cursor > android::widget::CursorTreeAdapter::getChild(cpp_int const &a0, cpp_int const &a1)
{
...
cpp_long android::widget::CursorTreeAdapter::getChildId(cpp_int const &a0, cpp_int const &a1)
{
	return cpp_long(
...
cpp_int android::widget::CursorTreeAdapter::getChildrenCount(cpp_int const &a0)
{
	return cpp_int(
...
local_ref< android::database::Cursor > android::widget::CursorTreeAdapter::getGroup(cpp_int const &a0)
{
	return local_ref< android::database::Cursor >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_int android::widget::CursorTreeAdapter::getGroupCount()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_long android::widget::CursorTreeAdapter::getGroupId(cpp_int const &a0)
{
	return cpp_long(
		environment::get().get_jenv()->CallLongMethod(
			get_jtype(),
...
local_ref< android::view::View > android::widget::CursorTreeAdapter::getGroupView(cpp_int const &a0, cpp_boolean const &a1, local_ref< android::view::View > const &a2, local_ref< android::view::ViewGroup > const &a3)
{
...
local_ref< android::view::View > android::widget::CursorTreeAdapter::getChildView(cpp_int const &a0, cpp_int const &a1, cpp_boolean const &a2, local_ref< android::view::View > const &a3, local_ref< android::view::ViewGroup > const &a4)
{
	return local_ref< android::view::View >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_boolean android::widget::CursorTreeAdapter::isChildSelectable(cpp_int const &a0, cpp_int const &a1)
{
	return cpp_boolean(
...
cpp_boolean android::widget::CursorTreeAdapter::hasStableIds()
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
void android::widget::CursorTreeAdapter::notifyDataSetChanged(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::widget::CursorTreeAdapter::onGroupCollapsed(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
local_ref< java::lang::Object > android::widget::CursorTreeAdapter::getChild_1(cpp_int const &a0, cpp_int const &a1)
{
...
local_ref< java::lang::Object > android::widget::CursorTreeAdapter::getGroup_1(cpp_int const &a0)
{
	return local_ref< java::lang::Object >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
