...
namespace android { namespace app {
	...
	class LocalActivityManager
		: public cpp_object<LocalActivityManager>
	{
	public:
		...
		void dispatchResume();
		void dispatchPause(cpp_boolean const&);
		void dispatchStop();
		void removeAllActivities();
		void dispatchDestroy(cpp_boolean const&);
	}; //class LocalActivityManager
...
local_ref< android::view::Window > android::app::LocalActivityManager::destroyActivity(local_ref< java::lang::String > const &a0, cpp_boolean const &a1)
{
	return local_ref< android::view::Window >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
void android::app::LocalActivityManager::dispatchPause(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::app::LocalActivityManager::dispatchDestroy(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
