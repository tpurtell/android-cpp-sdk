...
namespace android { namespace nfc {
	...
	public:
		...
		NdefRecord(jobject jobj)
		: cpp_object<NdefRecord>(jobj)
		{
		}

		cpp_short getTnf();
		local_ref< cpp_byte_array<1> > getType();
		local_ref< cpp_byte_array<1> > getId();
		local_ref< cpp_byte_array<1> > getPayload();
		local_ref< cpp_byte_array<1> > toByteArray();
		cpp_int describeContents();
		void writeToParcel(local_ref< android::os::Parcel > const&, cpp_int const&);

		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_short > TNF_EMPTY;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_short > TNF_WELL_KNOWN;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_short > TNF_MIME_MEDIA;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), cpp_short > TNF_ABSOLUTE_URI;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), cpp_short > TNF_EXTERNAL_TYPE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(5), J2CPP_FIELD_SIGNATURE(5), cpp_short > TNF_UNKNOWN;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), cpp_short > TNF_UNCHANGED;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), local_ref< cpp_byte_array<1> > > RTD_TEXT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(8), J2CPP_FIELD_SIGNATURE(8), local_ref< cpp_byte_array<1> > > RTD_URI;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(9), J2CPP_FIELD_SIGNATURE(9), local_ref< cpp_byte_array<1> > > RTD_SMART_POSTER;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(10), J2CPP_FIELD_SIGNATURE(10), local_ref< cpp_byte_array<1> > > RTD_ALTERNATIVE_CARRIER;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(11), J2CPP_FIELD_SIGNATURE(11), local_ref< cpp_byte_array<1> > > RTD_HANDOVER_CARRIER;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(12), J2CPP_FIELD_SIGNATURE(12), local_ref< cpp_byte_array<1> > > RTD_HANDOVER_REQUEST;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(13), J2CPP_FIELD_SIGNATURE(13), local_ref< cpp_byte_array<1> > > RTD_HANDOVER_SELECT;
...
template <>
local_ref< android::nfc::NdefRecord > create< android::nfc::NdefRecord>(cpp_short const &a0, local_ref< cpp_byte_array<1> > const &a1, local_ref< cpp_byte_array<1> > const &a2, local_ref< cpp_byte_array<1> > const &a3)
{
	return local_ref< android::nfc::NdefRecord >(
		environment::get().get_jenv()->NewObject(
			get_class<android::nfc::NdefRecord::J2CPP_CLASS_NAME>(),
			get_method_id<android::nfc::NdefRecord::J2CPP_CLASS_NAME, android::nfc::NdefRecord::J2CPP_METHOD_NAME(0), android::nfc::NdefRecord::J2CPP_METHOD_SIGNATURE(0), false>(),
...
template <>
local_ref< android::nfc::NdefRecord > create< android::nfc::NdefRecord>(local_ref< cpp_byte_array<1> > const &a0)
{
	return local_ref< android::nfc::NdefRecord >(
		environment::get().get_jenv()->NewObject(
			get_class<android::nfc::NdefRecord::J2CPP_CLASS_NAME>(),
			get_method_id<android::nfc::NdefRecord::J2CPP_CLASS_NAME, android::nfc::NdefRecord::J2CPP_METHOD_NAME(1), android::nfc::NdefRecord::J2CPP_METHOD_SIGNATURE(1), false>(),
			a0.get_jtype()
		)
	);
}

cpp_short android::nfc::NdefRecord::getTnf()
{
	return cpp_short(
...
local_ref< cpp_byte_array<1> > android::nfc::NdefRecord::getType()
{
...
local_ref< cpp_byte_array<1> > android::nfc::NdefRecord::getId()
{
	return local_ref< cpp_byte_array<1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< cpp_byte_array<1> > android::nfc::NdefRecord::getPayload()
{
	return local_ref< cpp_byte_array<1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< cpp_byte_array<1> > android::nfc::NdefRecord::toByteArray()
{
	return local_ref< cpp_byte_array<1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_int android::nfc::NdefRecord::describeContents()
{
	return cpp_int(
...
void android::nfc::NdefRecord::writeToParcel(local_ref< android::os::Parcel > const &a0, cpp_int const &a1)
{
	return void(
