...
namespace android { namespace service { namespace wallpaper {
	...
	namespace WallpaperService_ {
		...
		public:
			...
			void onSurfaceRedrawNeeded(local_ref< android::view::SurfaceHolder > const&);
...
J2CPP_DEFINE_METHOD(android::service::wallpaper::WallpaperService_::Engine,15,"onSurfaceRedrawNeeded","(Landroid/view/SurfaceHolder;)V")
J2CPP_DEFINE_METHOD(android::service::wallpaper::WallpaperService_::Engine,16,"onSurfaceCreated","(Landroid/view/SurfaceHolder;)V")
J2CPP_DEFINE_METHOD(android::service::wallpaper::WallpaperService_::Engine,17,"onSurfaceDestroyed","(Landroid/view/SurfaceHolder;)V")
