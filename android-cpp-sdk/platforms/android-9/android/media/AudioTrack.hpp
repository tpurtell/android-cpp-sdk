...
namespace android { namespace media {
	...
	public:
		...
		cpp_int attachAuxEffect(cpp_int const&);
		cpp_int setAuxEffectSendLevel(cpp_float const&);
...
template <>
local_ref< android::media::AudioTrack > create< android::media::AudioTrack>(cpp_int const &a0, cpp_int const &a1, cpp_int const &a2, cpp_int const &a3, cpp_int const &a4, cpp_int const &a5, cpp_int const &a6)
{
	return local_ref< android::media::AudioTrack >(
		environment::get().get_jenv()->NewObject(
			get_class<android::media::AudioTrack::J2CPP_CLASS_NAME>(),
			get_method_id<android::media::AudioTrack::J2CPP_CLASS_NAME, android::media::AudioTrack::J2CPP_METHOD_NAME(1), android::media::AudioTrack::J2CPP_METHOD_SIGNATURE(1), false>(),
...
cpp_int android::media::AudioTrack::getAudioSessionId()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int android::media::AudioTrack::attachAuxEffect(cpp_int const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int android::media::AudioTrack::setAuxEffectSendLevel(cpp_float const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
