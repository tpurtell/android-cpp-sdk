...
local_ref< java::lang::String > android::content::IntentSender::getTargetPackage()
{
	return call_method<
		android::content::IntentSender::J2CPP_CLASS_NAME,
...
local_ref< android::content::IntentSender > android::content::IntentSender::readIntentSenderOrNullFromParcel(local_ref< android::os::Parcel > const &a0)
{
	return call_static_method<
		android::content::IntentSender::J2CPP_CLASS_NAME,
		android::content::IntentSender::J2CPP_METHOD_NAME(9),
		android::content::IntentSender::J2CPP_METHOD_SIGNATURE(9), 
...
J2CPP_DEFINE_METHOD(android::content::IntentSender,2,"getTargetPackage","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::content::IntentSender,3,"equals","(Ljava/lang/Object;)Z")
J2CPP_DEFINE_METHOD(android::content::IntentSender,4,"hashCode","()I")
J2CPP_DEFINE_METHOD(android::content::IntentSender,5,"toString","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::content::IntentSender,6,"describeContents","()I")
J2CPP_DEFINE_METHOD(android::content::IntentSender,7,"writeToParcel","(Landroid/os/Parcel;I)V")
J2CPP_DEFINE_METHOD(android::content::IntentSender,8,"writeIntentSenderOrNullToParcel","(Landroid/content/IntentSender;Landroid/os/Parcel;)V")
J2CPP_DEFINE_METHOD(android::content::IntentSender,9,"readIntentSenderOrNullFromParcel","(Landroid/os/Parcel;)Landroid/content/IntentSender;")
J2CPP_DEFINE_METHOD(android::content::IntentSender,10,"<clinit>","()V")
