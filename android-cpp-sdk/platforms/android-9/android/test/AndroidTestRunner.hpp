...
namespace android { namespace test {
	...
	class AndroidTestRunner
		: public cpp_object<AndroidTestRunner>
	{
	public:
...
void android::test::AndroidTestRunner::testFailed(cpp_int const &a0, local_ref< junit::framework::Test > const &a1, local_ref< java::lang::Throwable > const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
