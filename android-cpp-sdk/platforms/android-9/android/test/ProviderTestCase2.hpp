...
namespace android { namespace test {
	...
	class ProviderTestCase2
		: public cpp_object<ProviderTestCase2>
	{
	public:
		...
		static local_ref< android::content::ContentResolver > newResolverWithContentProviderFromSql(local_ref< android::content::Context > const&, local_ref< java::lang::String > const&, local_ref< java::lang::Class > const&, local_ref< java::lang::String > const&, local_ref< java::lang::String > const&, cpp_int const&, local_ref< java::lang::String > const&);
	}; //class ProviderTestCase2
...
local_ref< android::content::ContentResolver > android::test::ProviderTestCase2::newResolverWithContentProviderFromSql(local_ref< android::content::Context > const &a0, local_ref< java::lang::String > const &a1, local_ref< java::lang::Class > const &a2, local_ref< java::lang::String > const &a3, local_ref< java::lang::String > const &a4, cpp_int const &a5, local_ref< java::lang::String > const &a6)
{
