...
template <>
local_ref< android::view::GestureDetector > create< android::view::GestureDetector>(local_ref< android::content::Context > const &a0, local_ref< android::view::GestureDetector_::OnGestureListener > const &a1, local_ref< android::os::Handler > const &a2, cpp_boolean const &a3)
{
	return local_ref< android::view::GestureDetector >(
		environment::get().get_jenv()->NewObject(
			get_class<android::view::GestureDetector::J2CPP_CLASS_NAME>(),
			get_method_id<android::view::GestureDetector::J2CPP_CLASS_NAME, android::view::GestureDetector::J2CPP_METHOD_NAME(4), android::view::GestureDetector::J2CPP_METHOD_SIGNATURE(4), false>(),
			a0.get_jtype(), a1.get_jtype(), a2.get_jtype(), a3.get_jtype()
		)
	);
}
