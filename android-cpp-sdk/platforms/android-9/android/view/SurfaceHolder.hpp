...
namespace android { namespace view {
	...
	namespace SurfaceHolder_ {
		...
		public:
			...
			Callback2(jobject jobj)
			: cpp_object<Callback2>(jobj)
			{
			}
	...
	public:
		...
		typedef SurfaceHolder_::Callback2 Callback2;
...
void android::view::SurfaceHolder_::Callback2::surfaceRedrawNeeded(local_ref< android::view::SurfaceHolder > const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
J2CPP_DEFINE_CLASS(android::view::SurfaceHolder_::Callback2,"android/view/SurfaceHolder$Callback2")
J2CPP_DEFINE_METHOD(android::view::SurfaceHolder_::Callback2,0,"surfaceRedrawNeeded","(Landroid/view/SurfaceHolder;)V")
