...
namespace android { namespace view {
	...
	namespace SurfaceHolder_ {
		...
		public:
			...
			explicit Callback2(jobject jobj)
			: object<Callback2>(jobj)
			{
			}
...
android::view::SurfaceHolder_::Callback2::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

android::view::SurfaceHolder_::Callback2::operator local_ref<android::view::SurfaceHolder_::Callback>() const
{
...
{
	return call_method<
		android::view::SurfaceHolder_::Callback2::J2CPP_CLASS_NAME,
		android::view::SurfaceHolder_::Callback2::J2CPP_METHOD_NAME(0),
		android::view::SurfaceHolder_::Callback2::J2CPP_METHOD_SIGNATURE(0), 
		void >
	(get_jobject(), a0);
}
