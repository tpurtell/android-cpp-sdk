...
local_ref< java::lang::CharSequence > android::view::inputmethod::InputConnectionWrapper::getSelectedText(cpp_int const &a0)
{
	return local_ref< java::lang::CharSequence >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_boolean android::view::inputmethod::InputConnectionWrapper::setComposingRegion(cpp_int const &a0, cpp_int const &a1)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
