...
namespace android { namespace hardware {
	...
	public:
		...
		static jfloat getAltitude(jfloat, jfloat);
		static void getAngleChange(local_ref< array<jfloat,1> >  const&, local_ref< array<jfloat,1> >  const&, local_ref< array<jfloat,1> >  const&);
		static void getRotationMatrixFromVector(local_ref< array<jfloat,1> >  const&, local_ref< array<jfloat,1> >  const&);
		static void getQuaternionFromVector(local_ref< array<jfloat,1> >  const&, local_ref< array<jfloat,1> >  const&);
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(34), J2CPP_FIELD_SIGNATURE(34), jfloat > PRESSURE_STANDARD_ATMOSPHERE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(35), J2CPP_FIELD_SIGNATURE(35), jfloat > LIGHT_SUNLIGHT_MAX;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(36), J2CPP_FIELD_SIGNATURE(36), jfloat > LIGHT_SUNLIGHT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(37), J2CPP_FIELD_SIGNATURE(37), jfloat > LIGHT_SHADE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(38), J2CPP_FIELD_SIGNATURE(38), jfloat > LIGHT_OVERCAST;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(39), J2CPP_FIELD_SIGNATURE(39), jfloat > LIGHT_SUNRISE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(40), J2CPP_FIELD_SIGNATURE(40), jfloat > LIGHT_CLOUDY;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(41), J2CPP_FIELD_SIGNATURE(41), jfloat > LIGHT_FULLMOON;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(42), J2CPP_FIELD_SIGNATURE(42), jfloat > LIGHT_NO_MOON;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(43), J2CPP_FIELD_SIGNATURE(43), jint > SENSOR_DELAY_FASTEST;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(44), J2CPP_FIELD_SIGNATURE(44), jint > SENSOR_DELAY_GAME;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(45), J2CPP_FIELD_SIGNATURE(45), jint > SENSOR_DELAY_UI;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(46), J2CPP_FIELD_SIGNATURE(46), jint > SENSOR_DELAY_NORMAL;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(47), J2CPP_FIELD_SIGNATURE(47), jint > SENSOR_STATUS_UNRELIABLE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(48), J2CPP_FIELD_SIGNATURE(48), jint > SENSOR_STATUS_ACCURACY_LOW;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(49), J2CPP_FIELD_SIGNATURE(49), jint > SENSOR_STATUS_ACCURACY_MEDIUM;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(50), J2CPP_FIELD_SIGNATURE(50), jint > SENSOR_STATUS_ACCURACY_HIGH;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(51), J2CPP_FIELD_SIGNATURE(51), jint > AXIS_X;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(52), J2CPP_FIELD_SIGNATURE(52), jint > AXIS_Y;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(53), J2CPP_FIELD_SIGNATURE(53), jint > AXIS_Z;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(54), J2CPP_FIELD_SIGNATURE(54), jint > AXIS_MINUS_X;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(55), J2CPP_FIELD_SIGNATURE(55), jint > AXIS_MINUS_Y;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(56), J2CPP_FIELD_SIGNATURE(56), jint > AXIS_MINUS_Z;
	}; //class SensorManager
...
jfloat android::hardware::SensorManager::getAltitude(jfloat a0, jfloat a1)
{
	return call_static_method<
		android::hardware::SensorManager::J2CPP_CLASS_NAME,
		android::hardware::SensorManager::J2CPP_METHOD_NAME(16),
		android::hardware::SensorManager::J2CPP_METHOD_SIGNATURE(16), 
		jfloat >
	(a0, a1);
}

void android::hardware::SensorManager::getAngleChange(local_ref< array<jfloat,1> > const &a0, local_ref< array<jfloat,1> > const &a1, local_ref< array<jfloat,1> > const &a2)
{
	return call_static_method<
		android::hardware::SensorManager::J2CPP_CLASS_NAME,
		android::hardware::SensorManager::J2CPP_METHOD_NAME(17),
		android::hardware::SensorManager::J2CPP_METHOD_SIGNATURE(17), 
		void >
	(a0, a1, a2);
}

void android::hardware::SensorManager::getRotationMatrixFromVector(local_ref< array<jfloat,1> > const &a0, local_ref< array<jfloat,1> > const &a1)
{
	return call_static_method<
		android::hardware::SensorManager::J2CPP_CLASS_NAME,
		android::hardware::SensorManager::J2CPP_METHOD_NAME(18),
		android::hardware::SensorManager::J2CPP_METHOD_SIGNATURE(18), 
		void >
	(a0, a1);
}

void android::hardware::SensorManager::getQuaternionFromVector(local_ref< array<jfloat,1> > const &a0, local_ref< array<jfloat,1> > const &a1)
{
	return call_static_method<
		android::hardware::SensorManager::J2CPP_CLASS_NAME,
		android::hardware::SensorManager::J2CPP_METHOD_NAME(19),
		android::hardware::SensorManager::J2CPP_METHOD_SIGNATURE(19), 
		void >
	(a0, a1);
}
...
static_field<
	android::hardware::SensorManager::J2CPP_CLASS_NAME,
	android::hardware::SensorManager::J2CPP_FIELD_NAME(56),
	android::hardware::SensorManager::J2CPP_FIELD_SIGNATURE(56),
	jint
...
J2CPP_DEFINE_METHOD(android::hardware::SensorManager,16,"getAltitude","(FF)F")
J2CPP_DEFINE_METHOD(android::hardware::SensorManager,17,"getAngleChange","([F[F[F)V")
J2CPP_DEFINE_METHOD(android::hardware::SensorManager,18,"getRotationMatrixFromVector","([F[F)V")
J2CPP_DEFINE_METHOD(android::hardware::SensorManager,19,"getQuaternionFromVector","([F[F)V")
...
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,34,"PRESSURE_STANDARD_ATMOSPHERE","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,35,"LIGHT_SUNLIGHT_MAX","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,36,"LIGHT_SUNLIGHT","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,37,"LIGHT_SHADE","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,38,"LIGHT_OVERCAST","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,39,"LIGHT_SUNRISE","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,40,"LIGHT_CLOUDY","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,41,"LIGHT_FULLMOON","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,42,"LIGHT_NO_MOON","F")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,43,"SENSOR_DELAY_FASTEST","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,44,"SENSOR_DELAY_GAME","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,45,"SENSOR_DELAY_UI","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,46,"SENSOR_DELAY_NORMAL","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,47,"SENSOR_STATUS_UNRELIABLE","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,48,"SENSOR_STATUS_ACCURACY_LOW","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,49,"SENSOR_STATUS_ACCURACY_MEDIUM","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,50,"SENSOR_STATUS_ACCURACY_HIGH","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,51,"AXIS_X","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,52,"AXIS_Y","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,53,"AXIS_Z","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,54,"AXIS_MINUS_X","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,55,"AXIS_MINUS_Y","I")
J2CPP_DEFINE_FIELD(android::hardware::SensorManager,56,"AXIS_MINUS_Z","I")
