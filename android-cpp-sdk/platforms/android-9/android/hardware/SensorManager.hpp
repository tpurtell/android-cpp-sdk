...
namespace android { namespace hardware {
	...
	public:
		...
		static cpp_float getAltitude(cpp_float const&, cpp_float const&);
		static void getAngleChange(local_ref< cpp_float_array<1> > const&, local_ref< cpp_float_array<1> > const&, local_ref< cpp_float_array<1> > const&);
		static void getRotationMatrixFromVector(local_ref< cpp_float_array<1> > const&, local_ref< cpp_float_array<1> > const&);
		static void getQuaternionFromVector(local_ref< cpp_float_array<1> > const&, local_ref< cpp_float_array<1> > const&);
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(34), J2CPP_FIELD_SIGNATURE(34), cpp_float > PRESSURE_STANDARD_ATMOSPHERE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(35), J2CPP_FIELD_SIGNATURE(35), cpp_float > LIGHT_SUNLIGHT_MAX;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(36), J2CPP_FIELD_SIGNATURE(36), cpp_float > LIGHT_SUNLIGHT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(37), J2CPP_FIELD_SIGNATURE(37), cpp_float > LIGHT_SHADE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(38), J2CPP_FIELD_SIGNATURE(38), cpp_float > LIGHT_OVERCAST;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(39), J2CPP_FIELD_SIGNATURE(39), cpp_float > LIGHT_SUNRISE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(40), J2CPP_FIELD_SIGNATURE(40), cpp_float > LIGHT_CLOUDY;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(41), J2CPP_FIELD_SIGNATURE(41), cpp_float > LIGHT_FULLMOON;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(42), J2CPP_FIELD_SIGNATURE(42), cpp_float > LIGHT_NO_MOON;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(43), J2CPP_FIELD_SIGNATURE(43), cpp_int > SENSOR_DELAY_FASTEST;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(44), J2CPP_FIELD_SIGNATURE(44), cpp_int > SENSOR_DELAY_GAME;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(45), J2CPP_FIELD_SIGNATURE(45), cpp_int > SENSOR_DELAY_UI;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(46), J2CPP_FIELD_SIGNATURE(46), cpp_int > SENSOR_DELAY_NORMAL;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(47), J2CPP_FIELD_SIGNATURE(47), cpp_int > SENSOR_STATUS_UNRELIABLE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(48), J2CPP_FIELD_SIGNATURE(48), cpp_int > SENSOR_STATUS_ACCURACY_LOW;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(49), J2CPP_FIELD_SIGNATURE(49), cpp_int > SENSOR_STATUS_ACCURACY_MEDIUM;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(50), J2CPP_FIELD_SIGNATURE(50), cpp_int > SENSOR_STATUS_ACCURACY_HIGH;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(51), J2CPP_FIELD_SIGNATURE(51), cpp_int > AXIS_X;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(52), J2CPP_FIELD_SIGNATURE(52), cpp_int > AXIS_Y;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(53), J2CPP_FIELD_SIGNATURE(53), cpp_int > AXIS_Z;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(54), J2CPP_FIELD_SIGNATURE(54), cpp_int > AXIS_MINUS_X;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(55), J2CPP_FIELD_SIGNATURE(55), cpp_int > AXIS_MINUS_Y;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(56), J2CPP_FIELD_SIGNATURE(56), cpp_int > AXIS_MINUS_Z;
	}; //class SensorManager
...
cpp_float android::hardware::SensorManager::getAltitude(cpp_float const &a0, cpp_float const &a1)
{
	return cpp_float(
		environment::get().get_jenv()->CallStaticFloatMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
void android::hardware::SensorManager::getAngleChange(local_ref< cpp_float_array<1> > const &a0, local_ref< cpp_float_array<1> > const &a1, local_ref< cpp_float_array<1> > const &a2)
{
	return void(
...
void android::hardware::SensorManager::getRotationMatrixFromVector(local_ref< cpp_float_array<1> > const &a0, local_ref< cpp_float_array<1> > const &a1)
{
	return void(
		environment::get().get_jenv()->CallStaticVoidMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
void android::hardware::SensorManager::getQuaternionFromVector(local_ref< cpp_float_array<1> > const &a0, local_ref< cpp_float_array<1> > const &a1)
{
	return void(
		environment::get().get_jenv()->CallStaticVoidMethod(
			get_class<J2CPP_CLASS_NAME>(),
