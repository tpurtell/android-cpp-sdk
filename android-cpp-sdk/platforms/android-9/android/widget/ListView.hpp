...
namespace android { namespace widget {
	...
	public:
		...
		void setOverscrollHeader(local_ref< android::graphics::drawable::Drawable > const&);
		local_ref< android::graphics::drawable::Drawable > getOverscrollHeader();
		void setOverscrollFooter(local_ref< android::graphics::drawable::Drawable > const&);
		local_ref< android::graphics::drawable::Drawable > getOverscrollFooter();
		...
		local_ref< cpp_long_array<1> > getCheckedItemIds();
		void clearChoices();
...
local_ref< cpp_long_array<1> > android::widget::ListView::getCheckedItemIds()
{
	return local_ref< cpp_long_array<1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
J2CPP_DEFINE_METHOD(android::widget::ListView,37,"setOverscrollHeader","(Landroid/graphics/drawable/Drawable;)V")
J2CPP_DEFINE_METHOD(android::widget::ListView,38,"getOverscrollHeader","()Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::widget::ListView,39,"setOverscrollFooter","(Landroid/graphics/drawable/Drawable;)V")
J2CPP_DEFINE_METHOD(android::widget::ListView,40,"getOverscrollFooter","()Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::widget::ListView,41,"onFocusChanged","(ZILandroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::widget::ListView,42,"onFinishInflate","()V")
J2CPP_DEFINE_METHOD(android::widget::ListView,43,"findViewTraversal","(I)Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::widget::ListView,44,"findViewWithTagTraversal","(Ljava/lang/Object;)Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::widget::ListView,45,"onTouchEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::widget::ListView,46,"getChoiceMode","()I")
J2CPP_DEFINE_METHOD(android::widget::ListView,47,"setChoiceMode","(I)V")
J2CPP_DEFINE_METHOD(android::widget::ListView,48,"performItemClick","(Landroid/view/View;IJ)Z")
J2CPP_DEFINE_METHOD(android::widget::ListView,49,"setItemChecked","(IZ)V")
J2CPP_DEFINE_METHOD(android::widget::ListView,50,"isItemChecked","(I)Z")
J2CPP_DEFINE_METHOD(android::widget::ListView,51,"getCheckedItemPosition","()I")
J2CPP_DEFINE_METHOD(android::widget::ListView,52,"getCheckedItemPositions","()Landroid/util/SparseBooleanArray;")
J2CPP_DEFINE_METHOD(android::widget::ListView,53,"getCheckItemIds","()[J")
J2CPP_DEFINE_METHOD(android::widget::ListView,54,"getCheckedItemIds","()[J")
J2CPP_DEFINE_METHOD(android::widget::ListView,55,"clearChoices","()V")
J2CPP_DEFINE_METHOD(android::widget::ListView,56,"onSaveInstanceState","()Landroid/os/Parcelable;")
J2CPP_DEFINE_METHOD(android::widget::ListView,57,"onRestoreInstanceState","(Landroid/os/Parcelable;)V")
J2CPP_DEFINE_METHOD(android::widget::ListView,58,"setAdapter","(Landroid/widget/Adapter;)V")
J2CPP_DEFINE_METHOD(android::widget::ListView,59,"getAdapter","()Landroid/widget/Adapter;")
