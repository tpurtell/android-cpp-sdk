...
void android::widget::HorizontalScrollView::setOverScrollMode(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,19,"onOverScrolled","(IIZZ)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,20,"pageScroll","(I)Z")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,21,"fullScroll","(I)Z")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,22,"arrowScroll","(I)Z")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,23,"smoothScrollBy","(II)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,24,"smoothScrollTo","(II)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,25,"computeHorizontalScrollRange","()I")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,26,"computeHorizontalScrollOffset","()I")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,27,"measureChild","(Landroid/view/View;II)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,28,"measureChildWithMargins","(Landroid/view/View;IIII)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,29,"computeScroll","()V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,30,"computeScrollDeltaToGetChildRectOnScreen","(Landroid/graphics/Rect;)I")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,31,"requestChildFocus","(Landroid/view/View;Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,32,"onRequestFocusInDescendants","(ILandroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,33,"requestChildRectangleOnScreen","(Landroid/view/View;Landroid/graphics/Rect;Z)Z")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,34,"requestLayout","()V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,35,"onLayout","(ZIIII)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,36,"onSizeChanged","(IIII)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,37,"fling","(I)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,38,"scrollTo","(II)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,39,"setOverScrollMode","(I)V")
J2CPP_DEFINE_METHOD(android::widget::HorizontalScrollView,40,"draw","(Landroid/graphics/Canvas;)V")
