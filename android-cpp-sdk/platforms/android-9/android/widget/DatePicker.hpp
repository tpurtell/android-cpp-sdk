...
namespace android { namespace widget {
	...
	namespace DatePicker_ {
		...
		class OnDateChangedListener
			: public cpp_object<OnDateChangedListener>
		{
		public:
...
void android::widget::DatePicker::updateDate(cpp_int const &a0, cpp_int const &a1, cpp_int const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::widget::DatePicker::init(cpp_int const &a0, cpp_int const &a1, cpp_int const &a2, local_ref< android::widget::DatePicker_::OnDateChangedListener > const &a3)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_int android::widget::DatePicker::getYear()
{
	return cpp_int(
...
cpp_int android::widget::DatePicker::getMonth()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int android::widget::DatePicker::getDayOfMonth()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
