...
namespace android { namespace text { namespace style {
	...
	namespace LeadingMarginSpan_ {
		...
		class LeadingMarginSpan2
			: public cpp_object<LeadingMarginSpan2>
		{
		public:
			...
			LeadingMarginSpan2(jobject jobj)
			: cpp_object<LeadingMarginSpan2>(jobj)
			{
			}

			cpp_int getLeadingMarginLineCount();
		}; //class LeadingMarginSpan2
...
cpp_int android::text::style::LeadingMarginSpan_::LeadingMarginSpan2::getLeadingMarginLineCount()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
