...
namespace android { namespace speech { namespace tts {
	...
	public:
		...
		cpp_int setEngineByPackageName(local_ref< java::lang::String > const&);
		local_ref< java::lang::String > getDefaultEngine();
		cpp_boolean areDefaultsEnforced();
...
cpp_int android::speech::tts::TextToSpeech::setEngineByPackageName(local_ref< java::lang::String > const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_boolean android::speech::tts::TextToSpeech::areDefaultsEnforced()
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
