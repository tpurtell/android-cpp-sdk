...
namespace android { namespace provider {
	...
	public:
		...
		AlarmClock(jobject jobj)
		: cpp_object<AlarmClock>(jobj)
		{
		}
...
template <>
local_ref< android::provider::AlarmClock > create< android::provider::AlarmClock>()
{
	return local_ref< android::provider::AlarmClock >(
		environment::get().get_jenv()->NewObject(
			get_class<android::provider::AlarmClock::J2CPP_CLASS_NAME>(),
			get_method_id<android::provider::AlarmClock::J2CPP_CLASS_NAME, android::provider::AlarmClock::J2CPP_METHOD_NAME(0), android::provider::AlarmClock::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
