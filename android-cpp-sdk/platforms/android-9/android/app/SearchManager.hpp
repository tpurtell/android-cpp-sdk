...
namespace android { namespace app {
	...
	class SearchManager
		: public cpp_object<SearchManager>
	{
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_char > MENU_KEY;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_int > MENU_KEYCODE;
