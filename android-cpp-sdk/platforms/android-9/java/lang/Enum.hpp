...
jint java::lang::Enum::compareTo(local_ref< java::lang::Object > const &a0)
{
	return call_method<
		java::lang::Enum::J2CPP_CLASS_NAME,
		java::lang::Enum::J2CPP_METHOD_NAME(11),
		java::lang::Enum::J2CPP_METHOD_SIGNATURE(11), 
		jint >
	(get_jobject(), a0);
}
...
J2CPP_DEFINE_METHOD(java::lang::Enum,10,"finalize","()V")
J2CPP_DEFINE_METHOD(java::lang::Enum,11,"compareTo","(Ljava/lang/Object;)I")
