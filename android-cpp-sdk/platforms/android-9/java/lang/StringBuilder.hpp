...
cpp_int java::lang::StringBuilder::offsetByCodePoints(cpp_int const &a0, cpp_int const &a1)
{
	return cpp_int(
...
cpp_int java::lang::StringBuilder::codePointCount(cpp_int const &a0, cpp_int const &a1)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::lang::StringBuilder::codePointBefore(cpp_int const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::lang::StringBuilder::codePointAt(cpp_int const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::lang::StringBuilder::lastIndexOf(local_ref< java::lang::String > const &a0, cpp_int const &a1)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::lang::StringBuilder::lastIndexOf(local_ref< java::lang::String > const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::lang::StringBuilder::indexOf(local_ref< java::lang::String > const &a0, cpp_int const &a1)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::lang::StringBuilder::indexOf(local_ref< java::lang::String > const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
local_ref< java::lang::CharSequence > java::lang::StringBuilder::subSequence(cpp_int const &a0, cpp_int const &a1)
{
...
local_ref< java::lang::String > java::lang::StringBuilder::substring(cpp_int const &a0, cpp_int const &a1)
{
	return local_ref< java::lang::String >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< java::lang::String > java::lang::StringBuilder::substring(cpp_int const &a0)
{
	return local_ref< java::lang::String >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
void java::lang::StringBuilder::setLength(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void java::lang::StringBuilder::setCharAt(cpp_int const &a0, cpp_char const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_int java::lang::StringBuilder::length()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
void java::lang::StringBuilder::getChars(cpp_int const &a0, cpp_int const &a1, local_ref< cpp_char_array<1> > const &a2, cpp_int const &a3)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void java::lang::StringBuilder::ensureCapacity(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_char java::lang::StringBuilder::charAt(cpp_int const &a0)
{
	return cpp_char(
...
cpp_int java::lang::StringBuilder::capacity()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,35,"offsetByCodePoints","(II)I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,36,"codePointCount","(II)I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,37,"codePointBefore","(I)I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,38,"codePointAt","(I)I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,39,"trimToSize","()V")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,40,"lastIndexOf","(Ljava/lang/String;I)I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,41,"lastIndexOf","(Ljava/lang/String;)I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,42,"indexOf","(Ljava/lang/String;I)I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,43,"indexOf","(Ljava/lang/String;)I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,44,"subSequence","(II)Ljava/lang/CharSequence;")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,45,"substring","(II)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,46,"substring","(I)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,47,"setLength","(I)V")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,48,"setCharAt","(IC)V")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,49,"length","()I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,50,"getChars","(II[CI)V")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,51,"ensureCapacity","(I)V")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,52,"charAt","(I)C")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,53,"capacity","()I")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,54,"append","(Ljava/lang/CharSequence;II)Ljava/lang/Appendable;")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,55,"append","(Ljava/lang/CharSequence;)Ljava/lang/Appendable;")
J2CPP_DEFINE_METHOD(java::lang::StringBuilder,56,"append","(C)Ljava/lang/Appendable;")
