...
template <>
local_ref< java::util::PropertyResourceBundle > create< java::util::PropertyResourceBundle>(local_ref< java::io::Reader > const &a0)
{
	return local_ref< java::util::PropertyResourceBundle >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::PropertyResourceBundle::J2CPP_CLASS_NAME>(),
			get_method_id<java::util::PropertyResourceBundle::J2CPP_CLASS_NAME, java::util::PropertyResourceBundle::J2CPP_METHOD_NAME(1), java::util::PropertyResourceBundle::J2CPP_METHOD_SIGNATURE(1), false>(),
			a0.get_jtype()
		)
	);
}
