...
namespace java { namespace util {
	...
	public:
		...
		static local_ref< cpp_object_array<java::lang::String, 1> > getISOCountries();
		static local_ref< cpp_object_array<java::lang::String, 1> > getISOLanguages();
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(16), J2CPP_FIELD_SIGNATURE(16), local_ref< java::util::Locale > > ROOT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(17), J2CPP_FIELD_SIGNATURE(17), local_ref< java::util::Locale > > SIMPLIFIED_CHINESE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(18), J2CPP_FIELD_SIGNATURE(18), local_ref< java::util::Locale > > TAIWAN;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(19), J2CPP_FIELD_SIGNATURE(19), local_ref< java::util::Locale > > TRADITIONAL_CHINESE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(20), J2CPP_FIELD_SIGNATURE(20), local_ref< java::util::Locale > > UK;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(21), J2CPP_FIELD_SIGNATURE(21), local_ref< java::util::Locale > > US;
	}; //class Locale
...
cpp_boolean java::util::Locale::equals(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
...
local_ref< cpp_object_array<java::util::Locale, 1> > java::util::Locale::getAvailableLocales()
{
...
local_ref< cpp_object_array<java::lang::String, 1> > java::util::Locale::getISOCountries()
{
...
local_ref< cpp_object_array<java::lang::String, 1> > java::util::Locale::getISOLanguages()
{
	return local_ref< cpp_object_array<java::lang::String, 1> >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
cpp_int java::util::Locale::hashCode()
{
	return cpp_int(
...
static_field<
	java::util::Locale::J2CPP_CLASS_NAME,
	java::util::Locale::J2CPP_FIELD_NAME(21),
	java::util::Locale::J2CPP_FIELD_SIGNATURE(21),
	local_ref< java::util::Locale >
> java::util::Locale::US;
...
J2CPP_DEFINE_FIELD(java::util::Locale,16,"ROOT","Ljava/util/Locale;")
J2CPP_DEFINE_FIELD(java::util::Locale,17,"SIMPLIFIED_CHINESE","Ljava/util/Locale;")
J2CPP_DEFINE_FIELD(java::util::Locale,18,"TAIWAN","Ljava/util/Locale;")
J2CPP_DEFINE_FIELD(java::util::Locale,19,"TRADITIONAL_CHINESE","Ljava/util/Locale;")
J2CPP_DEFINE_FIELD(java::util::Locale,20,"UK","Ljava/util/Locale;")
J2CPP_DEFINE_FIELD(java::util::Locale,21,"US","Ljava/util/Locale;")
