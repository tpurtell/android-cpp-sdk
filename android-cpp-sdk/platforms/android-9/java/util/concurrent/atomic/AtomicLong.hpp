...
void java::util::concurrent::atomic::AtomicLong::lazySet(jlong a0)
{
	return call_method<
		java::util::concurrent::atomic::AtomicLong::J2CPP_CLASS_NAME,
...
jdouble java::util::concurrent::atomic::AtomicLong::doubleValue()
{
	return call_method<
		java::util::concurrent::atomic::AtomicLong::J2CPP_CLASS_NAME,
		java::util::concurrent::atomic::AtomicLong::J2CPP_METHOD_NAME(18),
		java::util::concurrent::atomic::AtomicLong::J2CPP_METHOD_SIGNATURE(18), 
		jdouble >
	(get_jobject());
}
...
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,4,"lazySet","(J)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,5,"getAndSet","(J)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,6,"compareAndSet","(JJ)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,7,"weakCompareAndSet","(JJ)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,8,"getAndIncrement","()J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,9,"getAndDecrement","()J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,10,"getAndAdd","(J)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,11,"incrementAndGet","()J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,12,"decrementAndGet","()J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,13,"addAndGet","(J)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,14,"toString","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,15,"intValue","()I")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,16,"longValue","()J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,17,"floatValue","()F")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLong,18,"doubleValue","()D")
