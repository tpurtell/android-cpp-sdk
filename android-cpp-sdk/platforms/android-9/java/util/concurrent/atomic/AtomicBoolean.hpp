...
void java::util::concurrent::atomic::AtomicBoolean::lazySet(jboolean a0)
{
	return call_method<
		java::util::concurrent::atomic::AtomicBoolean::J2CPP_CLASS_NAME,
...
local_ref< java::lang::String > java::util::concurrent::atomic::AtomicBoolean::toString()
{
	return call_method<
		java::util::concurrent::atomic::AtomicBoolean::J2CPP_CLASS_NAME,
		java::util::concurrent::atomic::AtomicBoolean::J2CPP_METHOD_NAME(8),
		java::util::concurrent::atomic::AtomicBoolean::J2CPP_METHOD_SIGNATURE(8), 
...
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicBoolean,6,"lazySet","(Z)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicBoolean,7,"getAndSet","(Z)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicBoolean,8,"toString","()Ljava/lang/String;")
