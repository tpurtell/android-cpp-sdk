...
namespace java { namespace util { namespace concurrent { namespace atomic {
	...
	public:
		...
		void lazySet(local_ref< java::lang::Object > const&, cpp_int const&);
...
void java::util::concurrent::atomic::AtomicIntegerFieldUpdater::lazySet(local_ref< java::lang::Object > const &a0, cpp_int const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
