...
namespace java { namespace util { namespace concurrent { namespace atomic {
	...
	public:
		...
		void lazySet(local_ref< java::lang::Object > const&, cpp_long const&);
...
void java::util::concurrent::atomic::AtomicLongFieldUpdater::lazySet(local_ref< java::lang::Object > const &a0, cpp_long const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
