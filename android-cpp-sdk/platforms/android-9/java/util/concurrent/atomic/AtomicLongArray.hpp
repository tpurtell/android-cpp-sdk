...
namespace java { namespace util { namespace concurrent { namespace atomic {
	...
	public:
		...
		void lazySet(cpp_int const&, cpp_long const&);
...
template <>
local_ref< java::util::concurrent::atomic::AtomicLongArray > create< java::util::concurrent::atomic::AtomicLongArray>(cpp_int const &a0)
{
	return local_ref< java::util::concurrent::atomic::AtomicLongArray >(
...
template <>
local_ref< java::util::concurrent::atomic::AtomicLongArray > create< java::util::concurrent::atomic::AtomicLongArray>(local_ref< cpp_long_array<1> > const &a0)
{
	return local_ref< java::util::concurrent::atomic::AtomicLongArray >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::concurrent::atomic::AtomicLongArray::J2CPP_CLASS_NAME>(),
...
void java::util::concurrent::atomic::AtomicLongArray::lazySet(cpp_int const &a0, cpp_long const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,5,"lazySet","(IJ)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,6,"getAndSet","(IJ)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,7,"compareAndSet","(IJJ)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,8,"weakCompareAndSet","(IJJ)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,9,"getAndIncrement","(I)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,10,"getAndDecrement","(I)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,11,"getAndAdd","(IJ)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,12,"incrementAndGet","(I)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,13,"decrementAndGet","(I)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,14,"addAndGet","(IJ)J")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicLongArray,15,"toString","()Ljava/lang/String;")
