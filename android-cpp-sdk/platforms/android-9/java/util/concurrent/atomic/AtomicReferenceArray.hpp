...
namespace java { namespace util { namespace concurrent { namespace atomic {
	...
	public:
		...
		void lazySet(cpp_int const&, local_ref< java::lang::Object > const&);
...
void java::util::concurrent::atomic::AtomicReferenceArray::lazySet(cpp_int const &a0, local_ref< java::lang::Object > const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
