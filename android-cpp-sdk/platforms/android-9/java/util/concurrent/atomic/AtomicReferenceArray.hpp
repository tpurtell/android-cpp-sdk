...
namespace java { namespace util { namespace concurrent { namespace atomic {
	...
	public:
		...
		void lazySet(jint, local_ref< java::lang::Object >  const&);
...
void java::util::concurrent::atomic::AtomicReferenceArray::lazySet(jint a0, local_ref< java::lang::Object > const &a1)
{
	return call_method<
		java::util::concurrent::atomic::AtomicReferenceArray::J2CPP_CLASS_NAME,
...
local_ref< java::lang::String > java::util::concurrent::atomic::AtomicReferenceArray::toString()
{
	return call_method<
		java::util::concurrent::atomic::AtomicReferenceArray::J2CPP_CLASS_NAME,
		java::util::concurrent::atomic::AtomicReferenceArray::J2CPP_METHOD_NAME(9),
		java::util::concurrent::atomic::AtomicReferenceArray::J2CPP_METHOD_SIGNATURE(9), 
...
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicReferenceArray,5,"lazySet","(ILjava/lang/Object;)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicReferenceArray,6,"getAndSet","(ILjava/lang/Object;)Ljava/lang/Object;")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicReferenceArray,7,"compareAndSet","(ILjava/lang/Object;Ljava/lang/Object;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicReferenceArray,8,"weakCompareAndSet","(ILjava/lang/Object;Ljava/lang/Object;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::atomic::AtomicReferenceArray,9,"toString","()Ljava/lang/String;")
