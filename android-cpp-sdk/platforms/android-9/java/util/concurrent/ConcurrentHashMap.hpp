...
template <>
local_ref< java::util::concurrent::ConcurrentHashMap > create< java::util::concurrent::ConcurrentHashMap>(cpp_int const &a0, cpp_float const &a1)
{
	return local_ref< java::util::concurrent::ConcurrentHashMap >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::concurrent::ConcurrentHashMap::J2CPP_CLASS_NAME>(),
...
local_ref< java::util::concurrent::ConcurrentHashMap > create< java::util::concurrent::ConcurrentHashMap>(local_ref< java::util::Map > const &a0)
{
	return local_ref< java::util::concurrent::ConcurrentHashMap >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::concurrent::ConcurrentHashMap::J2CPP_CLASS_NAME>(),
			get_method_id<java::util::concurrent::ConcurrentHashMap::J2CPP_CLASS_NAME, java::util::concurrent::ConcurrentHashMap::J2CPP_METHOD_NAME(4), java::util::concurrent::ConcurrentHashMap::J2CPP_METHOD_SIGNATURE(4), false>(),
			a0.get_jtype()
		)
	);
}
