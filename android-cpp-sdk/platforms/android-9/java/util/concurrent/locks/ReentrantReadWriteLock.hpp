...
cpp_boolean java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::isHeldByCurrentThread()
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
cpp_int java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::getHoldCount()
{
	return cpp_int(
...
cpp_int java::util::concurrent::locks::ReentrantReadWriteLock::getReadHoldCount()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
