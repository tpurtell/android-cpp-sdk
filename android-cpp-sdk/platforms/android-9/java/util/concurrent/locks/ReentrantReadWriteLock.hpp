...
jboolean java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::isHeldByCurrentThread()
{
	return call_method<
		java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::J2CPP_CLASS_NAME,
		java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::J2CPP_METHOD_NAME(8),
		java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::J2CPP_METHOD_SIGNATURE(8), 
		jboolean >
	(get_jobject());
}

jint java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::getHoldCount()
{
	return call_method<
		java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::J2CPP_CLASS_NAME,
		java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::J2CPP_METHOD_NAME(9),
		java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock::J2CPP_METHOD_SIGNATURE(9), 
		jint >
	(get_jobject());
}
...
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock,8,"isHeldByCurrentThread","()Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock_::WriteLock,9,"getHoldCount","()I")
...
jint java::util::concurrent::locks::ReentrantReadWriteLock::getReadHoldCount()
{
	return call_method<
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_CLASS_NAME,
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_METHOD_NAME(10),
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_METHOD_SIGNATURE(10), 
		jint >
	(get_jobject());
}
...
jint java::util::concurrent::locks::ReentrantReadWriteLock::getQueueLength()
{
	return call_method<
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_CLASS_NAME,
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_METHOD_NAME(15),
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_METHOD_SIGNATURE(15), 
		jint >
	(get_jobject());
}
...
jint java::util::concurrent::locks::ReentrantReadWriteLock::getWaitQueueLength(local_ref< java::util::concurrent::locks::Condition > const &a0)
{
	return call_method<
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_CLASS_NAME,
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_METHOD_NAME(18),
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_METHOD_SIGNATURE(18), 
		jint >
	(get_jobject(), a0);
}
...
local_ref< java::util::concurrent::locks::Lock > java::util::concurrent::locks::ReentrantReadWriteLock::readLock_1()
{
	return call_method<
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_CLASS_NAME,
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_METHOD_NAME(22),
		java::util::concurrent::locks::ReentrantReadWriteLock::J2CPP_METHOD_SIGNATURE(22), 
		local_ref< java::util::concurrent::locks::Lock > >
	(get_jobject());
}
...
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,10,"getReadHoldCount","()I")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,11,"getQueuedWriterThreads","()Ljava/util/Collection;")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,12,"getQueuedReaderThreads","()Ljava/util/Collection;")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,13,"hasQueuedThreads","()Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,14,"hasQueuedThread","(Ljava/lang/Thread;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,15,"getQueueLength","()I")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,16,"getQueuedThreads","()Ljava/util/Collection;")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,17,"hasWaiters","(Ljava/util/concurrent/locks/Condition;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,18,"getWaitQueueLength","(Ljava/util/concurrent/locks/Condition;)I")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,19,"getWaitingThreads","(Ljava/util/concurrent/locks/Condition;)Ljava/util/Collection;")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,20,"toString","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,21,"writeLock","()Ljava/util/concurrent/locks/Lock;")
J2CPP_DEFINE_METHOD(java::util::concurrent::locks::ReentrantReadWriteLock,22,"readLock","()Ljava/util/concurrent/locks/Lock;")
