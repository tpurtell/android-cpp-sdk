...
namespace java { namespace util { namespace concurrent {
	...
	public:
		...
		cpp_long toMinutes(cpp_long const&);
		cpp_long toHours(cpp_long const&);
		cpp_long toDays(cpp_long const&);
...
cpp_long java::util::concurrent::TimeUnit::toMinutes(cpp_long const &a0)
{
	return cpp_long(
		environment::get().get_jenv()->CallLongMethod(
			get_jtype(),
...
cpp_long java::util::concurrent::TimeUnit::toHours(cpp_long const &a0)
{
	return cpp_long(
		environment::get().get_jenv()->CallLongMethod(
			get_jtype(),
...
cpp_long java::util::concurrent::TimeUnit::toDays(cpp_long const &a0)
{
	return cpp_long(
		environment::get().get_jenv()->CallLongMethod(
			get_jtype(),
