...
cpp_boolean java::util::Deque::offerFirst(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
...
cpp_boolean java::util::Deque::offerLast(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
cpp_boolean java::util::Deque::removeFirstOccurrence(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
cpp_boolean java::util::Deque::removeLastOccurrence(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
