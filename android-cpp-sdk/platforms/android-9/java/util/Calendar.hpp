...
namespace java { namespace util {
	...
	public:
		...
		local_ref< java::lang::String > getDisplayName(cpp_int const&, cpp_int const&, local_ref< java::util::Locale > const&);
		local_ref< java::util::Map > getDisplayNames(cpp_int const&, cpp_int const&, local_ref< java::util::Locale > const&);
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(46), J2CPP_FIELD_SIGNATURE(46), cpp_int > ALL_STYLES;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(47), J2CPP_FIELD_SIGNATURE(47), cpp_int > SHORT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(48), J2CPP_FIELD_SIGNATURE(48), cpp_int > LONG;
	}; //class Calendar
...
local_ref< java::lang::String > java::util::Calendar::getDisplayName(cpp_int const &a0, cpp_int const &a1, local_ref< java::util::Locale > const &a2)
{
	return local_ref< java::lang::String >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< java::util::Map > java::util::Calendar::getDisplayNames(cpp_int const &a0, cpp_int const &a1, local_ref< java::util::Locale > const &a2)
{
