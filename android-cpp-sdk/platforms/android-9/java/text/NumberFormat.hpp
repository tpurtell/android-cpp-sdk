...
J2CPP_DEFINE_METHOD(java::text::NumberFormat,37,"getRoundingMode","()Ljava/math/RoundingMode;")
J2CPP_DEFINE_METHOD(java::text::NumberFormat,38,"setRoundingMode","(Ljava/math/RoundingMode;)V")
