...
namespace java { namespace io {
	...
	public:
		...
		static local_ref< java::io::ObjectStreamClass > lookupAny(local_ref< java::lang::Class >  const&);
...
J2CPP_DEFINE_METHOD(java::io::ObjectStreamClass,7,"lookupAny","(Ljava/lang/Class;)Ljava/io/ObjectStreamClass;")
J2CPP_DEFINE_METHOD(java::io::ObjectStreamClass,8,"toString","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::io::ObjectStreamClass,9,"<clinit>","()V")
