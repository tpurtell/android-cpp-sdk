...
template <>
local_ref< java::io::PipedReader > create< java::io::PipedReader>(cpp_int const &a0)
{
	return local_ref< java::io::PipedReader >(
		environment::get().get_jenv()->NewObject(
			get_class<java::io::PipedReader::J2CPP_CLASS_NAME>(),
			get_method_id<java::io::PipedReader::J2CPP_CLASS_NAME, java::io::PipedReader::J2CPP_METHOD_NAME(2), java::io::PipedReader::J2CPP_METHOD_SIGNATURE(2), false>(),
			a0.get_jtype()
		)
	);
}
...
template <>
local_ref< java::io::PipedReader > create< java::io::PipedReader>(local_ref< java::io::PipedWriter > const &a0, cpp_int const &a1)
{
	return local_ref< java::io::PipedReader >(
		environment::get().get_jenv()->NewObject(
			get_class<java::io::PipedReader::J2CPP_CLASS_NAME>(),
			get_method_id<java::io::PipedReader::J2CPP_CLASS_NAME, java::io::PipedReader::J2CPP_METHOD_NAME(3), java::io::PipedReader::J2CPP_METHOD_SIGNATURE(3), false>(),
