...
namespace java { namespace io {
	...
	public:
		...
		jboolean setExecutable(jboolean, jboolean);
		jboolean setExecutable(jboolean);
		jboolean setReadable(jboolean, jboolean);
		jboolean setReadable(jboolean);
		jboolean setWritable(jboolean, jboolean);
		jboolean setWritable(jboolean);
		jlong length();
