...
namespace java { namespace io {
	...
	class FileDescriptor
		: public cpp_object<FileDescriptor>
	{
	public:
...
cpp_boolean java::io::FileDescriptor::valid()
{
	return cpp_boolean(
...
J2CPP_DEFINE_METHOD(java::io::FileDescriptor,3,"toString","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::io::FileDescriptor,4,"<clinit>","()V")
