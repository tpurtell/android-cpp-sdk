...
namespace java { namespace nio {
	...
	public:
		...
		local_ref< java::lang::Object > array();
		cpp_int arrayOffset();
		cpp_int capacity();
...
local_ref< java::lang::Object > java::nio::Buffer::array()
{
...
cpp_int java::nio::Buffer::arrayOffset()
{
	return cpp_int(
...
cpp_boolean java::nio::Buffer::hasArray()
{
	return cpp_boolean(
...
cpp_boolean java::nio::Buffer::isDirect()
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
