...
template <>
local_ref< java::security::cert::CertificateException > create< java::security::cert::CertificateException>(local_ref< java::lang::String > const &a0)
{
	return local_ref< java::security::cert::CertificateException >(
...
template <>
local_ref< java::security::cert::CertificateException > create< java::security::cert::CertificateException>()
{
	return local_ref< java::security::cert::CertificateException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CertificateException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::cert::CertificateException > create< java::security::cert::CertificateException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1)
{
	return local_ref< java::security::cert::CertificateException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CertificateException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::cert::CertificateException > create< java::security::cert::CertificateException>(local_ref< java::lang::Throwable > const &a0)
{
	return local_ref< java::security::cert::CertificateException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CertificateException::J2CPP_CLASS_NAME>(),
