...
namespace java { namespace security { namespace cert {
	...
	public:
		...
		CertPathValidatorException(jobject jobj)
...
template <>
local_ref< java::security::cert::CertPathValidatorException > create< java::security::cert::CertPathValidatorException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1, local_ref< java::security::cert::CertPath > const &a2, cpp_int const &a3)
{
	return local_ref< java::security::cert::CertPathValidatorException >(
...
template <>
local_ref< java::security::cert::CertPathValidatorException > create< java::security::cert::CertPathValidatorException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1)
{
	return local_ref< java::security::cert::CertPathValidatorException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CertPathValidatorException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::cert::CertPathValidatorException > create< java::security::cert::CertPathValidatorException>(local_ref< java::lang::Throwable > const &a0)
{
	return local_ref< java::security::cert::CertPathValidatorException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CertPathValidatorException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::cert::CertPathValidatorException > create< java::security::cert::CertPathValidatorException>(local_ref< java::lang::String > const &a0)
{
	return local_ref< java::security::cert::CertPathValidatorException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CertPathValidatorException::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::security::cert::CertPathValidatorException > create< java::security::cert::CertPathValidatorException>()
{
	return local_ref< java::security::cert::CertPathValidatorException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::security::cert::CertPathValidatorException::J2CPP_CLASS_NAME>(),
