...
namespace java { namespace sql {
	...
	public:
		...
		local_ref< java::io::InputStream > getBinaryStream(cpp_long const&, cpp_long const&);
...
local_ref< java::io::InputStream > java::sql::Blob::getBinaryStream(cpp_long const &a0, cpp_long const &a1)
{
	return local_ref< java::io::InputStream >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
J2CPP_DEFINE_METHOD(java::sql::Blob,1,"getBinaryStream","(JJ)Ljava/io/InputStream;")
J2CPP_DEFINE_METHOD(java::sql::Blob,2,"getBytes","(JI)[B")
J2CPP_DEFINE_METHOD(java::sql::Blob,3,"length","()J")
J2CPP_DEFINE_METHOD(java::sql::Blob,4,"position","(Ljava/sql/Blob;J)J")
J2CPP_DEFINE_METHOD(java::sql::Blob,5,"position","([BJ)J")
J2CPP_DEFINE_METHOD(java::sql::Blob,6,"setBinaryStream","(J)Ljava/io/OutputStream;")
J2CPP_DEFINE_METHOD(java::sql::Blob,7,"setBytes","(J[B)I")
J2CPP_DEFINE_METHOD(java::sql::Blob,8,"setBytes","(J[BII)I")
J2CPP_DEFINE_METHOD(java::sql::Blob,9,"truncate","(J)V")
J2CPP_DEFINE_METHOD(java::sql::Blob,10,"free","()V")
