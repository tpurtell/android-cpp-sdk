...
namespace java { namespace sql {
	...
	public:
		...
		SQLWarning(local_ref< java::lang::Throwable > const&);
		SQLWarning(local_ref< java::lang::String > const&, local_ref< java::lang::Throwable > const&);
		SQLWarning(local_ref< java::lang::String > const&, local_ref< java::lang::String > const&, local_ref< java::lang::Throwable > const&);
		SQLWarning(local_ref< java::lang::String > const&, local_ref< java::lang::String > const&, jint, local_ref< java::lang::Throwable > const&);
...
java::sql::SQLWarning::SQLWarning(local_ref< java::lang::Throwable > const &a0)
: object<java::sql::SQLWarning>(
	call_new_object<
		java::sql::SQLWarning::J2CPP_CLASS_NAME,
...
java::sql::SQLWarning::SQLWarning(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1)
: object<java::sql::SQLWarning>(
	call_new_object<
		java::sql::SQLWarning::J2CPP_CLASS_NAME,
...
java::sql::SQLWarning::SQLWarning(local_ref< java::lang::String > const &a0, local_ref< java::lang::String > const &a1, local_ref< java::lang::Throwable > const &a2)
: object<java::sql::SQLWarning>(
	call_new_object<
		java::sql::SQLWarning::J2CPP_CLASS_NAME,
...
java::sql::SQLWarning::SQLWarning(local_ref< java::lang::String > const &a0, local_ref< java::lang::String > const &a1, jint a2, local_ref< java::lang::Throwable > const &a3)
: object<java::sql::SQLWarning>(
	call_new_object<
		java::sql::SQLWarning::J2CPP_CLASS_NAME,
