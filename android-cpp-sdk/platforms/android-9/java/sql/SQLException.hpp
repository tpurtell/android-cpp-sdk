...
template <>
local_ref< java::sql::SQLException > create< java::sql::SQLException>(local_ref< java::lang::Throwable > const &a0)
{
	return local_ref< java::sql::SQLException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::sql::SQLException::J2CPP_CLASS_NAME>(),
			get_method_id<java::sql::SQLException::J2CPP_CLASS_NAME, java::sql::SQLException::J2CPP_METHOD_NAME(4), java::sql::SQLException::J2CPP_METHOD_SIGNATURE(4), false>(),
			a0.get_jtype()
		)
	);
}
...
template <>
local_ref< java::sql::SQLException > create< java::sql::SQLException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::Throwable > const &a1)
{
	return local_ref< java::sql::SQLException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::sql::SQLException::J2CPP_CLASS_NAME>(),
			get_method_id<java::sql::SQLException::J2CPP_CLASS_NAME, java::sql::SQLException::J2CPP_METHOD_NAME(5), java::sql::SQLException::J2CPP_METHOD_SIGNATURE(5), false>(),
			a0.get_jtype(), a1.get_jtype()
		)
	);
}
...
template <>
local_ref< java::sql::SQLException > create< java::sql::SQLException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::String > const &a1, local_ref< java::lang::Throwable > const &a2)
{
	return local_ref< java::sql::SQLException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::sql::SQLException::J2CPP_CLASS_NAME>(),
			get_method_id<java::sql::SQLException::J2CPP_CLASS_NAME, java::sql::SQLException::J2CPP_METHOD_NAME(6), java::sql::SQLException::J2CPP_METHOD_SIGNATURE(6), false>(),
			a0.get_jtype(), a1.get_jtype(), a2.get_jtype()
		)
	);
}
...
template <>
local_ref< java::sql::SQLException > create< java::sql::SQLException>(local_ref< java::lang::String > const &a0, local_ref< java::lang::String > const &a1, cpp_int const &a2, local_ref< java::lang::Throwable > const &a3)
{
	return local_ref< java::sql::SQLException >(
		environment::get().get_jenv()->NewObject(
			get_class<java::sql::SQLException::J2CPP_CLASS_NAME>(),
			get_method_id<java::sql::SQLException::J2CPP_CLASS_NAME, java::sql::SQLException::J2CPP_METHOD_NAME(7), java::sql::SQLException::J2CPP_METHOD_SIGNATURE(7), false>(),
