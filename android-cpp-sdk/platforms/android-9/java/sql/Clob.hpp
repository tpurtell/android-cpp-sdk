...
namespace java { namespace sql {
	...
	public:
		...
		void free();
		local_ref< java::io::Reader > getCharacterStream(cpp_long const&, cpp_long const&);
	}; //class Clob
...
local_ref< java::io::Reader > java::sql::Clob::getCharacterStream(cpp_long const &a0, cpp_long const &a1)
{
	return local_ref< java::io::Reader >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
J2CPP_DEFINE_METHOD(java::sql::Clob,11,"free","()V")
J2CPP_DEFINE_METHOD(java::sql::Clob,12,"getCharacterStream","(JJ)Ljava/io/Reader;")
