...
namespace java { namespace sql {
	...
	public:
		...
		DataTruncation(jint, jboolean, jboolean, jint, jint, local_ref< java::lang::Throwable > const&);
		jint getDataSize();
		jint getIndex();
...
java::sql::DataTruncation::DataTruncation(jint a0, jboolean a1, jboolean a2, jint a3, jint a4, local_ref< java::lang::Throwable > const &a5)
: object<java::sql::DataTruncation>(
	call_new_object<
		java::sql::DataTruncation::J2CPP_CLASS_NAME,
...
jint java::sql::DataTruncation::getTransferSize()
{
	return call_method<
		java::sql::DataTruncation::J2CPP_CLASS_NAME,
		java::sql::DataTruncation::J2CPP_METHOD_NAME(6),
		java::sql::DataTruncation::J2CPP_METHOD_SIGNATURE(6), 
		jint >
	(get_jobject());
}
