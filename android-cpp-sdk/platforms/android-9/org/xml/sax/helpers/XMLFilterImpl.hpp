...
namespace org { namespace xml { namespace sax { namespace helpers {
	...
	class XMLFilterImpl;
	class XMLFilterImpl
		: public cpp_object<XMLFilterImpl>
	{
	public:
...
void org::xml::sax::helpers::XMLFilterImpl::setFeature(local_ref< java::lang::String > const &a0, cpp_boolean const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
cpp_boolean org::xml::sax::helpers::XMLFilterImpl::getFeature(local_ref< java::lang::String > const &a0)
{
	return cpp_boolean(
...
void org::xml::sax::helpers::XMLFilterImpl::characters(local_ref< cpp_char_array<1> > const &a0, cpp_int const &a1, cpp_int const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void org::xml::sax::helpers::XMLFilterImpl::ignorableWhitespace(local_ref< cpp_char_array<1> > const &a0, cpp_int const &a1, cpp_int const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
