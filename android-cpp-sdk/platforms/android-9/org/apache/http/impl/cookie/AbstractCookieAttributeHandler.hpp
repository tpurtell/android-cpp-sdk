...
namespace org { namespace apache { namespace http { namespace impl { namespace cookie {
	...
	class AbstractCookieAttributeHandler
		: public cpp_object<AbstractCookieAttributeHandler>
	{
	public:
...
cpp_boolean org::apache::http::impl::cookie::AbstractCookieAttributeHandler::match(local_ref< org::apache::http::cookie::Cookie > const &a0, local_ref< org::apache::http::cookie::CookieOrigin > const &a1)
{
	return cpp_boolean(
