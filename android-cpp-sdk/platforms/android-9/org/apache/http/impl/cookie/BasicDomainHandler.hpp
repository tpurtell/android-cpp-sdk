...
namespace org { namespace apache { namespace http { namespace impl { namespace cookie {
	...
	class BasicDomainHandler
		: public cpp_object<BasicDomainHandler>
	{
	public:
		...
		BasicDomainHandler(jobject jobj)
		: cpp_object<BasicDomainHandler>(jobj)
		{
		}
...
template <>
local_ref< org::apache::http::impl::cookie::BasicDomainHandler > create< org::apache::http::impl::cookie::BasicDomainHandler>()
{
	return local_ref< org::apache::http::impl::cookie::BasicDomainHandler >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::impl::cookie::BasicDomainHandler::J2CPP_CLASS_NAME>(),
			get_method_id<org::apache::http::impl::cookie::BasicDomainHandler::J2CPP_CLASS_NAME, org::apache::http::impl::cookie::BasicDomainHandler::J2CPP_METHOD_NAME(0), org::apache::http::impl::cookie::BasicDomainHandler::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
...
cpp_boolean org::apache::http::impl::cookie::BasicDomainHandler::match(local_ref< org::apache::http::cookie::Cookie > const &a0, local_ref< org::apache::http::cookie::CookieOrigin > const &a1)
{
	return cpp_boolean(
