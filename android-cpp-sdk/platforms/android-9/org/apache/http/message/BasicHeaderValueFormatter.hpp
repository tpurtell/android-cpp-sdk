...
namespace org { namespace apache { namespace http { namespace message {
	...
	class BasicHeaderValueFormatter
		: public cpp_object<BasicHeaderValueFormatter>
	{
	public:
		...
		static local_ref< java::lang::String > formatParameters(local_ref< cpp_object_array<org::apache::http::NameValuePair, 1> > const&, cpp_boolean const&, local_ref< org::apache::http::message::HeaderValueFormatter > const&);
		...
		static local_ref< java::lang::String > formatNameValuePair(local_ref< org::apache::http::NameValuePair > const&, cpp_boolean const&, local_ref< org::apache::http::message::HeaderValueFormatter > const&);
...
local_ref< org::apache::http::util::CharArrayBuffer > org::apache::http::message::BasicHeaderValueFormatter::formatElements(local_ref< org::apache::http::util::CharArrayBuffer > const &a0, local_ref< cpp_object_array<org::apache::http::HeaderElement, 1> > const &a1, cpp_boolean const &a2)
{
...
local_ref< java::lang::String > org::apache::http::message::BasicHeaderValueFormatter::formatHeaderElement(local_ref< org::apache::http::HeaderElement > const &a0, cpp_boolean const &a1, local_ref< org::apache::http::message::HeaderValueFormatter > const &a2)
{
	return local_ref< java::lang::String >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
local_ref< org::apache::http::util::CharArrayBuffer > org::apache::http::message::BasicHeaderValueFormatter::formatHeaderElement(local_ref< org::apache::http::util::CharArrayBuffer > const &a0, local_ref< org::apache::http::HeaderElement > const &a1, cpp_boolean const &a2)
{
	return local_ref< org::apache::http::util::CharArrayBuffer >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< java::lang::String > org::apache::http::message::BasicHeaderValueFormatter::formatParameters(local_ref< cpp_object_array<org::apache::http::NameValuePair, 1> > const &a0, cpp_boolean const &a1, local_ref< org::apache::http::message::HeaderValueFormatter > const &a2)
{
	return local_ref< java::lang::String >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
local_ref< org::apache::http::util::CharArrayBuffer > org::apache::http::message::BasicHeaderValueFormatter::formatParameters(local_ref< org::apache::http::util::CharArrayBuffer > const &a0, local_ref< cpp_object_array<org::apache::http::NameValuePair, 1> > const &a1, cpp_boolean const &a2)
{
	return local_ref< org::apache::http::util::CharArrayBuffer >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< java::lang::String > org::apache::http::message::BasicHeaderValueFormatter::formatNameValuePair(local_ref< org::apache::http::NameValuePair > const &a0, cpp_boolean const &a1, local_ref< org::apache::http::message::HeaderValueFormatter > const &a2)
{
	return local_ref< java::lang::String >(
		environment::get().get_jenv()->CallStaticObjectMethod(
			get_class<J2CPP_CLASS_NAME>(),
...
local_ref< org::apache::http::util::CharArrayBuffer > org::apache::http::message::BasicHeaderValueFormatter::formatNameValuePair(local_ref< org::apache::http::util::CharArrayBuffer > const &a0, local_ref< org::apache::http::NameValuePair > const &a1, cpp_boolean const &a2)
{
	return local_ref< org::apache::http::util::CharArrayBuffer >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
