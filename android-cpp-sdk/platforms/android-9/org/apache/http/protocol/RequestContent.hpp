...
namespace org { namespace apache { namespace http { namespace protocol {
	...
	class RequestContent
		: public cpp_object<RequestContent>
	{
	public:
		...
		RequestContent(jobject jobj)
		: cpp_object<RequestContent>(jobj)
		{
		}
...
template <>
local_ref< org::apache::http::protocol::RequestContent > create< org::apache::http::protocol::RequestContent>()
{
	return local_ref< org::apache::http::protocol::RequestContent >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::protocol::RequestContent::J2CPP_CLASS_NAME>(),
			get_method_id<org::apache::http::protocol::RequestContent::J2CPP_CLASS_NAME, org::apache::http::protocol::RequestContent::J2CPP_METHOD_NAME(0), org::apache::http::protocol::RequestContent::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
