...
namespace org { namespace apache { namespace http { namespace conn { namespace params {
	...
	public:
		...
		ConnConnectionParamBean(jobject jobj)
...
template <>
local_ref< org::apache::http::conn::params::ConnConnectionParamBean > create< org::apache::http::conn::params::ConnConnectionParamBean>(local_ref< org::apache::http::params::HttpParams > const &a0)
{
	return local_ref< org::apache::http::conn::params::ConnConnectionParamBean >(
