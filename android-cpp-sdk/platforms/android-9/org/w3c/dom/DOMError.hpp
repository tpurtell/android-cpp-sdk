...
namespace org { namespace w3c { namespace dom {
	...
	public:
		...
		DOMError(jobject jobj)
		: cpp_object<DOMError>(jobj)
		{
		}

		cpp_short getSeverity();
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_short > SEVERITY_WARNING;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_short > SEVERITY_ERROR;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_short > SEVERITY_FATAL_ERROR;
	}; //class DOMError
...
cpp_short org::w3c::dom::DOMError::getSeverity()
{
	return cpp_short(
...
{
	return local_ref< org::w3c::dom::DOMLocator >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
