...
namespace org { namespace w3c { namespace dom { namespace ls {
	...
	class LSParserFilter
		: public cpp_object<LSParserFilter>
	{
	public:
		...
		LSParserFilter(jobject jobj)
		: cpp_object<LSParserFilter>(jobj)
		{
		}

		cpp_short startElement(local_ref< org::w3c::dom::Element > const&);
		cpp_short acceptNode(local_ref< org::w3c::dom::Node > const&);
		cpp_int getWhatToShow();

		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_short > FILTER_ACCEPT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_short > FILTER_REJECT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_short > FILTER_SKIP;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), cpp_short > FILTER_INTERRUPT;
	}; //class LSParserFilter
...
cpp_short org::w3c::dom::ls::LSParserFilter::startElement(local_ref< org::w3c::dom::Element > const &a0)
{
	return cpp_short(
...
cpp_short org::w3c::dom::ls::LSParserFilter::acceptNode(local_ref< org::w3c::dom::Node > const &a0)
{
	return cpp_short(
		environment::get().get_jenv()->CallShortMethod(
			get_jtype(),
...
cpp_int org::w3c::dom::ls::LSParserFilter::getWhatToShow()
{
	return cpp_int(
