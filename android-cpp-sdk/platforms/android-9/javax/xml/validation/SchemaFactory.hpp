...
namespace javax { namespace xml { namespace validation {
	...
	class SchemaFactory;
	class SchemaFactory
		: public cpp_object<SchemaFactory>
	{
	public:
		...
		SchemaFactory(jobject jobj)
		: cpp_object<SchemaFactory>(jobj)
		{
		}
		...
		cpp_boolean isSchemaLanguageSupported(local_ref< java::lang::String > const&);
		...
		local_ref< javax::xml::validation::Schema > newSchema(local_ref< cpp_object_array<javax::xml::transform::Source, 1> > const&);
...
template <>
local_ref< javax::xml::validation::SchemaFactory > create< javax::xml::validation::SchemaFactory>()
{
	return local_ref< javax::xml::validation::SchemaFactory >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::xml::validation::SchemaFactory::J2CPP_CLASS_NAME>(),
			get_method_id<javax::xml::validation::SchemaFactory::J2CPP_CLASS_NAME, javax::xml::validation::SchemaFactory::J2CPP_METHOD_NAME(0), javax::xml::validation::SchemaFactory::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
...
cpp_boolean javax::xml::validation::SchemaFactory::isSchemaLanguageSupported(local_ref< java::lang::String > const &a0)
{
	return cpp_boolean(
...
cpp_boolean javax::xml::validation::SchemaFactory::getFeature(local_ref< java::lang::String > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
void javax::xml::validation::SchemaFactory::setFeature(local_ref< java::lang::String > const &a0, cpp_boolean const &a1)
{
	return void(
...
local_ref< javax::xml::validation::Schema > javax::xml::validation::SchemaFactory::newSchema(local_ref< cpp_object_array<javax::xml::transform::Source, 1> > const &a0)
{
	return local_ref< javax::xml::validation::Schema >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
