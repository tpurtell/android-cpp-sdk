...
namespace javax { namespace xml { namespace parsers {
	...
	public:
		...
		static local_ref< javax::xml::parsers::SAXParserFactory > newInstance(local_ref< java::lang::String >  const&, local_ref< java::lang::ClassLoader >  const&);
...
local_ref< javax::xml::parsers::SAXParserFactory > javax::xml::parsers::SAXParserFactory::newInstance(local_ref< java::lang::String > const &a0, local_ref< java::lang::ClassLoader > const &a1)
{
	return call_static_method<
		javax::xml::parsers::SAXParserFactory::J2CPP_CLASS_NAME,
...
jboolean javax::xml::parsers::SAXParserFactory::isXIncludeAware()
{
	return call_method<
		javax::xml::parsers::SAXParserFactory::J2CPP_CLASS_NAME,
		javax::xml::parsers::SAXParserFactory::J2CPP_METHOD_NAME(13),
		javax::xml::parsers::SAXParserFactory::J2CPP_METHOD_SIGNATURE(13), 
		jboolean >
	(get_jobject());
}
...
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,2,"newInstance","(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljavax/xml/parsers/SAXParserFactory;")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,3,"newSAXParser","()Ljavax/xml/parsers/SAXParser;")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,4,"setNamespaceAware","(Z)V")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,5,"setValidating","(Z)V")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,6,"isNamespaceAware","()Z")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,7,"isValidating","()Z")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,8,"setFeature","(Ljava/lang/String;Z)V")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,9,"getFeature","(Ljava/lang/String;)Z")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,10,"getSchema","()Ljavax/xml/validation/Schema;")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,11,"setSchema","(Ljavax/xml/validation/Schema;)V")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,12,"setXIncludeAware","(Z)V")
J2CPP_DEFINE_METHOD(javax::xml::parsers::SAXParserFactory,13,"isXIncludeAware","()Z")
