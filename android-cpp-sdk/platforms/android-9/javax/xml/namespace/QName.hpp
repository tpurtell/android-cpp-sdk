...
template <>
local_ref< javax::xml::namespace::QName > create< javax::xml::namespace::QName>(local_ref< java::lang::String > const &a0, local_ref< java::lang::String > const &a1)
{
	return local_ref< javax::xml::namespace::QName >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::xml::namespace::QName::J2CPP_CLASS_NAME>(),
			get_method_id<javax::xml::namespace::QName::J2CPP_CLASS_NAME, javax::xml::namespace::QName::J2CPP_METHOD_NAME(0), javax::xml::namespace::QName::J2CPP_METHOD_SIGNATURE(0), false>(),
...
template <>
local_ref< javax::xml::namespace::QName > create< javax::xml::namespace::QName>(local_ref< java::lang::String > const &a0, local_ref< java::lang::String > const &a1, local_ref< java::lang::String > const &a2)
{
	return local_ref< javax::xml::namespace::QName >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::xml::namespace::QName::J2CPP_CLASS_NAME>(),
			get_method_id<javax::xml::namespace::QName::J2CPP_CLASS_NAME, javax::xml::namespace::QName::J2CPP_METHOD_NAME(1), javax::xml::namespace::QName::J2CPP_METHOD_SIGNATURE(1), false>(),
...
template <>
local_ref< javax::xml::namespace::QName > create< javax::xml::namespace::QName>(local_ref< java::lang::String > const &a0)
{
	return local_ref< javax::xml::namespace::QName >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::xml::namespace::QName::J2CPP_CLASS_NAME>(),
			get_method_id<javax::xml::namespace::QName::J2CPP_CLASS_NAME, javax::xml::namespace::QName::J2CPP_METHOD_NAME(2), javax::xml::namespace::QName::J2CPP_METHOD_SIGNATURE(2), false>(),
			a0.get_jtype()
		)
	);
}
...
cpp_boolean javax::xml::namespace::QName::equals(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
...
cpp_int javax::xml::namespace::QName::hashCode()
{
	return cpp_int(
