...
namespace javax { namespace xml { namespace transform {
	...
	public:
		...
		Transformer(jobject jobj)
		: cpp_object<Transformer>(jobj)
		{
		}
...
template <>
local_ref< javax::xml::transform::Transformer > create< javax::xml::transform::Transformer>()
{
	return local_ref< javax::xml::transform::Transformer >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::xml::transform::Transformer::J2CPP_CLASS_NAME>(),
			get_method_id<javax::xml::transform::Transformer::J2CPP_CLASS_NAME, javax::xml::transform::Transformer::J2CPP_METHOD_NAME(0), javax::xml::transform::Transformer::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
