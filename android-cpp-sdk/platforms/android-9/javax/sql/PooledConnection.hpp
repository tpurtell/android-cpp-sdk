...
namespace j2cpp { namespace javax { namespace sql { class StatementEventListener; } } }
...
namespace javax { namespace sql {
	...
	public:
		...
		void addStatementEventListener(local_ref< javax::sql::StatementEventListener > const&);
		void removeStatementEventListener(local_ref< javax::sql::StatementEventListener > const&);
	}; //class PooledConnection
...
J2CPP_DEFINE_METHOD(javax::sql::PooledConnection,4,"addStatementEventListener","(Ljavax/sql/StatementEventListener;)V")
J2CPP_DEFINE_METHOD(javax::sql::PooledConnection,5,"removeStatementEventListener","(Ljavax/sql/StatementEventListener;)V")
