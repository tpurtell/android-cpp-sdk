...
template <>
local_ref< javax::net::ssl::SSLContextSpi > create< javax::net::ssl::SSLContextSpi>()
{
	return local_ref< javax::net::ssl::SSLContextSpi >(
...
J2CPP_DEFINE_METHOD(javax::net::ssl::SSLContextSpi,8,"engineGetDefaultSSLParameters","()Ljavax/net/ssl/SSLParameters;")
J2CPP_DEFINE_METHOD(javax::net::ssl::SSLContextSpi,9,"engineGetSupportedSSLParameters","()Ljavax/net/ssl/SSLParameters;")
