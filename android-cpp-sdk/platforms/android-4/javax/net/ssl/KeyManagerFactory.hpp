...
J2CPP_DEFINE_METHOD(javax::net::ssl::KeyManagerFactory,1,"getAlgorithm","()Ljava/lang/String;")
...
J2CPP_DEFINE_METHOD(javax::net::ssl::KeyManagerFactory,5,"getProvider","()Ljava/security/Provider;")
J2CPP_DEFINE_METHOD(javax::net::ssl::KeyManagerFactory,6,"init","(Ljava/security/KeyStore;[C)V")
J2CPP_DEFINE_METHOD(javax::net::ssl::KeyManagerFactory,7,"init","(Ljavax/net/ssl/ManagerFactoryParameters;)V")
J2CPP_DEFINE_METHOD(javax::net::ssl::KeyManagerFactory,8,"getKeyManagers","()[javax.net.ssl.KeyManager")
J2CPP_DEFINE_METHOD(javax::net::ssl::KeyManagerFactory,9,"getDefaultAlgorithm","()Ljava/lang/String;")
