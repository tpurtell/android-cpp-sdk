...
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,1,"getCipherSuite","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,2,"getLocalCertificates","()[java.security.cert.Certificate")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,3,"getServerCertificates","()[java.security.cert.Certificate")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,4,"getPeerPrincipal","()Ljava/security/Principal;")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,5,"getLocalPrincipal","()Ljava/security/Principal;")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,6,"setDefaultHostnameVerifier","(Ljavax/net/ssl/HostnameVerifier;)V")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,7,"getDefaultHostnameVerifier","()Ljavax/net/ssl/HostnameVerifier;")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,8,"setHostnameVerifier","(Ljavax/net/ssl/HostnameVerifier;)V")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,9,"getHostnameVerifier","()Ljavax/net/ssl/HostnameVerifier;")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,10,"setDefaultSSLSocketFactory","(Ljavax/net/ssl/SSLSocketFactory;)V")
J2CPP_DEFINE_METHOD(javax::net::ssl::HttpsURLConnection,11,"getDefaultSSLSocketFactory","()Ljavax/net/ssl/SSLSocketFactory;")
