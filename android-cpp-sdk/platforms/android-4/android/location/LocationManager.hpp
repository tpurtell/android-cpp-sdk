...
J2CPP_DEFINE_METHOD(android::location::LocationManager,25,"getGpsStatus","(Landroid/location/GpsStatus;)Landroid/location/GpsStatus;")
J2CPP_DEFINE_METHOD(android::location::LocationManager,26,"sendExtraCommand","(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z")
