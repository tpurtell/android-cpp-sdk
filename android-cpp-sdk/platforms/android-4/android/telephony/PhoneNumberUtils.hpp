...
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,12,"toCallerIDMinMatch","(Ljava/lang/String;)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,13,"getStrippedReversed","(Ljava/lang/String;)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,14,"stringFromStringAndTOA","(Ljava/lang/String;I)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,15,"toaFromString","(Ljava/lang/String;)I")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,16,"calledPartyBCDToString","([BII)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,17,"calledPartyBCDFragmentToString","([BII)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,18,"isWellFormedSmsAddress","(Ljava/lang/String;)Z")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,19,"isGlobalPhoneNumber","(Ljava/lang/String;)Z")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,20,"networkPortionToCalledPartyBCD","(Ljava/lang/String;)[B")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,21,"networkPortionToCalledPartyBCDWithLength","(Ljava/lang/String;)[B")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,22,"numberToCalledPartyBCD","(Ljava/lang/String;)[B")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,23,"formatNumber","(Ljava/lang/String;)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,24,"getFormatTypeForLocale","(Ljava/util/Locale;)I")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,25,"formatNumber","(Landroid/text/Editable;I)V")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,26,"formatNanpNumber","(Landroid/text/Editable;)V")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,27,"formatJapaneseNumber","(Landroid/text/Editable;)V")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,28,"isEmergencyNumber","(Ljava/lang/String;)Z")
J2CPP_DEFINE_METHOD(android::telephony::PhoneNumberUtils,29,"convertKeypadLettersToDigits","(Ljava/lang/String;)Ljava/lang/String;")
