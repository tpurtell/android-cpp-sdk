...
namespace android { namespace content { namespace pm {
	...
	public:
		...
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), jboolean > enabled;
		field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), jboolean > exported;
	}; //class ComponentInfo
...
jint android::content::pm::ComponentInfo::getIconResource()
{
	return call_method<
		android::content::pm::ComponentInfo::J2CPP_CLASS_NAME,
		android::content::pm::ComponentInfo::J2CPP_METHOD_NAME(5),
		android::content::pm::ComponentInfo::J2CPP_METHOD_SIGNATURE(5), 
		jint >
	(get_jobject());
}
...
void android::content::pm::ComponentInfo::writeToParcel(local_ref< android::os::Parcel > const &a0, jint a1)
{
	return call_method<
		android::content::pm::ComponentInfo::J2CPP_CLASS_NAME,
		android::content::pm::ComponentInfo::J2CPP_METHOD_NAME(8),
		android::content::pm::ComponentInfo::J2CPP_METHOD_SIGNATURE(8), 
		void >
	(get_jobject(), a0, a1);
}
