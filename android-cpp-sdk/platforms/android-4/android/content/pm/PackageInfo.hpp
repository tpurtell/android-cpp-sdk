...
namespace android { namespace content { namespace pm {
	...
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(16), J2CPP_FIELD_SIGNATURE(16), local_ref< android::os::Parcelable_::Creator > > CREATOR;
	}; //class PackageInfo
...
static_field<
	android::content::pm::PackageInfo::J2CPP_CLASS_NAME,
	android::content::pm::PackageInfo::J2CPP_FIELD_NAME(16),
	android::content::pm::PackageInfo::J2CPP_FIELD_SIGNATURE(16),
...
J2CPP_DEFINE_FIELD(android::content::pm::PackageInfo,16,"CREATOR","Landroid/os/Parcelable$Creator;")
