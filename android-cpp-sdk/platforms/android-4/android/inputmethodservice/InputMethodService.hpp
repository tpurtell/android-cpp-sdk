...
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,56,"onKeyMultiple","(IILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,57,"onKeyUp","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,58,"onTrackballEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,59,"onAppPrivateCommand","(Ljava/lang/String;Landroid/os/Bundle;)V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,60,"sendDownUpKeyEvents","(I)V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,61,"sendDefaultEditorAction","(Z)Z")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,62,"sendKeyChar","(C)V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,63,"onExtractedSelectionChanged","(II)V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,64,"onExtractedTextClicked","()V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,65,"onExtractedCursorMovement","(II)V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,66,"onExtractTextContextMenuItem","(I)Z")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,67,"getTextForImeAction","(I)Ljava/lang/CharSequence;")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,68,"onUpdateExtractingVisibility","(Landroid/view/inputmethod/EditorInfo;)V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,69,"onUpdateExtractingViews","(Landroid/view/inputmethod/EditorInfo;)V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,70,"onExtractingInputChanged","(Landroid/view/inputmethod/EditorInfo;)V")
J2CPP_DEFINE_METHOD(android::inputmethodservice::InputMethodService,71,"dump","(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[java.lang.String)V")
