...
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,6,"setEGLConfigChooser","(Landroid/opengl/GLSurfaceView$EGLConfigChooser;)V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,7,"setEGLConfigChooser","(Z)V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,8,"setEGLConfigChooser","(IIIIII)V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,9,"setRenderMode","(I)V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,10,"getRenderMode","()I")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,11,"requestRender","()V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,12,"surfaceCreated","(Landroid/view/SurfaceHolder;)V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,13,"surfaceDestroyed","(Landroid/view/SurfaceHolder;)V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,14,"surfaceChanged","(Landroid/view/SurfaceHolder;III)V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,15,"onPause","()V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,16,"onResume","()V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,17,"queueEvent","(Ljava/lang/Runnable;)V")
J2CPP_DEFINE_METHOD(android::opengl::GLSurfaceView,18,"onDetachedFromWindow","()V")
