...
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,11,"getThreshold","()I")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,12,"setThreshold","(I)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,13,"setOnItemClickListener","(Landroid/widget/AdapterView$OnItemClickListener;)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,14,"setOnItemSelectedListener","(Landroid/widget/AdapterView$OnItemSelectedListener;)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,15,"getItemClickListener","()Landroid/widget/AdapterView$OnItemClickListener;")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,16,"getItemSelectedListener","()Landroid/widget/AdapterView$OnItemSelectedListener;")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,17,"getOnItemClickListener","()Landroid/widget/AdapterView$OnItemClickListener;")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,18,"getOnItemSelectedListener","()Landroid/widget/AdapterView$OnItemSelectedListener;")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,19,"getAdapter","()Landroid/widget/ListAdapter;")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,20,"setAdapter","(Landroid/widget/ListAdapter;)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,21,"onKeyPreIme","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,22,"onKeyUp","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,23,"onKeyDown","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,24,"enoughToFilter","()Z")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,25,"isPopupShowing","()Z")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,26,"convertSelectionToString","(Ljava/lang/Object;)Ljava/lang/CharSequence;")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,27,"clearListSelection","()V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,28,"setListSelection","(I)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,29,"getListSelection","()I")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,30,"performFiltering","(Ljava/lang/CharSequence;I)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,31,"performCompletion","()V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,32,"onCommitCompletion","(Landroid/view/inputmethod/CompletionInfo;)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,33,"isPerformingCompletion","()Z")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,34,"replaceText","(Ljava/lang/CharSequence;)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,35,"onFilterComplete","(I)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,36,"onWindowFocusChanged","(Z)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,37,"onFocusChanged","(ZILandroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,38,"onAttachedToWindow","()V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,39,"onDetachedFromWindow","()V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,40,"dismissDropDown","()V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,41,"setFrame","(IIII)Z")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,42,"showDropDown","()V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,43,"setValidator","(Landroid/widget/AutoCompleteTextView$Validator;)V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,44,"getValidator","()Landroid/widget/AutoCompleteTextView$Validator;")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,45,"performValidation","()V")
J2CPP_DEFINE_METHOD(android::widget::AutoCompleteTextView,46,"getFilter","()Landroid/widget/Filter;")
