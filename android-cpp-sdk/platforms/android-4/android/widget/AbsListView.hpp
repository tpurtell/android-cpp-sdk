...
void android::widget::AbsListView::onGlobalLayout()
{
	return call_method<
		android::widget::AbsListView::J2CPP_CLASS_NAME,
		android::widget::AbsListView::J2CPP_METHOD_NAME(65),
		android::widget::AbsListView::J2CPP_METHOD_SIGNATURE(65), 
		void >
	(get_jobject());
}
...
jint android::widget::AbsListView::getCacheColorHint()
{
	return call_method<
		android::widget::AbsListView::J2CPP_CLASS_NAME,
		android::widget::AbsListView::J2CPP_METHOD_NAME(77),
		android::widget::AbsListView::J2CPP_METHOD_SIGNATURE(77), 
		jint >
	(get_jobject());
}
...
J2CPP_DEFINE_METHOD(android::widget::AbsListView,49,"onKeyUp","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,50,"dispatchSetPressed","(Z)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,51,"pointToPosition","(II)I")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,52,"pointToRowId","(II)J")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,53,"onTouchModeChanged","(Z)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,54,"onTouchEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,55,"draw","(Landroid/graphics/Canvas;)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,56,"onInterceptTouchEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,57,"addTouchables","(Ljava/util/ArrayList;)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,58,"invalidateViews","()V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,59,"handleDataChanged","()V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,60,"isInFilterMode","()Z")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,61,"onCreateInputConnection","(Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,62,"checkInputConnectionProxy","(Landroid/view/View;)Z")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,63,"clearTextFilter","()V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,64,"hasTextFilter","()Z")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,65,"onGlobalLayout","()V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,66,"beforeTextChanged","(Ljava/lang/CharSequence;III)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,67,"onTextChanged","(Ljava/lang/CharSequence;III)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,68,"afterTextChanged","(Landroid/text/Editable;)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,69,"onFilterComplete","(I)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,70,"generateLayoutParams","(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,71,"generateLayoutParams","(Landroid/util/AttributeSet;)Landroid/widget/AbsListView$LayoutParams;")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,72,"checkLayoutParams","(Landroid/view/ViewGroup$LayoutParams;)Z")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,73,"setTranscriptMode","(I)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,74,"getTranscriptMode","()I")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,75,"getSolidColor","()I")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,76,"setCacheColorHint","(I)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,77,"getCacheColorHint","()I")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,78,"reclaimViews","(Ljava/util/List;)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,79,"setRecyclerListener","(Landroid/widget/AbsListView$RecyclerListener;)V")
J2CPP_DEFINE_METHOD(android::widget::AbsListView,80,"generateLayoutParams","(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;")
