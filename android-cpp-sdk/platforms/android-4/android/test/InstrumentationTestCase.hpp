...
void android::test::InstrumentationTestCase::sendKeys(local_ref< java::lang::String > const &a0)
{
	return call_method<
		android::test::InstrumentationTestCase::J2CPP_CLASS_NAME,
		android::test::InstrumentationTestCase::J2CPP_METHOD_NAME(7),
		android::test::InstrumentationTestCase::J2CPP_METHOD_SIGNATURE(7), 
		void >
	(get_jobject(), a0);
}
...
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,1,"injectInsrumentation","(Landroid/app/Instrumentation;)V")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,2,"getInstrumentation","()Landroid/app/Instrumentation;")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,3,"launchActivity","(Ljava/lang/String;Ljava/lang/Class;Landroid/os/Bundle;)Landroid/app/Activity;")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,4,"launchActivityWithIntent","(Ljava/lang/String;Ljava/lang/Class;Landroid/content/Intent;)Landroid/app/Activity;")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,5,"runTestOnUiThread","(Ljava/lang/Runnable;)V")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,6,"runTest","()V")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,7,"sendKeys","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,8,"sendKeys","([I)V")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,9,"sendRepeatedKeys","([I)V")
J2CPP_DEFINE_METHOD(android::test::InstrumentationTestCase,10,"tearDown","()V")
