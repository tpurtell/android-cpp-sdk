...
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,17,"getPackagesForUid","(I)[java.lang.String")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,18,"getNameForUid","(I)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,19,"getInstalledApplications","(I)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,20,"resolveActivity","(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,21,"queryIntentActivities","(Landroid/content/Intent;I)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,22,"queryIntentActivityOptions","(Landroid/content/ComponentName;[android.content.IntentLandroid/content/Intent;I)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,23,"queryBroadcastReceivers","(Landroid/content/Intent;I)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,24,"resolveService","(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,25,"queryIntentServices","(Landroid/content/Intent;I)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,26,"resolveContentProvider","(Ljava/lang/String;I)Landroid/content/pm/ProviderInfo;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,27,"queryContentProviders","(Ljava/lang/String;II)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,28,"getInstrumentationInfo","(Landroid/content/ComponentName;I)Landroid/content/pm/InstrumentationInfo;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,29,"queryInstrumentation","(Ljava/lang/String;I)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,30,"getDrawable","(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,31,"getActivityIcon","(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,32,"getActivityIcon","(Landroid/content/Intent;)Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,33,"getDefaultActivityIcon","()Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,34,"getApplicationIcon","(Landroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,35,"getApplicationIcon","(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,36,"getText","(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Ljava/lang/CharSequence;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,37,"getXml","(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/content/res/XmlResourceParser;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,38,"getApplicationLabel","(Landroid/content/pm/ApplicationInfo;)Ljava/lang/CharSequence;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,39,"getResourcesForActivity","(Landroid/content/ComponentName;)Landroid/content/res/Resources;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,40,"getResourcesForApplication","(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/Resources;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,41,"getResourcesForApplication","(Ljava/lang/String;)Landroid/content/res/Resources;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,42,"getPackageArchiveInfo","(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,43,"addPackageToPreferred","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,44,"removePackageFromPreferred","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,45,"getPreferredPackages","(I)Ljava/util/List;")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,46,"setComponentEnabledSetting","(Landroid/content/ComponentName;II)V")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,47,"getComponentEnabledSetting","(Landroid/content/ComponentName;)I")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,48,"setApplicationEnabledSetting","(Ljava/lang/String;II)V")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,49,"getApplicationEnabledSetting","(Ljava/lang/String;)I")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,50,"addPreferredActivity","(Landroid/content/IntentFilter;I[android.content.ComponentNameLandroid/content/ComponentName;)V")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,51,"clearPackagePreferredActivities","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,52,"getPreferredActivities","(Ljava/util/List;Ljava/util/List;Ljava/lang/String;)I")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,53,"getSystemSharedLibraryNames","()[java.lang.String")
J2CPP_DEFINE_METHOD(android::test::mock::MockPackageManager,54,"isSafeMode","()Z")
