...
J2CPP_DEFINE_METHOD(android::test::RenamingDelegatingContext,8,"databaseList","()[java.lang.String")
J2CPP_DEFINE_METHOD(android::test::RenamingDelegatingContext,9,"openFileInput","(Ljava/lang/String;)Ljava/io/FileInputStream;")
J2CPP_DEFINE_METHOD(android::test::RenamingDelegatingContext,10,"openFileOutput","(Ljava/lang/String;I)Ljava/io/FileOutputStream;")
J2CPP_DEFINE_METHOD(android::test::RenamingDelegatingContext,11,"getFileStreamPath","(Ljava/lang/String;)Ljava/io/File;")
J2CPP_DEFINE_METHOD(android::test::RenamingDelegatingContext,12,"deleteFile","(Ljava/lang/String;)Z")
J2CPP_DEFINE_METHOD(android::test::RenamingDelegatingContext,13,"fileList","()[java.lang.String")
