...
void android::test::AndroidTestRunner::testStarted(local_ref< java::lang::String > const &a0)
{
	return call_method<
		android::test::AndroidTestRunner::J2CPP_CLASS_NAME,
		android::test::AndroidTestRunner::J2CPP_METHOD_NAME(14),
		android::test::AndroidTestRunner::J2CPP_METHOD_SIGNATURE(14), 
		void >
	(get_jobject(), a0);
}
...
J2CPP_DEFINE_METHOD(android::test::AndroidTestRunner,12,"setInstrumentaiton","(Landroid/app/Instrumentation;)V")
J2CPP_DEFINE_METHOD(android::test::AndroidTestRunner,13,"loadSuiteClass","(Ljava/lang/String;)Ljava/lang/Class;")
J2CPP_DEFINE_METHOD(android::test::AndroidTestRunner,14,"testStarted","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::test::AndroidTestRunner,15,"testEnded","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::test::AndroidTestRunner,16,"testFailed","(ILjunit/framework/Test;Ljava/lang/Throwable;)V")
J2CPP_DEFINE_METHOD(android::test::AndroidTestRunner,17,"runFailed","(Ljava/lang/String;)V")
