...
namespace android { namespace app {
	...
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(25), J2CPP_FIELD_SIGNATURE(25), local_ref< java::lang::String > > INTENT_ACTION_WEB_SEARCH_SETTINGS;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(26), J2CPP_FIELD_SIGNATURE(26), local_ref< java::lang::String > > INTENT_ACTION_SEARCHABLES_CHANGED;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(27), J2CPP_FIELD_SIGNATURE(27), local_ref< java::lang::String > > INTENT_ACTION_SEARCH_SETTINGS_CHANGED;
	}; //class SearchManager
...
J2CPP_DEFINE_METHOD(android::app::SearchManager,2,"stopSearch","()V")
J2CPP_DEFINE_METHOD(android::app::SearchManager,3,"setOnDismissListener","(Landroid/app/SearchManager$OnDismissListener;)V")
J2CPP_DEFINE_METHOD(android::app::SearchManager,4,"setOnCancelListener","(Landroid/app/SearchManager$OnCancelListener;)V")
J2CPP_DEFINE_METHOD(android::app::SearchManager,5,"onCancel","(Landroid/content/DialogInterface;)V")
J2CPP_DEFINE_METHOD(android::app::SearchManager,6,"onDismiss","(Landroid/content/DialogInterface;)V")
...
J2CPP_DEFINE_FIELD(android::app::SearchManager,25,"INTENT_ACTION_WEB_SEARCH_SETTINGS","Ljava/lang/String;")
J2CPP_DEFINE_FIELD(android::app::SearchManager,26,"INTENT_ACTION_SEARCHABLES_CHANGED","Ljava/lang/String;")
J2CPP_DEFINE_FIELD(android::app::SearchManager,27,"INTENT_ACTION_SEARCH_SETTINGS_CHANGED","Ljava/lang/String;")
