...
local_ref< java::util::List > android::app::LauncherActivity::makeListItems()
{
	return call_method<
		android::app::LauncherActivity::J2CPP_CLASS_NAME,
		android::app::LauncherActivity::J2CPP_METHOD_NAME(6),
		android::app::LauncherActivity::J2CPP_METHOD_SIGNATURE(6), 
...
J2CPP_DEFINE_METHOD(android::app::LauncherActivity,2,"onListItemClick","(Landroid/widget/ListView;Landroid/view/View;IJ)V")
J2CPP_DEFINE_METHOD(android::app::LauncherActivity,3,"intentForPosition","(I)Landroid/content/Intent;")
J2CPP_DEFINE_METHOD(android::app::LauncherActivity,4,"itemForPosition","(I)Landroid/app/LauncherActivity$ListItem;")
J2CPP_DEFINE_METHOD(android::app::LauncherActivity,5,"getTargetIntent","()Landroid/content/Intent;")
J2CPP_DEFINE_METHOD(android::app::LauncherActivity,6,"makeListItems","()Ljava/util/List;")
