...
android::database::sqlite::SQLiteConstraintException::operator local_ref<android::database::SQLException>() const
{
	return local_ref<android::database::SQLException>(get_jobject());
}

android::database::sqlite::SQLiteConstraintException::operator local_ref<java::io::Serializable>() const
{
	return local_ref<java::io::Serializable>(get_jobject());
}

android::database::sqlite::SQLiteConstraintException::operator local_ref<java::lang::RuntimeException>() const
{
	return local_ref<java::lang::RuntimeException>(get_jobject());
}

android::database::sqlite::SQLiteConstraintException::operator local_ref<java::lang::Throwable>() const
{
	return local_ref<java::lang::Throwable>(get_jobject());
}

android::database::sqlite::SQLiteConstraintException::operator local_ref<java::lang::Exception>() const
{
	return local_ref<java::lang::Exception>(get_jobject());
}

android::database::sqlite::SQLiteConstraintException::operator local_ref<java::lang::Object>() const
{
