...
J2CPP_DEFINE_METHOD(android::appwidget::AppWidgetHostView,5,"generateLayoutParams","(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;")
J2CPP_DEFINE_METHOD(android::appwidget::AppWidgetHostView,6,"updateAppWidget","(Landroid/widget/RemoteViews;)V")
J2CPP_DEFINE_METHOD(android::appwidget::AppWidgetHostView,7,"drawChild","(Landroid/graphics/Canvas;Landroid/view/View;J)Z")
J2CPP_DEFINE_METHOD(android::appwidget::AppWidgetHostView,8,"prepareView","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::appwidget::AppWidgetHostView,9,"getDefaultView","()Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::appwidget::AppWidgetHostView,10,"getErrorView","()Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::appwidget::AppWidgetHostView,11,"generateLayoutParams","(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;")
