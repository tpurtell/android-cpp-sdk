...
local_ref< java::lang::String > android::webkit::WebView::getOriginalUrl()
{
	return call_method<
		android::webkit::WebView::J2CPP_CLASS_NAME,
		android::webkit::WebView::J2CPP_METHOD_NAME(45),
		android::webkit::WebView::J2CPP_METHOD_SIGNATURE(45), 
		local_ref< java::lang::String >
	>(get_jobject());
}
...
local_ref< java::lang::String > android::webkit::WebView::getTitle()
{
	return call_method<
		android::webkit::WebView::J2CPP_CLASS_NAME,
		android::webkit::WebView::J2CPP_METHOD_NAME(46),
		android::webkit::WebView::J2CPP_METHOD_SIGNATURE(46), 
		local_ref< java::lang::String >
	>(get_jobject());
}
...
local_ref< android::graphics::Bitmap > android::webkit::WebView::getFavicon()
{
	return call_method<
		android::webkit::WebView::J2CPP_CLASS_NAME,
		android::webkit::WebView::J2CPP_METHOD_NAME(47),
		android::webkit::WebView::J2CPP_METHOD_SIGNATURE(47), 
...
local_ref< android::view::View > android::webkit::WebView::getZoomControls()
{
	return call_method<
		android::webkit::WebView::J2CPP_CLASS_NAME,
		android::webkit::WebView::J2CPP_METHOD_NAME(91),
		android::webkit::WebView::J2CPP_METHOD_SIGNATURE(91), 
...
J2CPP_DEFINE_METHOD(android::webkit::WebView,22,"loadData","(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,23,"loadDataWithBaseURL","(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,24,"stopLoading","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,25,"reload","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,26,"canGoBack","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,27,"goBack","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,28,"canGoForward","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,29,"goForward","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,30,"canGoBackOrForward","(I)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,31,"goBackOrForward","(I)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,32,"pageUp","(Z)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,33,"pageDown","(Z)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,34,"clearView","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,35,"capturePicture","()Landroid/graphics/Picture;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,36,"getScale","()F")
J2CPP_DEFINE_METHOD(android::webkit::WebView,37,"setInitialScale","(I)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,38,"invokeZoomPicker","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,39,"getHitTestResult","()Landroid/webkit/WebView$HitTestResult;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,40,"requestFocusNodeHref","(Landroid/os/Message;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,41,"requestImageRef","(Landroid/os/Message;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,42,"computeHorizontalScrollRange","()I")
J2CPP_DEFINE_METHOD(android::webkit::WebView,43,"computeVerticalScrollRange","()I")
J2CPP_DEFINE_METHOD(android::webkit::WebView,44,"getUrl","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,45,"getOriginalUrl","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,46,"getTitle","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,47,"getFavicon","()Landroid/graphics/Bitmap;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,48,"getProgress","()I")
J2CPP_DEFINE_METHOD(android::webkit::WebView,49,"getContentHeight","()I")
J2CPP_DEFINE_METHOD(android::webkit::WebView,50,"pauseTimers","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,51,"resumeTimers","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,52,"clearCache","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,53,"clearFormData","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,54,"clearHistory","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,55,"clearSslPreferences","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,56,"copyBackForwardList","()Landroid/webkit/WebBackForwardList;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,57,"findNext","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,58,"findAll","(Ljava/lang/String;)I")
J2CPP_DEFINE_METHOD(android::webkit::WebView,59,"findAddress","(Ljava/lang/String;)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,60,"clearMatches","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,61,"documentHasImages","(Landroid/os/Message;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,62,"computeScroll","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,63,"setWebViewClient","(Landroid/webkit/WebViewClient;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,64,"setDownloadListener","(Landroid/webkit/DownloadListener;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,65,"setWebChromeClient","(Landroid/webkit/WebChromeClient;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,66,"setPictureListener","(Landroid/webkit/WebView$PictureListener;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,67,"addJavascriptInterface","(Ljava/lang/Object;Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,68,"getSettings","()Landroid/webkit/WebSettings;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,69,"getPluginList","()Landroid/webkit/PluginList;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,70,"refreshPlugins","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,71,"finalize","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,72,"onDraw","(Landroid/graphics/Canvas;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,73,"setLayoutParams","(Landroid/view/ViewGroup$LayoutParams;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,74,"performLongClick","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,75,"onKeyDown","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,76,"onKeyUp","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,77,"onAttachedToWindow","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,78,"onDetachedFromWindow","()V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,79,"onChildViewAdded","(Landroid/view/View;Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,80,"onChildViewRemoved","(Landroid/view/View;Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,81,"onGlobalFocusChanged","(Landroid/view/View;Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,82,"onWindowFocusChanged","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,83,"onFocusChanged","(ZILandroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,84,"onSizeChanged","(IIII)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,85,"onScrollChanged","(IIII)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,86,"dispatchKeyEvent","(Landroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,87,"onTouchEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,88,"setMapTrackballToArrowKeys","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,89,"onTrackballEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,90,"flingScroll","(II)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,91,"getZoomControls","()Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::webkit::WebView,92,"zoomIn","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,93,"zoomOut","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,94,"requestFocus","(ILandroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,95,"onMeasure","(II)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,96,"requestChildRectangleOnScreen","(Landroid/view/View;Landroid/graphics/Rect;Z)Z")
J2CPP_DEFINE_METHOD(android::webkit::WebView,97,"setBackgroundColor","(I)V")
J2CPP_DEFINE_METHOD(android::webkit::WebView,98,"debugDump","()V")
