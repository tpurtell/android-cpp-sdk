...
J2CPP_DEFINE_METHOD(android::text::format::DateUtils,13,"formatDateTime","(Landroid/content/Context;JI)Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::text::format::DateUtils,14,"getRelativeTimeSpanString","(Landroid/content/Context;JZ)Ljava/lang/CharSequence;")
J2CPP_DEFINE_METHOD(android::text::format::DateUtils,15,"getRelativeTimeSpanString","(Landroid/content/Context;J)Ljava/lang/CharSequence;")
J2CPP_DEFINE_METHOD(android::text::format::DateUtils,16,"<clinit>","()V")
