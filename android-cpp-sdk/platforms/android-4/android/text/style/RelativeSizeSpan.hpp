...
android::text::style::RelativeSizeSpan::operator local_ref<android::os::Parcelable>() const
{
	return local_ref<android::os::Parcelable>(get_jobject());
}

android::text::style::RelativeSizeSpan::operator local_ref<android::text::style::UpdateAppearance>() const
{
	return local_ref<android::text::style::UpdateAppearance>(get_jobject());
}

android::text::style::RelativeSizeSpan::operator local_ref<android::text::style::UpdateLayout>() const
{
...
android::text::style::RelativeSizeSpan::operator local_ref<android::text::style::CharacterStyle>() const
{
...
android::text::style::RelativeSizeSpan::operator local_ref<java::lang::Object>() const
{
