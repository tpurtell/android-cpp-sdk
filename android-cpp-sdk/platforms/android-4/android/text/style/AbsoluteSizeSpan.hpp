...
J2CPP_DEFINE_METHOD(android::text::style::AbsoluteSizeSpan,1,"<init>","(Landroid/os/Parcel;)V")
J2CPP_DEFINE_METHOD(android::text::style::AbsoluteSizeSpan,2,"getSpanTypeId","()I")
J2CPP_DEFINE_METHOD(android::text::style::AbsoluteSizeSpan,3,"describeContents","()I")
J2CPP_DEFINE_METHOD(android::text::style::AbsoluteSizeSpan,4,"writeToParcel","(Landroid/os/Parcel;I)V")
J2CPP_DEFINE_METHOD(android::text::style::AbsoluteSizeSpan,5,"getSize","()I")
J2CPP_DEFINE_METHOD(android::text::style::AbsoluteSizeSpan,6,"updateDrawState","(Landroid/text/TextPaint;)V")
J2CPP_DEFINE_METHOD(android::text::style::AbsoluteSizeSpan,7,"updateMeasureState","(Landroid/text/TextPaint;)V")
