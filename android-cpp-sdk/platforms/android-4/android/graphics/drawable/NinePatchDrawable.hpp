...
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,13,"inflate","(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,14,"getPaint","()Landroid/graphics/Paint;")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,15,"getIntrinsicWidth","()I")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,16,"getIntrinsicHeight","()I")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,17,"getMinimumWidth","()I")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,18,"getMinimumHeight","()I")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,19,"getOpacity","()I")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,20,"getTransparentRegion","()Landroid/graphics/Region;")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,21,"getConstantState","()Landroid/graphics/drawable/Drawable$ConstantState;")
J2CPP_DEFINE_METHOD(android::graphics::drawable::NinePatchDrawable,22,"mutate","()Landroid/graphics/drawable/Drawable;")
