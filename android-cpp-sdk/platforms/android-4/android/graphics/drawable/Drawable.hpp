...
J2CPP_DEFINE_METHOD(android::graphics::drawable::Drawable_::ConstantState,2,"getChangingConfigurations","()I")
...
J2CPP_DEFINE_METHOD(android::graphics::drawable::Drawable,41,"createFromXml","(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;)Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::graphics::drawable::Drawable,42,"createFromXmlInner","(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::graphics::drawable::Drawable,43,"createFromPath","(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::graphics::drawable::Drawable,44,"inflate","(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)V")
J2CPP_DEFINE_METHOD(android::graphics::drawable::Drawable,45,"getConstantState","()Landroid/graphics/drawable/Drawable$ConstantState;")
