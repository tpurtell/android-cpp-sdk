...
J2CPP_DEFINE_METHOD(android::graphics::Rect,6,"isEmpty","()Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,7,"width","()I")
J2CPP_DEFINE_METHOD(android::graphics::Rect,8,"height","()I")
J2CPP_DEFINE_METHOD(android::graphics::Rect,9,"centerX","()I")
J2CPP_DEFINE_METHOD(android::graphics::Rect,10,"centerY","()I")
J2CPP_DEFINE_METHOD(android::graphics::Rect,11,"exactCenterX","()F")
J2CPP_DEFINE_METHOD(android::graphics::Rect,12,"exactCenterY","()F")
J2CPP_DEFINE_METHOD(android::graphics::Rect,13,"setEmpty","()V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,14,"set","(IIII)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,15,"set","(Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,16,"offset","(II)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,17,"offsetTo","(II)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,18,"inset","(II)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,19,"contains","(II)Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,20,"contains","(IIII)Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,21,"contains","(Landroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,22,"intersect","(IIII)Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,23,"intersect","(Landroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,24,"setIntersect","(Landroid/graphics/Rect;Landroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,25,"intersects","(IIII)Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,26,"intersects","(Landroid/graphics/Rect;Landroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::graphics::Rect,27,"union","(IIII)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,28,"union","(Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,29,"union","(II)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,30,"sort","()V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,31,"describeContents","()I")
J2CPP_DEFINE_METHOD(android::graphics::Rect,32,"writeToParcel","(Landroid/os/Parcel;I)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,33,"readFromParcel","(Landroid/os/Parcel;)V")
J2CPP_DEFINE_METHOD(android::graphics::Rect,34,"<clinit>","()V")
