...
namespace android { namespace view {
	...
	namespace ViewGroup_ {
		...
		public:
			...
			static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), jint > WRAP_CONTENT;
			field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), jint > width;
			field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), jint > height;
			field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), local_ref< android::view::animation::LayoutAnimationController_::AnimationParameters > > layoutAnimationParameters;
		}; //class LayoutParams
	...
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), jint > FOCUS_BEFORE_DESCENDANTS;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), jint > FOCUS_AFTER_DESCENDANTS;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), jint > FOCUS_BLOCK_DESCENDANTS;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), jint > PERSISTENT_NO_CACHE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(5), J2CPP_FIELD_SIGNATURE(5), jint > PERSISTENT_ANIMATION_CACHE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), jint > PERSISTENT_SCROLLING_CACHE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), jint > PERSISTENT_ALL_CACHES;
	}; //class ViewGroup
...
J2CPP_DEFINE_FIELD(android::view::ViewGroup_::LayoutParams,1,"WRAP_CONTENT","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup_::LayoutParams,2,"width","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup_::LayoutParams,3,"height","I")
...
void android::view::ViewGroup::setPersistentDrawingCache(jint a0)
{
	return call_method<
		android::view::ViewGroup::J2CPP_CLASS_NAME,
		android::view::ViewGroup::J2CPP_METHOD_NAME(94),
		android::view::ViewGroup::J2CPP_METHOD_SIGNATURE(94), 
		void >
	(get_jobject(), a0);
}
...
jboolean android::view::ViewGroup::addStatesFromChildren()
{
	return call_method<
		android::view::ViewGroup::J2CPP_CLASS_NAME,
		android::view::ViewGroup::J2CPP_METHOD_NAME(114),
		android::view::ViewGroup::J2CPP_METHOD_SIGNATURE(114), 
		jboolean >
	(get_jobject());
}
...
static_field<
	android::view::ViewGroup::J2CPP_CLASS_NAME,
	android::view::ViewGroup::J2CPP_FIELD_NAME(7),
	android::view::ViewGroup::J2CPP_FIELD_SIGNATURE(7),
	jint
...
J2CPP_DEFINE_METHOD(android::view::ViewGroup,21,"dispatchWindowVisibilityChanged","(I)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,22,"recomputeViewAttributes","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,23,"bringChildToFront","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,24,"dispatchKeyEventPreIme","(Landroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,25,"dispatchKeyEvent","(Landroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,26,"dispatchKeyShortcutEvent","(Landroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,27,"dispatchTrackballEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,28,"dispatchTouchEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,29,"requestDisallowInterceptTouchEvent","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,30,"onInterceptTouchEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,31,"requestFocus","(ILandroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,32,"onRequestFocusInDescendants","(ILandroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,33,"dispatchPopulateAccessibilityEvent","(Landroid/view/accessibility/AccessibilityEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,34,"setPadding","(IIII)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,35,"dispatchSaveInstanceState","(Landroid/util/SparseArray;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,36,"dispatchFreezeSelfOnly","(Landroid/util/SparseArray;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,37,"dispatchRestoreInstanceState","(Landroid/util/SparseArray;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,38,"dispatchThawSelfOnly","(Landroid/util/SparseArray;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,39,"setChildrenDrawingCacheEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,40,"onAnimationStart","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,41,"onAnimationEnd","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,42,"dispatchDraw","(Landroid/graphics/Canvas;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,43,"getChildDrawingOrder","(II)I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,44,"drawChild","(Landroid/graphics/Canvas;Landroid/view/View;J)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,45,"setClipChildren","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,46,"setClipToPadding","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,47,"dispatchSetSelected","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,48,"dispatchSetPressed","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,49,"setStaticTransformationsEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,50,"getChildStaticTransformation","(Landroid/view/View;Landroid/view/animation/Transformation;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,51,"addView","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,52,"addView","(Landroid/view/View;I)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,53,"addView","(Landroid/view/View;II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,54,"addView","(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,55,"addView","(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,56,"updateViewLayout","(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,57,"checkLayoutParams","(Landroid/view/ViewGroup$LayoutParams;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,58,"setOnHierarchyChangeListener","(Landroid/view/ViewGroup$OnHierarchyChangeListener;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,59,"addViewInLayout","(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,60,"addViewInLayout","(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,61,"cleanupLayoutState","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,62,"attachLayoutAnimationParameters","(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,63,"removeView","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,64,"removeViewInLayout","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,65,"removeViewsInLayout","(II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,66,"removeViewAt","(I)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,67,"removeViews","(II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,68,"removeAllViews","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,69,"removeAllViewsInLayout","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,70,"removeDetachedView","(Landroid/view/View;Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,71,"attachViewToParent","(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,72,"detachViewFromParent","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,73,"detachViewFromParent","(I)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,74,"detachViewsFromParent","(II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,75,"detachAllViewsFromParent","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,76,"invalidateChild","(Landroid/view/View;Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,77,"invalidateChildInParent","([ILandroid/graphics/Rect;)Landroid/view/ViewParent;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,78,"offsetDescendantRectToMyCoords","(Landroid/view/View;Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,79,"offsetRectIntoDescendantCoords","(Landroid/view/View;Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,80,"getChildVisibleRect","(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Point;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,81,"onLayout","(ZIIII)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,82,"canAnimate","()Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,83,"startLayoutAnimation","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,84,"scheduleLayoutAnimation","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,85,"setLayoutAnimation","(Landroid/view/animation/LayoutAnimationController;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,86,"getLayoutAnimation","()Landroid/view/animation/LayoutAnimationController;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,87,"isAnimationCacheEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,88,"setAnimationCacheEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,89,"isAlwaysDrawnWithCacheEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,90,"setAlwaysDrawnWithCacheEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,91,"isChildrenDrawnWithCacheEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,92,"setChildrenDrawnWithCacheEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,93,"getPersistentDrawingCache","()I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,94,"setPersistentDrawingCache","(I)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,95,"generateLayoutParams","(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,96,"generateLayoutParams","(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,97,"generateDefaultLayoutParams","()Landroid/view/ViewGroup$LayoutParams;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,98,"debug","(I)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,99,"indexOfChild","(Landroid/view/View;)I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,100,"getChildCount","()I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,101,"getChildAt","(I)Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,102,"measureChildren","(II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,103,"measureChild","(Landroid/view/View;II)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,104,"measureChildWithMargins","(Landroid/view/View;IIII)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,105,"getChildMeasureSpec","(III)I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,106,"clearDisappearingChildren","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,107,"gatherTransparentRegion","(Landroid/graphics/Region;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,108,"requestTransparentRegion","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,109,"fitSystemWindows","(Landroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,110,"getLayoutAnimationListener","()Landroid/view/animation/Animation$AnimationListener;")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,111,"drawableStateChanged","()V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,112,"onCreateDrawableState","(I)[I")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,113,"setAddStatesFromChildren","(Z)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,114,"addStatesFromChildren","()Z")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,115,"childDrawableStateChanged","(Landroid/view/View;)V")
J2CPP_DEFINE_METHOD(android::view::ViewGroup,116,"setLayoutAnimationListener","(Landroid/view/animation/Animation$AnimationListener;)V")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,0,"FLAG_USE_CHILD_DRAWING_ORDER","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,1,"FOCUS_BEFORE_DESCENDANTS","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,2,"FOCUS_AFTER_DESCENDANTS","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,3,"FOCUS_BLOCK_DESCENDANTS","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,4,"PERSISTENT_NO_CACHE","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,5,"PERSISTENT_ANIMATION_CACHE","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,6,"PERSISTENT_SCROLLING_CACHE","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,7,"PERSISTENT_ALL_CACHES","I")
J2CPP_DEFINE_FIELD(android::view::ViewGroup,8,"CLIP_TO_PADDING_MASK","I")
