...
jint android::view::View::getVerticalScrollbarWidth()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(8),
		android::view::View::J2CPP_METHOD_SIGNATURE(8), 
		jint >
	(get_jobject());
}
...
jboolean android::view::View::hasFocusable()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(25),
		android::view::View::J2CPP_METHOD_SIGNATURE(25), 
		jboolean >
	(get_jobject());
}
...
jboolean android::view::View::isShown()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(47),
		android::view::View::J2CPP_METHOD_SIGNATURE(47), 
		jboolean >
	(get_jobject());
}
...
void android::view::View::setPressed(jboolean a0)
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(67),
		android::view::View::J2CPP_METHOD_SIGNATURE(67), 
		void >
	(get_jobject(), a0);
}
...
void android::view::View::getWindowVisibleDisplayFrame(local_ref< android::graphics::Rect > const &a0)
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(98),
		android::view::View::J2CPP_METHOD_SIGNATURE(98), 
		void >
	(get_jobject(), a0);
}
...
jlong android::view::View::getDrawingTime()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(188),
		android::view::View::J2CPP_METHOD_SIGNATURE(188), 
		jlong >
	(get_jobject());
}
...
void android::view::View::setDuplicateParentStateEnabled(jboolean a0)
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(189),
		android::view::View::J2CPP_METHOD_SIGNATURE(189), 
		void >
	(get_jobject(), a0);
}
...
jboolean android::view::View::isDuplicateParentStateEnabled()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(190),
		android::view::View::J2CPP_METHOD_SIGNATURE(190), 
		jboolean >
	(get_jobject());
}
...
void android::view::View::setDrawingCacheEnabled(jboolean a0)
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(191),
		android::view::View::J2CPP_METHOD_SIGNATURE(191), 
		void >
	(get_jobject(), a0);
}
...
jboolean android::view::View::isDrawingCacheEnabled()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(192),
		android::view::View::J2CPP_METHOD_SIGNATURE(192), 
		jboolean >
	(get_jobject());
}
...
local_ref< android::graphics::Bitmap > android::view::View::getDrawingCache()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(193),
		android::view::View::J2CPP_METHOD_SIGNATURE(193), 
...
jboolean android::view::View::isInEditMode()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(200),
		android::view::View::J2CPP_METHOD_SIGNATURE(200), 
		jboolean >
	(get_jobject());
}
...
void android::view::View::refreshDrawableState()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(219),
		android::view::View::J2CPP_METHOD_SIGNATURE(219), 
		void >
	(get_jobject());
}
...
local_ref< android::view::ViewTreeObserver > android::view::View::getViewTreeObserver()
{
	return call_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(235),
		android::view::View::J2CPP_METHOD_SIGNATURE(235), 
...
local_ref< android::view::View > android::view::View::inflate(local_ref< android::content::Context > const &a0, jint a1, local_ref< android::view::ViewGroup > const &a2)
{
	return call_static_method<
		android::view::View::J2CPP_CLASS_NAME,
		android::view::View::J2CPP_METHOD_NAME(269),
		android::view::View::J2CPP_METHOD_SIGNATURE(269), 
		local_ref< android::view::View > >
	(a0, a1, a2);
}
...
J2CPP_DEFINE_METHOD(android::view::View,95,"dispatchWindowVisibilityChanged","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,96,"onWindowVisibilityChanged","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,97,"getWindowVisibility","()I")
J2CPP_DEFINE_METHOD(android::view::View,98,"getWindowVisibleDisplayFrame","(Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::view::View,99,"isInTouchMode","()Z")
J2CPP_DEFINE_METHOD(android::view::View,100,"getContext","()Landroid/content/Context;")
J2CPP_DEFINE_METHOD(android::view::View,101,"onKeyPreIme","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::View,102,"onKeyDown","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::View,103,"onKeyUp","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::View,104,"onKeyMultiple","(IILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::View,105,"onKeyShortcut","(ILandroid/view/KeyEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::View,106,"onCheckIsTextEditor","()Z")
J2CPP_DEFINE_METHOD(android::view::View,107,"onCreateInputConnection","(Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;")
J2CPP_DEFINE_METHOD(android::view::View,108,"checkInputConnectionProxy","(Landroid/view/View;)Z")
J2CPP_DEFINE_METHOD(android::view::View,109,"createContextMenu","(Landroid/view/ContextMenu;)V")
J2CPP_DEFINE_METHOD(android::view::View,110,"getContextMenuInfo","()Landroid/view/ContextMenu$ContextMenuInfo;")
J2CPP_DEFINE_METHOD(android::view::View,111,"onCreateContextMenu","(Landroid/view/ContextMenu;)V")
J2CPP_DEFINE_METHOD(android::view::View,112,"onTrackballEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::View,113,"onTouchEvent","(Landroid/view/MotionEvent;)Z")
J2CPP_DEFINE_METHOD(android::view::View,114,"cancelLongPress","()V")
J2CPP_DEFINE_METHOD(android::view::View,115,"setTouchDelegate","(Landroid/view/TouchDelegate;)V")
J2CPP_DEFINE_METHOD(android::view::View,116,"getTouchDelegate","()Landroid/view/TouchDelegate;")
J2CPP_DEFINE_METHOD(android::view::View,117,"bringToFront","()V")
J2CPP_DEFINE_METHOD(android::view::View,118,"onScrollChanged","(IIII)V")
J2CPP_DEFINE_METHOD(android::view::View,119,"onSizeChanged","(IIII)V")
J2CPP_DEFINE_METHOD(android::view::View,120,"dispatchDraw","(Landroid/graphics/Canvas;)V")
J2CPP_DEFINE_METHOD(android::view::View,121,"getParent","()Landroid/view/ViewParent;")
J2CPP_DEFINE_METHOD(android::view::View,122,"getScrollX","()I")
J2CPP_DEFINE_METHOD(android::view::View,123,"getScrollY","()I")
J2CPP_DEFINE_METHOD(android::view::View,124,"getWidth","()I")
J2CPP_DEFINE_METHOD(android::view::View,125,"getHeight","()I")
J2CPP_DEFINE_METHOD(android::view::View,126,"getDrawingRect","(Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::view::View,127,"getMeasuredWidth","()I")
J2CPP_DEFINE_METHOD(android::view::View,128,"getMeasuredHeight","()I")
J2CPP_DEFINE_METHOD(android::view::View,129,"getTop","()I")
J2CPP_DEFINE_METHOD(android::view::View,130,"getBottom","()I")
J2CPP_DEFINE_METHOD(android::view::View,131,"getLeft","()I")
J2CPP_DEFINE_METHOD(android::view::View,132,"getRight","()I")
J2CPP_DEFINE_METHOD(android::view::View,133,"getHitRect","(Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::view::View,134,"getFocusedRect","(Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::view::View,135,"getGlobalVisibleRect","(Landroid/graphics/Rect;Landroid/graphics/Point;)Z")
J2CPP_DEFINE_METHOD(android::view::View,136,"getGlobalVisibleRect","(Landroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::view::View,137,"getLocalVisibleRect","(Landroid/graphics/Rect;)Z")
J2CPP_DEFINE_METHOD(android::view::View,138,"offsetTopAndBottom","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,139,"offsetLeftAndRight","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,140,"getLayoutParams","()Landroid/view/ViewGroup$LayoutParams;")
J2CPP_DEFINE_METHOD(android::view::View,141,"setLayoutParams","(Landroid/view/ViewGroup$LayoutParams;)V")
J2CPP_DEFINE_METHOD(android::view::View,142,"scrollTo","(II)V")
J2CPP_DEFINE_METHOD(android::view::View,143,"scrollBy","(II)V")
J2CPP_DEFINE_METHOD(android::view::View,144,"invalidate","(Landroid/graphics/Rect;)V")
J2CPP_DEFINE_METHOD(android::view::View,145,"invalidate","(IIII)V")
J2CPP_DEFINE_METHOD(android::view::View,146,"invalidate","()V")
J2CPP_DEFINE_METHOD(android::view::View,147,"getHandler","()Landroid/os/Handler;")
J2CPP_DEFINE_METHOD(android::view::View,148,"post","(Ljava/lang/Runnable;)Z")
J2CPP_DEFINE_METHOD(android::view::View,149,"postDelayed","(Ljava/lang/Runnable;J)Z")
J2CPP_DEFINE_METHOD(android::view::View,150,"removeCallbacks","(Ljava/lang/Runnable;)Z")
J2CPP_DEFINE_METHOD(android::view::View,151,"postInvalidate","()V")
J2CPP_DEFINE_METHOD(android::view::View,152,"postInvalidate","(IIII)V")
J2CPP_DEFINE_METHOD(android::view::View,153,"postInvalidateDelayed","(J)V")
J2CPP_DEFINE_METHOD(android::view::View,154,"postInvalidateDelayed","(JIIII)V")
J2CPP_DEFINE_METHOD(android::view::View,155,"computeScroll","()V")
J2CPP_DEFINE_METHOD(android::view::View,156,"isHorizontalFadingEdgeEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::View,157,"setHorizontalFadingEdgeEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,158,"isVerticalFadingEdgeEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::View,159,"setVerticalFadingEdgeEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,160,"getTopFadingEdgeStrength","()F")
J2CPP_DEFINE_METHOD(android::view::View,161,"getBottomFadingEdgeStrength","()F")
J2CPP_DEFINE_METHOD(android::view::View,162,"getLeftFadingEdgeStrength","()F")
J2CPP_DEFINE_METHOD(android::view::View,163,"getRightFadingEdgeStrength","()F")
J2CPP_DEFINE_METHOD(android::view::View,164,"isHorizontalScrollBarEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::View,165,"setHorizontalScrollBarEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,166,"isVerticalScrollBarEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::View,167,"setVerticalScrollBarEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,168,"setScrollBarStyle","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,169,"getScrollBarStyle","()I")
J2CPP_DEFINE_METHOD(android::view::View,170,"computeHorizontalScrollRange","()I")
J2CPP_DEFINE_METHOD(android::view::View,171,"computeHorizontalScrollOffset","()I")
J2CPP_DEFINE_METHOD(android::view::View,172,"computeHorizontalScrollExtent","()I")
J2CPP_DEFINE_METHOD(android::view::View,173,"computeVerticalScrollRange","()I")
J2CPP_DEFINE_METHOD(android::view::View,174,"computeVerticalScrollOffset","()I")
J2CPP_DEFINE_METHOD(android::view::View,175,"computeVerticalScrollExtent","()I")
J2CPP_DEFINE_METHOD(android::view::View,176,"onDraw","(Landroid/graphics/Canvas;)V")
J2CPP_DEFINE_METHOD(android::view::View,177,"onAttachedToWindow","()V")
J2CPP_DEFINE_METHOD(android::view::View,178,"onDetachedFromWindow","()V")
J2CPP_DEFINE_METHOD(android::view::View,179,"getWindowAttachCount","()I")
J2CPP_DEFINE_METHOD(android::view::View,180,"getWindowToken","()Landroid/os/IBinder;")
J2CPP_DEFINE_METHOD(android::view::View,181,"getApplicationWindowToken","()Landroid/os/IBinder;")
J2CPP_DEFINE_METHOD(android::view::View,182,"saveHierarchyState","(Landroid/util/SparseArray;)V")
J2CPP_DEFINE_METHOD(android::view::View,183,"dispatchSaveInstanceState","(Landroid/util/SparseArray;)V")
J2CPP_DEFINE_METHOD(android::view::View,184,"onSaveInstanceState","()Landroid/os/Parcelable;")
J2CPP_DEFINE_METHOD(android::view::View,185,"restoreHierarchyState","(Landroid/util/SparseArray;)V")
J2CPP_DEFINE_METHOD(android::view::View,186,"dispatchRestoreInstanceState","(Landroid/util/SparseArray;)V")
J2CPP_DEFINE_METHOD(android::view::View,187,"onRestoreInstanceState","(Landroid/os/Parcelable;)V")
J2CPP_DEFINE_METHOD(android::view::View,188,"getDrawingTime","()J")
J2CPP_DEFINE_METHOD(android::view::View,189,"setDuplicateParentStateEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,190,"isDuplicateParentStateEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::View,191,"setDrawingCacheEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,192,"isDrawingCacheEnabled","()Z")
J2CPP_DEFINE_METHOD(android::view::View,193,"getDrawingCache","()Landroid/graphics/Bitmap;")
J2CPP_DEFINE_METHOD(android::view::View,194,"getDrawingCache","(Z)Landroid/graphics/Bitmap;")
J2CPP_DEFINE_METHOD(android::view::View,195,"destroyDrawingCache","()V")
J2CPP_DEFINE_METHOD(android::view::View,196,"setDrawingCacheBackgroundColor","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,197,"getDrawingCacheBackgroundColor","()I")
J2CPP_DEFINE_METHOD(android::view::View,198,"buildDrawingCache","()V")
J2CPP_DEFINE_METHOD(android::view::View,199,"buildDrawingCache","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,200,"isInEditMode","()Z")
J2CPP_DEFINE_METHOD(android::view::View,201,"isPaddingOffsetRequired","()Z")
J2CPP_DEFINE_METHOD(android::view::View,202,"getLeftPaddingOffset","()I")
J2CPP_DEFINE_METHOD(android::view::View,203,"getRightPaddingOffset","()I")
J2CPP_DEFINE_METHOD(android::view::View,204,"getTopPaddingOffset","()I")
J2CPP_DEFINE_METHOD(android::view::View,205,"getBottomPaddingOffset","()I")
J2CPP_DEFINE_METHOD(android::view::View,206,"draw","(Landroid/graphics/Canvas;)V")
J2CPP_DEFINE_METHOD(android::view::View,207,"getSolidColor","()I")
J2CPP_DEFINE_METHOD(android::view::View,208,"isLayoutRequested","()Z")
J2CPP_DEFINE_METHOD(android::view::View,209,"layout","(IIII)V")
J2CPP_DEFINE_METHOD(android::view::View,210,"onLayout","(ZIIII)V")
J2CPP_DEFINE_METHOD(android::view::View,211,"onFinishInflate","()V")
J2CPP_DEFINE_METHOD(android::view::View,212,"getResources","()Landroid/content/res/Resources;")
J2CPP_DEFINE_METHOD(android::view::View,213,"invalidateDrawable","(Landroid/graphics/drawable/Drawable;)V")
J2CPP_DEFINE_METHOD(android::view::View,214,"scheduleDrawable","(Landroid/graphics/drawable/Drawable;Ljava/lang/Runnable;J)V")
J2CPP_DEFINE_METHOD(android::view::View,215,"unscheduleDrawable","(Landroid/graphics/drawable/Drawable;Ljava/lang/Runnable;)V")
J2CPP_DEFINE_METHOD(android::view::View,216,"unscheduleDrawable","(Landroid/graphics/drawable/Drawable;)V")
J2CPP_DEFINE_METHOD(android::view::View,217,"verifyDrawable","(Landroid/graphics/drawable/Drawable;)Z")
J2CPP_DEFINE_METHOD(android::view::View,218,"drawableStateChanged","()V")
J2CPP_DEFINE_METHOD(android::view::View,219,"refreshDrawableState","()V")
J2CPP_DEFINE_METHOD(android::view::View,220,"getDrawableState","()[I")
J2CPP_DEFINE_METHOD(android::view::View,221,"onCreateDrawableState","(I)[I")
J2CPP_DEFINE_METHOD(android::view::View,222,"mergeDrawableStates","([I[I)[I")
J2CPP_DEFINE_METHOD(android::view::View,223,"setBackgroundColor","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,224,"setBackgroundResource","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,225,"setBackgroundDrawable","(Landroid/graphics/drawable/Drawable;)V")
J2CPP_DEFINE_METHOD(android::view::View,226,"getBackground","()Landroid/graphics/drawable/Drawable;")
J2CPP_DEFINE_METHOD(android::view::View,227,"setPadding","(IIII)V")
J2CPP_DEFINE_METHOD(android::view::View,228,"getPaddingTop","()I")
J2CPP_DEFINE_METHOD(android::view::View,229,"getPaddingBottom","()I")
J2CPP_DEFINE_METHOD(android::view::View,230,"getPaddingLeft","()I")
J2CPP_DEFINE_METHOD(android::view::View,231,"getPaddingRight","()I")
J2CPP_DEFINE_METHOD(android::view::View,232,"setSelected","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,233,"dispatchSetSelected","(Z)V")
J2CPP_DEFINE_METHOD(android::view::View,234,"isSelected","()Z")
J2CPP_DEFINE_METHOD(android::view::View,235,"getViewTreeObserver","()Landroid/view/ViewTreeObserver;")
J2CPP_DEFINE_METHOD(android::view::View,236,"getRootView","()Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::view::View,237,"getLocationOnScreen","([I)V")
J2CPP_DEFINE_METHOD(android::view::View,238,"getLocationInWindow","([I)V")
J2CPP_DEFINE_METHOD(android::view::View,239,"findViewById","(I)Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::view::View,240,"findViewWithTag","(Ljava/lang/Object;)Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::view::View,241,"setId","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,242,"getId","()I")
J2CPP_DEFINE_METHOD(android::view::View,243,"getTag","()Ljava/lang/Object;")
J2CPP_DEFINE_METHOD(android::view::View,244,"setTag","(Ljava/lang/Object;)V")
J2CPP_DEFINE_METHOD(android::view::View,245,"getTag","(I)Ljava/lang/Object;")
J2CPP_DEFINE_METHOD(android::view::View,246,"setTag","(ILjava/lang/Object;)V")
J2CPP_DEFINE_METHOD(android::view::View,247,"getBaseline","()I")
J2CPP_DEFINE_METHOD(android::view::View,248,"requestLayout","()V")
J2CPP_DEFINE_METHOD(android::view::View,249,"forceLayout","()V")
J2CPP_DEFINE_METHOD(android::view::View,250,"measure","(II)V")
J2CPP_DEFINE_METHOD(android::view::View,251,"onMeasure","(II)V")
J2CPP_DEFINE_METHOD(android::view::View,252,"setMeasuredDimension","(II)V")
J2CPP_DEFINE_METHOD(android::view::View,253,"resolveSize","(II)I")
J2CPP_DEFINE_METHOD(android::view::View,254,"getDefaultSize","(II)I")
J2CPP_DEFINE_METHOD(android::view::View,255,"getSuggestedMinimumHeight","()I")
J2CPP_DEFINE_METHOD(android::view::View,256,"getSuggestedMinimumWidth","()I")
J2CPP_DEFINE_METHOD(android::view::View,257,"setMinimumHeight","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,258,"setMinimumWidth","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,259,"getAnimation","()Landroid/view/animation/Animation;")
J2CPP_DEFINE_METHOD(android::view::View,260,"startAnimation","(Landroid/view/animation/Animation;)V")
J2CPP_DEFINE_METHOD(android::view::View,261,"clearAnimation","()V")
J2CPP_DEFINE_METHOD(android::view::View,262,"setAnimation","(Landroid/view/animation/Animation;)V")
J2CPP_DEFINE_METHOD(android::view::View,263,"onAnimationStart","()V")
J2CPP_DEFINE_METHOD(android::view::View,264,"onAnimationEnd","()V")
J2CPP_DEFINE_METHOD(android::view::View,265,"onSetAlpha","(I)Z")
J2CPP_DEFINE_METHOD(android::view::View,266,"playSoundEffect","(I)V")
J2CPP_DEFINE_METHOD(android::view::View,267,"performHapticFeedback","(I)Z")
J2CPP_DEFINE_METHOD(android::view::View,268,"performHapticFeedback","(II)Z")
J2CPP_DEFINE_METHOD(android::view::View,269,"inflate","(Landroid/content/Context;ILandroid/view/ViewGroup;)Landroid/view/View;")
J2CPP_DEFINE_METHOD(android::view::View,270,"<clinit>","()V")
