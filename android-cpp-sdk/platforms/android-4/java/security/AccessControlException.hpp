...
java::security::AccessControlException::operator local_ref<java::io::Serializable>() const
{
	return local_ref<java::io::Serializable>(get_jobject());
}

java::security::AccessControlException::operator local_ref<java::lang::RuntimeException>() const
{
	return local_ref<java::lang::RuntimeException>(get_jobject());
}

java::security::AccessControlException::operator local_ref<java::lang::Throwable>() const
{
...
java::security::AccessControlException::operator local_ref<java::lang::Exception>() const
{
	return local_ref<java::lang::Exception>(get_jobject());
}

java::security::AccessControlException::operator local_ref<java::lang::Object>() const
{
