...
namespace java { namespace security { namespace spec {
	...
	class X509EncodedKeySpec
		: public object<X509EncodedKeySpec>
	{
	public:
		...
		: object<X509EncodedKeySpec>(jobj)
		{
		}
		...
		X509EncodedKeySpec(local_ref< array<jbyte,1> > const&);
...
java::security::spec::X509EncodedKeySpec::X509EncodedKeySpec(local_ref< array<jbyte,1> > const &a0)
: object<java::security::spec::X509EncodedKeySpec>(
	call_new_object<
...
local_ref< array<jbyte,1> > java::security::spec::X509EncodedKeySpec::getEncoded()
{
	return call_method<
		java::security::spec::X509EncodedKeySpec::J2CPP_CLASS_NAME,
