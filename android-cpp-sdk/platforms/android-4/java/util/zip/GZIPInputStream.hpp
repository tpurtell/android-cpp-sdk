...
namespace java { namespace util { namespace zip {
	...
	public:
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), jint > GZIP_MAGIC;
	}; //class GZIPInputStream
...
static_field<
	java::util::zip::GZIPInputStream::J2CPP_CLASS_NAME,
	java::util::zip::GZIPInputStream::J2CPP_FIELD_NAME(2),
	java::util::zip::GZIPInputStream::J2CPP_FIELD_SIGNATURE(2),
	jint
...
J2CPP_DEFINE_METHOD(java::util::zip::GZIPInputStream,2,"read","([BII)I")
J2CPP_DEFINE_METHOD(java::util::zip::GZIPInputStream,3,"close","()V")
J2CPP_DEFINE_FIELD(java::util::zip::GZIPInputStream,0,"crc","Ljava/util/zip/CRC32;")
J2CPP_DEFINE_FIELD(java::util::zip::GZIPInputStream,1,"eos","Z")
J2CPP_DEFINE_FIELD(java::util::zip::GZIPInputStream,2,"GZIP_MAGIC","I")
