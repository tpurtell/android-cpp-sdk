...
jboolean java::util::concurrent::ScheduledThreadPoolExecutor::remove(local_ref< java::lang::Runnable > const &a0)
{
	return call_method<
		java::util::concurrent::ScheduledThreadPoolExecutor::J2CPP_CLASS_NAME,
...
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,4,"remove","(Ljava/lang/Runnable;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,5,"schedule","(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,6,"schedule","(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,7,"scheduleAtFixedRate","(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,8,"scheduleWithFixedDelay","(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,9,"execute","(Ljava/lang/Runnable;)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,10,"submit","(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,11,"submit","(Ljava/lang/Runnable;Ljava/lang/Object;)Ljava/util/concurrent/Future;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,12,"submit","(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,13,"setContinueExistingPeriodicTasksAfterShutdownPolicy","(Z)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,14,"getContinueExistingPeriodicTasksAfterShutdownPolicy","()Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,15,"setExecuteExistingDelayedTasksAfterShutdownPolicy","(Z)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,16,"getExecuteExistingDelayedTasksAfterShutdownPolicy","()Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,17,"shutdown","()V")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,18,"shutdownNow","()Ljava/util/List;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ScheduledThreadPoolExecutor,19,"getQueue","()Ljava/util/concurrent/BlockingQueue;")
