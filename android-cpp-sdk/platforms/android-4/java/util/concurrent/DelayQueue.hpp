...
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,2,"offer","(Ljava/util/concurrent/Delayed;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,3,"put","(Ljava/util/concurrent/Delayed;)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,4,"offer","(Ljava/util/concurrent/Delayed;JLjava/util/concurrent/TimeUnit;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,5,"add","(Ljava/util/concurrent/Delayed;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,6,"take","()Ljava/util/concurrent/Delayed;")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,7,"poll","(JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/Delayed;")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,8,"poll","()Ljava/util/concurrent/Delayed;")
...
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,23,"put","(Ljava/lang/Object;)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,24,"take","()Ljava/lang/Object;")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,25,"poll","(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;")
J2CPP_DEFINE_METHOD(java::util::concurrent::DelayQueue,26,"offer","(Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;)Z")
