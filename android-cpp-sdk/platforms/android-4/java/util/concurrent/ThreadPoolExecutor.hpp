...
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,16,"getQueue","()Ljava/util/concurrent/BlockingQueue;")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,17,"remove","(Ljava/lang/Runnable;)Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,18,"purge","()V")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,19,"setCorePoolSize","(I)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,20,"getCorePoolSize","()I")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,21,"prestartCoreThread","()Z")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,22,"prestartAllCoreThreads","()I")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,23,"setMaximumPoolSize","(I)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,24,"getMaximumPoolSize","()I")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,25,"setKeepAliveTime","(JLjava/util/concurrent/TimeUnit;)V")
J2CPP_DEFINE_METHOD(java::util::concurrent::ThreadPoolExecutor,26,"getKeepAliveTime","(Ljava/util/concurrent/TimeUnit;)J")
