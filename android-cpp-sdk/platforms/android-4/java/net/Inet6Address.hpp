...
local_ref< java::lang::String > java::net::Inet6Address::getHostAddress()
{
	return call_method<
		java::net::Inet6Address::J2CPP_CLASS_NAME,
...
jint java::net::Inet6Address::hashCode()
{
	return call_method<
		java::net::Inet6Address::J2CPP_CLASS_NAME,
...
jboolean java::net::Inet6Address::equals(local_ref< java::lang::Object > const &a0)
{
	return call_method<
		java::net::Inet6Address::J2CPP_CLASS_NAME,
		java::net::Inet6Address::J2CPP_METHOD_NAME(17),
		java::net::Inet6Address::J2CPP_METHOD_SIGNATURE(17), 
		jboolean
	>(get_jobject(), a0);
}
...
jboolean java::net::Inet6Address::isIPv4CompatibleAddress()
{
	return call_method<
		java::net::Inet6Address::J2CPP_CLASS_NAME,
		java::net::Inet6Address::J2CPP_METHOD_NAME(18),
		java::net::Inet6Address::J2CPP_METHOD_SIGNATURE(18), 
		jboolean
	>(get_jobject());
}
...
local_ref< java::lang::String > java::net::Inet6Address::toString()
{
	return call_method<
		java::net::Inet6Address::J2CPP_CLASS_NAME,
		java::net::Inet6Address::J2CPP_METHOD_NAME(19),
		java::net::Inet6Address::J2CPP_METHOD_SIGNATURE(19), 
		local_ref< java::lang::String >
	>(get_jobject());
}
...
J2CPP_DEFINE_METHOD(java::net::Inet6Address,13,"getHostAddress","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(java::net::Inet6Address,14,"getScopeId","()I")
J2CPP_DEFINE_METHOD(java::net::Inet6Address,15,"getScopedInterface","()Ljava/net/NetworkInterface;")
J2CPP_DEFINE_METHOD(java::net::Inet6Address,16,"hashCode","()I")
J2CPP_DEFINE_METHOD(java::net::Inet6Address,17,"equals","(Ljava/lang/Object;)Z")
J2CPP_DEFINE_METHOD(java::net::Inet6Address,18,"isIPv4CompatibleAddress","()Z")
J2CPP_DEFINE_METHOD(java::net::Inet6Address,19,"toString","()Ljava/lang/String;")
