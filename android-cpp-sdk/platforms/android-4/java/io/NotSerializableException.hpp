...
java::io::NotSerializableException::operator local_ref<java::io::IOException>() const
{
	return local_ref<java::io::IOException>(get_jobject());
}

java::io::NotSerializableException::operator local_ref<java::io::Serializable>() const
{
...
java::io::NotSerializableException::operator local_ref<java::lang::Throwable>() const
{
	return local_ref<java::lang::Throwable>(get_jobject());
}

java::io::NotSerializableException::operator local_ref<java::lang::Exception>() const
{
	return local_ref<java::lang::Exception>(get_jobject());
}

java::io::NotSerializableException::operator local_ref<java::lang::Object>() const
{
