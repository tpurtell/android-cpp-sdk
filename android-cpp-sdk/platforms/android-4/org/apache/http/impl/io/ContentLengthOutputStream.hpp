...
org::apache::http::impl::io::ContentLengthOutputStream::operator local_ref<java::io::Closeable>() const
{
	return local_ref<java::io::Closeable>(get_jobject());
}

org::apache::http::impl::io::ContentLengthOutputStream::operator local_ref<java::io::Flushable>() const
{
...
org::apache::http::impl::io::ContentLengthOutputStream::operator local_ref<java::lang::Object>() const
{
