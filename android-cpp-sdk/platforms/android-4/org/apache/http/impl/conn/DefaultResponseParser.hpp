...
org::apache::http::impl::conn::DefaultResponseParser::operator local_ref<org::apache::http::io::HttpMessageParser>() const
{
	return local_ref<org::apache::http::io::HttpMessageParser>(get_jobject());
}

org::apache::http::impl::conn::DefaultResponseParser::operator local_ref<java::lang::Object>() const
{
