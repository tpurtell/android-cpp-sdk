...
namespace org { namespace apache { namespace http { namespace auth {
	...
	class MalformedChallengeException
		: public object<MalformedChallengeException>
	{
	public:
		...
		: object<MalformedChallengeException>(jobj)
		{
		}
...
org::apache::http::auth::MalformedChallengeException::operator local_ref<org::apache::http::HttpException>() const
{
...
org::apache::http::auth::MalformedChallengeException::operator local_ref<java::io::Serializable>() const
{
	return local_ref<java::io::Serializable>(get_jobject());
}

org::apache::http::auth::MalformedChallengeException::operator local_ref<java::lang::Throwable>() const
{
	return local_ref<java::lang::Throwable>(get_jobject());
}

org::apache::http::auth::MalformedChallengeException::operator local_ref<java::lang::Exception>() const
{
	return local_ref<java::lang::Exception>(get_jobject());
}

org::apache::http::auth::MalformedChallengeException::operator local_ref<java::lang::Object>() const
{
...
: object<org::apache::http::auth::MalformedChallengeException>(
	call_new_object<
		org::apache::http::auth::MalformedChallengeException::J2CPP_CLASS_NAME,
		org::apache::http::auth::MalformedChallengeException::J2CPP_METHOD_NAME(0),
		org::apache::http::auth::MalformedChallengeException::J2CPP_METHOD_SIGNATURE(0)
	>()
)
{
}
...
: object<org::apache::http::auth::MalformedChallengeException>(
	call_new_object<
		org::apache::http::auth::MalformedChallengeException::J2CPP_CLASS_NAME,
		org::apache::http::auth::MalformedChallengeException::J2CPP_METHOD_NAME(1),
		org::apache::http::auth::MalformedChallengeException::J2CPP_METHOD_SIGNATURE(1)
	>(a0)
)
{
}
...
: object<org::apache::http::auth::MalformedChallengeException>(
	call_new_object<
		org::apache::http::auth::MalformedChallengeException::J2CPP_CLASS_NAME,
		org::apache::http::auth::MalformedChallengeException::J2CPP_METHOD_NAME(2),
		org::apache::http::auth::MalformedChallengeException::J2CPP_METHOD_SIGNATURE(2)
	>(a0, a1)
)
{
}
