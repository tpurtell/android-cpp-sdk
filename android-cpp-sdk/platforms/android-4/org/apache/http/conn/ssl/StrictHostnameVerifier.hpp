...
namespace org { namespace apache { namespace http { namespace conn { namespace ssl {
	...
	class StrictHostnameVerifier
		: public object<StrictHostnameVerifier>
	{
	public:
		...
		: object<StrictHostnameVerifier>(jobj)
		{
		}
...
org::apache::http::conn::ssl::StrictHostnameVerifier::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

org::apache::http::conn::ssl::StrictHostnameVerifier::operator local_ref<javax::net::ssl::HostnameVerifier>() const
{
...
org::apache::http::conn::ssl::StrictHostnameVerifier::operator local_ref<org::apache::http::conn::ssl::X509HostnameVerifier>() const
{
...
: object<org::apache::http::conn::ssl::StrictHostnameVerifier>(
	call_new_object<
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_CLASS_NAME,
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_METHOD_NAME(0),
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_METHOD_SIGNATURE(0)
	>()
)
{
}
...
void org::apache::http::conn::ssl::StrictHostnameVerifier::verify(local_ref< java::lang::String > const &a0, local_ref< array< local_ref< java::lang::String >, 1> > const &a1, local_ref< array< local_ref< java::lang::String >, 1> > const &a2)
{
	return call_method<
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_CLASS_NAME,
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_METHOD_NAME(1),
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_METHOD_SIGNATURE(1), 
		void
...
local_ref< java::lang::String > org::apache::http::conn::ssl::StrictHostnameVerifier::toString()
{
	return call_method<
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_CLASS_NAME,
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_METHOD_NAME(2),
		org::apache::http::conn::ssl::StrictHostnameVerifier::J2CPP_METHOD_SIGNATURE(2), 
