...
org::apache::http::ProtocolException::operator local_ref<java::io::Serializable>() const
{
	return local_ref<java::io::Serializable>(get_jobject());
}

org::apache::http::ProtocolException::operator local_ref<java::lang::Throwable>() const
{
	return local_ref<java::lang::Throwable>(get_jobject());
}

org::apache::http::ProtocolException::operator local_ref<java::lang::Exception>() const
{
	return local_ref<java::lang::Exception>(get_jobject());
}

org::apache::http::ProtocolException::operator local_ref<java::lang::Object>() const
{
...
: object<org::apache::http::ProtocolException>(
	call_new_object<
		org::apache::http::ProtocolException::J2CPP_CLASS_NAME,
		org::apache::http::ProtocolException::J2CPP_METHOD_NAME(0),
		org::apache::http::ProtocolException::J2CPP_METHOD_SIGNATURE(0)
	>()
)
{
}
...
: object<org::apache::http::ProtocolException>(
	call_new_object<
		org::apache::http::ProtocolException::J2CPP_CLASS_NAME,
		org::apache::http::ProtocolException::J2CPP_METHOD_NAME(1),
		org::apache::http::ProtocolException::J2CPP_METHOD_SIGNATURE(1)
	>(a0)
)
{
}
...
: object<org::apache::http::ProtocolException>(
	call_new_object<
		org::apache::http::ProtocolException::J2CPP_CLASS_NAME,
		org::apache::http::ProtocolException::J2CPP_METHOD_NAME(2),
		org::apache::http::ProtocolException::J2CPP_METHOD_SIGNATURE(2)
	>(a0, a1)
)
{
}
