...
namespace org { namespace apache { namespace http { namespace client { namespace params {
	...
	class ClientParamBean
		: public cpp_object<ClientParamBean>
	{
	public:
		...
		void setRejectRelativeRedirect(cpp_boolean const&);
		void setMaxRedirects(cpp_int const&);
		void setAllowCircularRedirects(cpp_boolean const&);
		void setHandleAuthentication(cpp_boolean const&);
...
void org::apache::http::client::params::ClientParamBean::setHandleRedirects(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void org::apache::http::client::params::ClientParamBean::setRejectRelativeRedirect(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void org::apache::http::client::params::ClientParamBean::setMaxRedirects(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void org::apache::http::client::params::ClientParamBean::setAllowCircularRedirects(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void org::apache::http::client::params::ClientParamBean::setHandleAuthentication(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
