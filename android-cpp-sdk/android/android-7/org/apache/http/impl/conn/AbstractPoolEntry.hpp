...
namespace org { namespace apache { namespace http { namespace impl { namespace conn {
	...
	public:
		...
		AbstractPoolEntry(jobject jobj)
...
template <>
local_ref< org::apache::http::impl::conn::AbstractPoolEntry > create< org::apache::http::impl::conn::AbstractPoolEntry>(local_ref< org::apache::http::conn::ClientConnectionOperator > const &a0, local_ref< org::apache::http::conn::routing::HttpRoute > const &a1)
{
	return local_ref< org::apache::http::impl::conn::AbstractPoolEntry >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::impl::conn::AbstractPoolEntry::J2CPP_CLASS_NAME>(),
			get_method_id<org::apache::http::impl::conn::AbstractPoolEntry::J2CPP_CLASS_NAME, org::apache::http::impl::conn::AbstractPoolEntry::J2CPP_METHOD_NAME(0), org::apache::http::impl::conn::AbstractPoolEntry::J2CPP_METHOD_SIGNATURE(0), false>(),
