...
namespace org { namespace apache { namespace http { namespace impl { namespace conn {
	...
	class AbstractPooledConnAdapter
		: public cpp_object<AbstractPooledConnAdapter>
	{
	public:
...
void org::apache::http::impl::conn::AbstractPooledConnAdapter::tunnelTarget(cpp_boolean const &a0, local_ref< org::apache::http::params::HttpParams > const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void org::apache::http::impl::conn::AbstractPooledConnAdapter::tunnelProxy(local_ref< org::apache::http::HttpHost > const &a0, cpp_boolean const &a1, local_ref< org::apache::http::params::HttpParams > const &a2)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
