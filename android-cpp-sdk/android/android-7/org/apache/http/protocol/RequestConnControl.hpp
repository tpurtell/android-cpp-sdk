...
namespace org { namespace apache { namespace http { namespace protocol {
	...
	public:
		...
		RequestConnControl(jobject jobj)
...
template <>
local_ref< org::apache::http::protocol::RequestConnControl > create< org::apache::http::protocol::RequestConnControl>()
{
	return local_ref< org::apache::http::protocol::RequestConnControl >(
