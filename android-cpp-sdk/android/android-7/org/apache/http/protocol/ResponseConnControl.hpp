...
namespace org { namespace apache { namespace http { namespace protocol {
	...
	public:
		...
		ResponseConnControl(jobject jobj)
...
template <>
local_ref< org::apache::http::protocol::ResponseConnControl > create< org::apache::http::protocol::ResponseConnControl>()
{
	return local_ref< org::apache::http::protocol::ResponseConnControl >(
