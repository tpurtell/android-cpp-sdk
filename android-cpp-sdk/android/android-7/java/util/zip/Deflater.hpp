...
template <>
local_ref< java::util::zip::Deflater > create< java::util::zip::Deflater>()
{
	return local_ref< java::util::zip::Deflater >(
...
template <>
local_ref< java::util::zip::Deflater > create< java::util::zip::Deflater>(cpp_int const &a0)
{
	return local_ref< java::util::zip::Deflater >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::zip::Deflater::J2CPP_CLASS_NAME>(),
...
template <>
local_ref< java::util::zip::Deflater > create< java::util::zip::Deflater>(cpp_int const &a0, cpp_boolean const &a1)
{
	return local_ref< java::util::zip::Deflater >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::zip::Deflater::J2CPP_CLASS_NAME>(),
