...
namespace java { namespace security { namespace acl {
	...
	public:
		...
		AclNotFoundException(jobject jobj)
...
template <>
local_ref< java::security::acl::AclNotFoundException > create< java::security::acl::AclNotFoundException>()
{
	return local_ref< java::security::acl::AclNotFoundException >(
