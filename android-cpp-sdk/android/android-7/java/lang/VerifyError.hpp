...
template <>
local_ref< java::lang::VerifyError > create< java::lang::VerifyError>()
{
	return local_ref< java::lang::VerifyError >(
...
template <>
local_ref< java::lang::VerifyError > create< java::lang::VerifyError>(local_ref< java::lang::String > const &a0)
{
	return local_ref< java::lang::VerifyError >(
		environment::get().get_jenv()->NewObject(
			get_class<java::lang::VerifyError::J2CPP_CLASS_NAME>(),
