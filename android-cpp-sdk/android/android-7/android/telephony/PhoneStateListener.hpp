...
namespace android { namespace telephony {
	...
	class PhoneStateListener
		: public cpp_object<PhoneStateListener>
	{
	public:
		...
		void onCallForwardingIndicatorChanged(cpp_boolean const&);
		void onCellLocationChanged(local_ref< android::telephony::CellLocation > const&);
		void onCallStateChanged(cpp_int const&, local_ref< java::lang::String > const&);
		void onDataConnectionStateChanged(cpp_int const&);
		void onDataConnectionStateChanged(cpp_int const&, cpp_int const&);
		void onDataActivity(cpp_int const&);
		void onSignalStrengthsChanged(local_ref< android::telephony::SignalStrength > const&);

		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_int > LISTEN_NONE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_int > LISTEN_SERVICE_STATE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_int > LISTEN_SIGNAL_STRENGTH;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), cpp_int > LISTEN_MESSAGE_WAITING_INDICATOR;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), cpp_int > LISTEN_CALL_FORWARDING_INDICATOR;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(5), J2CPP_FIELD_SIGNATURE(5), cpp_int > LISTEN_CELL_LOCATION;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), cpp_int > LISTEN_CALL_STATE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), cpp_int > LISTEN_DATA_CONNECTION_STATE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(8), J2CPP_FIELD_SIGNATURE(8), cpp_int > LISTEN_DATA_ACTIVITY;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(9), J2CPP_FIELD_SIGNATURE(9), cpp_int > LISTEN_SIGNAL_STRENGTHS;
	}; //class PhoneStateListener
...
void android::telephony::PhoneStateListener::onSignalStrengthChanged(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::telephony::PhoneStateListener::onMessageWaitingIndicatorChanged(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::telephony::PhoneStateListener::onCallForwardingIndicatorChanged(cpp_boolean const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::telephony::PhoneStateListener::onCallStateChanged(cpp_int const &a0, local_ref< java::lang::String > const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::telephony::PhoneStateListener::onDataConnectionStateChanged(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::telephony::PhoneStateListener::onDataConnectionStateChanged(cpp_int const &a0, cpp_int const &a1)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
...
void android::telephony::PhoneStateListener::onDataActivity(cpp_int const &a0)
{
	return void(
		environment::get().get_jenv()->CallVoidMethod(
			get_jtype(),
