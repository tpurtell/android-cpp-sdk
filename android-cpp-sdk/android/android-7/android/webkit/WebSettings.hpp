...
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,55,"setJavaScriptEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,56,"setPluginsEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,57,"setPluginsPath","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,58,"setDatabasePath","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,59,"setGeolocationDatabasePath","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,60,"setAppCacheEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,61,"setAppCachePath","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,62,"setAppCacheMaxSize","(J)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,63,"setDatabaseEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,64,"setDomStorageEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,65,"getDomStorageEnabled","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,66,"getDatabasePath","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,67,"getDatabaseEnabled","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,68,"setGeolocationEnabled","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,69,"getJavaScriptEnabled","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,70,"getPluginsEnabled","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,71,"getPluginsPath","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,72,"setJavaScriptCanOpenWindowsAutomatically","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,73,"getJavaScriptCanOpenWindowsAutomatically","()Z")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,74,"setDefaultTextEncodingName","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,75,"getDefaultTextEncodingName","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,76,"setUserAgentString","(Ljava/lang/String;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,77,"getUserAgentString","()Ljava/lang/String;")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,78,"setNeedInitialFocus","(Z)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,79,"setRenderPriority","(Landroid/webkit/WebSettings$RenderPriority;)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,80,"setCacheMode","(I)V")
J2CPP_DEFINE_METHOD(android::webkit::WebSettings,81,"getCacheMode","()I")
