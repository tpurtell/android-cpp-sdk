...
namespace javax { namespace xml { namespace transform { namespace sax {
	...
	class SAXTransformerFactory
		: public cpp_object<SAXTransformerFactory>
	{
	public:
		...
		SAXTransformerFactory(jobject jobj)
		: cpp_object<SAXTransformerFactory>(jobj)
		{
		}
...
template <>
local_ref< javax::xml::transform::sax::SAXTransformerFactory > create< javax::xml::transform::sax::SAXTransformerFactory>()
{
	return local_ref< javax::xml::transform::sax::SAXTransformerFactory >(
		environment::get().get_jenv()->NewObject(
			get_class<javax::xml::transform::sax::SAXTransformerFactory::J2CPP_CLASS_NAME>(),
			get_method_id<javax::xml::transform::sax::SAXTransformerFactory::J2CPP_CLASS_NAME, javax::xml::transform::sax::SAXTransformerFactory::J2CPP_METHOD_NAME(0), javax::xml::transform::sax::SAXTransformerFactory::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
...
{
	return local_ref< javax::xml::transform::sax::TransformerHandler >(
...
{
	return local_ref< javax::xml::transform::sax::TemplatesHandler >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
{
	return local_ref< org::xml::sax::XMLFilter >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
