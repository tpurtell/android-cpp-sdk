...
namespace java { namespace nio { namespace channels {
	...
	public:
		...
		UnresolvedAddressException(jobject jobj)
...
template <>
local_ref< java::nio::channels::UnresolvedAddressException > create< java::nio::channels::UnresolvedAddressException>()
{
	return local_ref< java::nio::channels::UnresolvedAddressException >(
