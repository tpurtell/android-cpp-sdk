...
namespace java { namespace util { namespace concurrent {
	...
	class LinkedBlockingQueue
		: public cpp_object<LinkedBlockingQueue>
	{
	public:
		...
		LinkedBlockingQueue(jobject jobj)
		: cpp_object<LinkedBlockingQueue>(jobj)
		{
		}
...
template <>
local_ref< java::util::concurrent::LinkedBlockingQueue > create< java::util::concurrent::LinkedBlockingQueue>()
{
	return local_ref< java::util::concurrent::LinkedBlockingQueue >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::concurrent::LinkedBlockingQueue::J2CPP_CLASS_NAME>(),
			get_method_id<java::util::concurrent::LinkedBlockingQueue::J2CPP_CLASS_NAME, java::util::concurrent::LinkedBlockingQueue::J2CPP_METHOD_NAME(0), java::util::concurrent::LinkedBlockingQueue::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}

template <>
local_ref< java::util::concurrent::LinkedBlockingQueue > create< java::util::concurrent::LinkedBlockingQueue>(cpp_int const &a0)
{
	return local_ref< java::util::concurrent::LinkedBlockingQueue >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::concurrent::LinkedBlockingQueue::J2CPP_CLASS_NAME>(),
			get_method_id<java::util::concurrent::LinkedBlockingQueue::J2CPP_CLASS_NAME, java::util::concurrent::LinkedBlockingQueue::J2CPP_METHOD_NAME(1), java::util::concurrent::LinkedBlockingQueue::J2CPP_METHOD_SIGNATURE(1), false>(),
			a0.get_jtype()
		)
	);
}
...
template <>
local_ref< java::util::concurrent::LinkedBlockingQueue > create< java::util::concurrent::LinkedBlockingQueue>(local_ref< java::util::Collection > const &a0)
{
	return local_ref< java::util::concurrent::LinkedBlockingQueue >(
		environment::get().get_jenv()->NewObject(
			get_class<java::util::concurrent::LinkedBlockingQueue::J2CPP_CLASS_NAME>(),
			get_method_id<java::util::concurrent::LinkedBlockingQueue::J2CPP_CLASS_NAME, java::util::concurrent::LinkedBlockingQueue::J2CPP_METHOD_NAME(2), java::util::concurrent::LinkedBlockingQueue::J2CPP_METHOD_SIGNATURE(2), false>(),
			a0.get_jtype()
		)
	);
}

cpp_int java::util::concurrent::LinkedBlockingQueue::size()
{
	return cpp_int(
...
cpp_int java::util::concurrent::LinkedBlockingQueue::remainingCapacity()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_boolean java::util::concurrent::LinkedBlockingQueue::offer(local_ref< java::lang::Object > const &a0, cpp_long const &a1, local_ref< java::util::concurrent::TimeUnit > const &a2)
{
	return cpp_boolean(
...
cpp_boolean java::util::concurrent::LinkedBlockingQueue::offer(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
local_ref< java::lang::Object > java::util::concurrent::LinkedBlockingQueue::poll(cpp_long const &a0, local_ref< java::util::concurrent::TimeUnit > const &a1)
{
	return local_ref< java::lang::Object >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_boolean java::util::concurrent::LinkedBlockingQueue::remove(local_ref< java::lang::Object > const &a0)
{
	return cpp_boolean(
		environment::get().get_jenv()->CallBooleanMethod(
			get_jtype(),
...
local_ref< cpp_object_array<java::lang::Object, 1> > java::util::concurrent::LinkedBlockingQueue::toArray()
{
...
local_ref< cpp_object_array<java::lang::Object, 1> > java::util::concurrent::LinkedBlockingQueue::toArray(local_ref< cpp_object_array<java::lang::Object, 1> > const &a0)
{
	return local_ref< cpp_object_array<java::lang::Object, 1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_int java::util::concurrent::LinkedBlockingQueue::drainTo(local_ref< java::util::Collection > const &a0)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
...
cpp_int java::util::concurrent::LinkedBlockingQueue::drainTo(local_ref< java::util::Collection > const &a0, cpp_int const &a1)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
