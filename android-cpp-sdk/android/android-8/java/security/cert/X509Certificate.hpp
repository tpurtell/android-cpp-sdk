...
namespace java { namespace security { namespace cert {
	...
	public:
		...
		local_ref< cpp_byte_array<1> > getTBSCertificate();
		...
		local_ref< cpp_boolean_array<1> > getIssuerUniqueID();
		local_ref< cpp_boolean_array<1> > getSubjectUniqueID();
...
cpp_int java::security::cert::X509Certificate::getVersion()
{
	return cpp_int(
...
local_ref< cpp_byte_array<1> > java::security::cert::X509Certificate::getTBSCertificate()
{
...
local_ref< cpp_byte_array<1> > java::security::cert::X509Certificate::getSignature()
{
	return local_ref< cpp_byte_array<1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< cpp_byte_array<1> > java::security::cert::X509Certificate::getSigAlgParams()
{
	return local_ref< cpp_byte_array<1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< cpp_boolean_array<1> > java::security::cert::X509Certificate::getIssuerUniqueID()
{
...
local_ref< cpp_boolean_array<1> > java::security::cert::X509Certificate::getSubjectUniqueID()
{
	return local_ref< cpp_boolean_array<1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
local_ref< cpp_boolean_array<1> > java::security::cert::X509Certificate::getKeyUsage()
{
	return local_ref< cpp_boolean_array<1> >(
		environment::get().get_jenv()->CallObjectMethod(
			get_jtype(),
...
cpp_int java::security::cert::X509Certificate::getBasicConstraints()
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
