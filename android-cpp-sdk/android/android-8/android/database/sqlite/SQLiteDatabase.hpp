...
namespace android { namespace database { namespace sqlite {
	...
	public:
		...
		cpp_long insertWithOnConflict(local_ref< java::lang::String > const&, local_ref< java::lang::String > const&, local_ref< android::content::ContentValues > const&, cpp_int const&);
		...
		cpp_int updateWithOnConflict(local_ref< java::lang::String > const&, local_ref< android::content::ContentValues > const&, local_ref< java::lang::String > const&, local_ref< cpp_object_array<java::lang::String, 1> > const&, cpp_int const&);
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(0), J2CPP_FIELD_SIGNATURE(0), cpp_int > CONFLICT_ROLLBACK;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(1), J2CPP_FIELD_SIGNATURE(1), cpp_int > CONFLICT_ABORT;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(2), J2CPP_FIELD_SIGNATURE(2), cpp_int > CONFLICT_FAIL;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(3), J2CPP_FIELD_SIGNATURE(3), cpp_int > CONFLICT_IGNORE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(4), J2CPP_FIELD_SIGNATURE(4), cpp_int > CONFLICT_REPLACE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(5), J2CPP_FIELD_SIGNATURE(5), cpp_int > CONFLICT_NONE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(6), J2CPP_FIELD_SIGNATURE(6), cpp_int > SQLITE_MAX_LIKE_PATTERN_LENGTH;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(7), J2CPP_FIELD_SIGNATURE(7), cpp_int > OPEN_READWRITE;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(8), J2CPP_FIELD_SIGNATURE(8), cpp_int > OPEN_READONLY;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(9), J2CPP_FIELD_SIGNATURE(9), cpp_int > NO_LOCALIZED_COLLATORS;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(10), J2CPP_FIELD_SIGNATURE(10), cpp_int > CREATE_IF_NECESSARY;
	}; //class SQLiteDatabase
...
cpp_long android::database::sqlite::SQLiteDatabase::insertWithOnConflict(local_ref< java::lang::String > const &a0, local_ref< java::lang::String > const &a1, local_ref< android::content::ContentValues > const &a2, cpp_int const &a3)
{
	return cpp_long(
		environment::get().get_jenv()->CallLongMethod(
			get_jtype(),
...
cpp_int android::database::sqlite::SQLiteDatabase::updateWithOnConflict(local_ref< java::lang::String > const &a0, local_ref< android::content::ContentValues > const &a1, local_ref< java::lang::String > const &a2, local_ref< cpp_object_array<java::lang::String, 1> > const &a3, cpp_int const &a4)
{
	return cpp_int(
		environment::get().get_jenv()->CallIntMethod(
			get_jtype(),
