...
namespace android { namespace text { namespace style {
	...
	public:
		...
		StrikethroughSpan(jobject jobj)
...
template <>
local_ref< android::text::style::StrikethroughSpan > create< android::text::style::StrikethroughSpan>()
{
	return local_ref< android::text::style::StrikethroughSpan >(
...
template <>
local_ref< android::text::style::StrikethroughSpan > create< android::text::style::StrikethroughSpan>(local_ref< android::os::Parcel > const &a0)
{
	return local_ref< android::text::style::StrikethroughSpan >(
		environment::get().get_jenv()->NewObject(
			get_class<android::text::style::StrikethroughSpan::J2CPP_CLASS_NAME>(),
