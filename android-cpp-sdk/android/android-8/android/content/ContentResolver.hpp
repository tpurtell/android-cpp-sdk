...
namespace android { namespace content {
	...
	public:
		...
		static void addPeriodicSync(local_ref< android::accounts::Account > const&, local_ref< java::lang::String > const&, local_ref< android::os::Bundle > const&, cpp_long const&);
		...
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(16), J2CPP_FIELD_SIGNATURE(16), cpp_int > SYNC_OBSERVER_TYPE_SETTINGS;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(17), J2CPP_FIELD_SIGNATURE(17), cpp_int > SYNC_OBSERVER_TYPE_PENDING;
		static static_field< J2CPP_CLASS_NAME, J2CPP_FIELD_NAME(18), J2CPP_FIELD_SIGNATURE(18), cpp_int > SYNC_OBSERVER_TYPE_ACTIVE;
	}; //class ContentResolver
...
void android::content::ContentResolver::addPeriodicSync(local_ref< android::accounts::Account > const &a0, local_ref< java::lang::String > const &a1, local_ref< android::os::Bundle > const &a2, cpp_long const &a3)
{
	return void(
		environment::get().get_jenv()->CallStaticVoidMethod(
			get_class<J2CPP_CLASS_NAME>(),
