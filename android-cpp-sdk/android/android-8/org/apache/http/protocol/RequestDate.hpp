...
namespace org { namespace apache { namespace http { namespace protocol {
	...
	public:
		...
		RequestDate(jobject jobj)
		: cpp_object<RequestDate>(jobj)
		{
		}
...
template <>
local_ref< org::apache::http::protocol::RequestDate > create< org::apache::http::protocol::RequestDate>()
{
	return local_ref< org::apache::http::protocol::RequestDate >(
		environment::get().get_jenv()->NewObject(
			get_class<org::apache::http::protocol::RequestDate::J2CPP_CLASS_NAME>(),
			get_method_id<org::apache::http::protocol::RequestDate::J2CPP_CLASS_NAME, org::apache::http::protocol::RequestDate::J2CPP_METHOD_NAME(0), org::apache::http::protocol::RequestDate::J2CPP_METHOD_SIGNATURE(0), false>()
		)
	);
}
