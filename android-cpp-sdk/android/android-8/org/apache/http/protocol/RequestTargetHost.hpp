...
namespace org { namespace apache { namespace http { namespace protocol {
	...
	public:
		...
		RequestTargetHost(jobject jobj)
...
template <>
local_ref< org::apache::http::protocol::RequestTargetHost > create< org::apache::http::protocol::RequestTargetHost>()
{
	return local_ref< org::apache::http::protocol::RequestTargetHost >(
